...
# Usage: python runImpacts_v25_SR_M1500GeV_e4.py <workingArea> [--regen]
# e.g.   python runImpacts_v25_SR_M1500GeV_e4.py rpfmult_Binningv10_Inputv25_SR_M1500GeV_e4 --regen
...
configJSON = "config_Binningv10_Inputv25_SR_M1500GeV_e4.json"  # same JSON as runWith1DVanilla_v25_SR_M1500GeV_e4.py
...
def regenerate(signal, tf):
    ...
    import runWith1DVanilla_v25_SR_M1500GeV_e4 as ref
