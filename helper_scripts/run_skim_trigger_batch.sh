...
# run skim_ntuples_trigger.C with object, region, and base_dir parameters
echo "\n[1] root -l -b -q 'skim_ntuples_trigger.C(\"$object\", \"$region\", \"$base_dir\")'"
root -b -l -q "skim_ntuples_trigger.C(\"$object\", \"$region\", \"$base_dir\")"
