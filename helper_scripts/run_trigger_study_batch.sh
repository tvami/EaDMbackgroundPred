...
# run trigger_study.C with object, region, and base_dir parameters
echo "\n[1] root -l -b -q 'trigger_study.C(\"$object\", \"$region\", \"$base_dir\")'"
root -b -l -q "trigger_study.C(\"$object\", \"$region\", \"$base_dir\")"
