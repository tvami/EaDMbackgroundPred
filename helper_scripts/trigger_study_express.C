...
/// Usage:
///       root -l -b -q 'trigger_study_express.C("track", "sr", "/path/to/files/")'

void trigger_study_express(TString object = "track", TString region = "sr", TString base_dir = "/ceph/cms/store/user/tvami/EarthAsDM/Cosmics/crab_Ntuplizer-Cosmics_Run2023D-CosmicTP-PromptReco-v1_v3/") {
    ...
    TString output_file = TString::Format("skimmed_random_trig_%s_%s_%s.root", object.Data(), region.Data(), dataset_name.Data());
    ...
    auto df_trigger = df2.Filter("HLT_Random", "Trigger");
