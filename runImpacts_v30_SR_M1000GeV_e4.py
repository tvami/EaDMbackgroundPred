...
# Usage: python runImpacts_v30_SR_M1000GeV_e4.py <workingArea> [--regen]
# e.g.   python runImpacts_v30_SR_M1000GeV_e4.py rpf2x0_Binningv13_Inputv30_SR_M1000GeV_e4 --regen
...
configJSON = "config_Binningv13_Inputv30_SR_M1000GeV_e4.json"  # same JSON as runWith1DVanilla_v30_SR_M1000GeV_e4.py
...
def regenerate(signal, tf):
    ...
    import runWith1DVanilla_v30_SR_M1000GeV_e4 as ref
