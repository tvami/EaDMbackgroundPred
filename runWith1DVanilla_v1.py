...
def plot_fit(signal, tf):
    ...
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, lumiText=r'2023Dv1 Cosmics (1.1M Events)')
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, True, lumiText=r'2023Dv1 Cosmics (1.1M Events)')
