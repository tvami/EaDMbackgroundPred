...
def plot_fit(signal, tf):
    ...
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, lumiText=r'2023D Cosmics', pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.9999"})
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, True, lumiText=r'2023D Cosmics', pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.9999"})
...
if __name__ == "__main__":
    ...
    signal_areas = ["Signal_M3000GeV_VR1"] * 3
    ...
    test_FTest('1x0','2x0',"Signal_M3000GeV_VR1")
