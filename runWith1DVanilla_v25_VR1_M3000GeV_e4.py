...
configJSON = "config_Binningv10_Inputv25_VR1_M3000GeV_e4.json" # sys.argv[2]
...
_rpf_options = {
    ...
    '2x0old': {
        ...
        'constraints': {
            0: {"MIN": 0.0, "MAX": 50},
            1: {"MIN": 0.0, "MAX": 50},
            2: {"MIN": -5,  "MAX": 50}   # allow concave (downward) curvature: VR1 TF turns over
        }
    },
...
if __name__ == "__main__":
    ...
    test_FTest('1x0','2x0',"Signal_M3000GeV_e4_VR1")
