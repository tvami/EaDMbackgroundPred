...
def plot_fit(signal, tf):
    ...
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, lumiText=r'Cosmics MC (1.2M Events)', pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.9999"})
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, True, lumiText=r'Cosmics MC (1.2M Events)', pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.9999"})
