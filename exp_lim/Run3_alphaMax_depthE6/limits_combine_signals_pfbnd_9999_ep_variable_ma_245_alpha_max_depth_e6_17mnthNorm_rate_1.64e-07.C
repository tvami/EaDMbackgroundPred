...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx239[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy239[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx239,Graph0_fy239);
   ...
   TH1F *Graph_Graph0239 = new TH1F("Graph_Graph0239","",100,0,197.7);
   ...
   Double_t Graph1_fx240[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy240[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx240,Graph1_fy240);
   ...
   TH1F *Graph_Graph1240 = new TH1F("Graph_Graph1240","Graph",100,0,197.7);
   Graph_Graph1240->SetMinimum(0.4736673);
   Graph_Graph1240->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx241[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy241[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx241,Graph2_fy241);
   ...
   TH1F *Graph_Graph2241 = new TH1F("Graph_Graph2241","Graph",100,0,197.7);
   Graph_Graph2241->SetMinimum(0.837719);
   Graph_Graph2241->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx242[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy242[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx242,Graph0_fy242);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0242 = new TH1F("Graph_Graph0242","",100,0,197.7);
   ...
   Double_t Graph_fx243[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy243[17] = { 2.296564e-42, 1.218649e-30, 1.231029e-23, 5.490467e-19, 1.112064e-15, 3.274956e-13, 2.67419e-11, 8.913762e-10, 0.004685532, 6.635839, 58.47709, 154.2586, 257.3367, 345.4707, 412.4153, 459.4208, 490.076 };
   graph = new TGraph(17,Graph_fx243,Graph_fy243);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph243 = new TH1F("Graph_Graph243","",100,0,197.7);
   ...
   Double_t Graph_fx245[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy245[17] = { 2.526221e-42, 1.340513e-30, 1.354132e-23, 6.039513e-19, 1.223271e-15, 3.602451e-13, 2.941609e-11, 9.805138e-10, 0.005154085, 7.299422, 64.3248, 169.6845, 283.0703, 380.0177, 453.6568, 505.3629, 539.0836 };
   graph = new TGraph(17,Graph_fx245,Graph_fy245);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph245 = new TH1F("Graph_Graph245","",100,0,197.7);
   Graph_Graph245->SetMinimum(2.273599e-42);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(36.67878,0,36.67878,1.98891);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(36.67378,0,"  36.68 TeV");
