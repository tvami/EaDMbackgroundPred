...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx169[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy169[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx169,Graph0_fy169);
   ...
   TH1F *Graph_Graph0169 = new TH1F("Graph_Graph0169","",100,0,197.7);
   ...
   Double_t Graph1_fx170[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy170[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx170,Graph1_fy170);
   ...
   TH1F *Graph_Graph1170 = new TH1F("Graph_Graph1170","Graph",100,0,197.7);
   Graph_Graph1170->SetMinimum(0.4736673);
   Graph_Graph1170->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx171[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy171[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx171,Graph2_fy171);
   ...
   TH1F *Graph_Graph2171 = new TH1F("Graph_Graph2171","Graph",100,0,197.7);
   Graph_Graph2171->SetMinimum(0.837719);
   Graph_Graph2171->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx172[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy172[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx172,Graph0_fy172);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0172 = new TH1F("Graph_Graph0172","",100,0,197.7);
   ...
   Double_t Graph_fx173[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy173[17] = { 0.001181874, 0.05138484, 0.4605775, 1.896833, 5.042919, 10.24134, 17.42825, 26.25736, 122.469, 163.3811, 141.136, 116.5667, 96.87924, 81.73527, 70.02283, 60.81987, 53.46183 };
   graph = new TGraph(17,Graph_fx173,Graph_fy173);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph173 = new TH1F("Graph_Graph173","",100,0,197.7);
   Graph_Graph173->SetMinimum(0.001063686);
   Graph_Graph173->SetMaximum(179.7191);
   ...
   Double_t Graph_fx175[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy175[17] = { 0.001300061, 0.05652332, 0.5066353, 2.086516, 5.547211, 11.26547, 19.17108, 28.88309, 134.7159, 179.7192, 155.2496, 128.2234, 106.5672, 89.90879, 77.02511, 66.90186, 58.80801 };
   graph = new TGraph(17,Graph_fx175,Graph_fy175);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph175 = new TH1F("Graph_Graph175","",100,0,197.7);
   Graph_Graph175->SetMinimum(0.001170055);
   Graph_Graph175->SetMaximum(197.691);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.299412,0,8.299412,12.00854);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.294412,0,"  8.30 TeV");
