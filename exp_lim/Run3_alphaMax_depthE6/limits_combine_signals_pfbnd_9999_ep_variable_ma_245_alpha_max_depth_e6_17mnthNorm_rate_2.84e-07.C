...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx323[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy323[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx323,Graph0_fy323);
   ...
   TH1F *Graph_Graph0323 = new TH1F("Graph_Graph0323","",100,0,197.7);
   ...
   Double_t Graph1_fx324[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy324[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx324,Graph1_fy324);
   ...
   TH1F *Graph_Graph1324 = new TH1F("Graph_Graph1324","Graph",100,0,197.7);
   Graph_Graph1324->SetMinimum(0.4736673);
   Graph_Graph1324->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx325[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy325[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx325,Graph2_fy325);
   ...
   TH1F *Graph_Graph2325 = new TH1F("Graph_Graph2325","Graph",100,0,197.7);
   Graph_Graph2325->SetMinimum(0.837719);
   Graph_Graph2325->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx326[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy326[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx326,Graph0_fy326);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0326 = new TH1F("Graph_Graph0326","",100,0,197.7);
   ...
   Double_t Graph_fx327[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy327[17] = { 1.524183e-136, 4.906974e-101, 9.225548e-80, 1.341303e-65, 1.695064e-55, 6.231836e-48, 4.68203e-42, 2.314025e-37, 2.263917e-16, 4.374167e-06, 0.009210532, 0.3755762, 3.239218, 13.00198, 33.93831, 67.98044, 114.4533 };
   graph = new TGraph(17,Graph_fx327,Graph_fy327);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph327 = new TH1F("Graph_Graph327","",100,0,197.7);
   Graph_Graph327->SetMinimum(1.371764e-136);
   ...
   Double_t Graph_fx329[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy329[17] = { 1.676601e-136, 5.397672e-101, 1.01481e-79, 1.475433e-65, 1.864571e-55, 6.85502e-48, 5.150233e-42, 2.545428e-37, 2.490309e-16, 4.811583e-06, 0.01013158, 0.4131339, 3.56314, 14.30218, 37.33214, 74.77848, 125.8986 };
   graph = new TGraph(17,Graph_fx329,Graph_fy329);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph329 = new TH1F("Graph_Graph329","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(97.26657,0,97.26657,2.412965);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(97.26157,0,"  97.27 TeV");
