...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx330[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy330[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx330,Graph0_fy330);
   ...
   TH1F *Graph_Graph0330 = new TH1F("Graph_Graph0330","",100,0,197.7);
   ...
   Double_t Graph1_fx331[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy331[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx331,Graph1_fy331);
   ...
   TH1F *Graph_Graph1331 = new TH1F("Graph_Graph1331","Graph",100,0,197.7);
   Graph_Graph1331->SetMinimum(0.4736673);
   Graph_Graph1331->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx332[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy332[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx332,Graph2_fy332);
   ...
   TH1F *Graph_Graph2332 = new TH1F("Graph_Graph2332","Graph",100,0,197.7);
   Graph_Graph2332->SetMinimum(0.837719);
   Graph_Graph2332->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx333[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy333[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx333,Graph0_fy333);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0333 = new TH1F("Graph_Graph0333","",100,0,197.7);
   ...
   Double_t Graph_fx334[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy334[17] = { 1.035276e-146, 1.201866e-108, 7.731227e-86, 1.184657e-70, 8.05064e-60, 1.045187e-51, 2.094995e-45, 2.270145e-40, 7.599081e-18, 8.588228e-07, 0.003258333, 0.1783447, 1.835325, 8.287489, 23.53058, 50.20223, 88.77198 };
   graph = new TGraph(17,Graph_fx334,Graph_fy334);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph334 = new TH1F("Graph_Graph334","",100,0,197.7);
   Graph_Graph334->SetMinimum(9.317488e-147);
   ...
   Double_t Graph_fx336[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy336[17] = { 1.138804e-146, 1.322052e-108, 8.50435e-86, 1.303123e-70, 8.855704e-60, 1.149706e-51, 2.304495e-45, 2.49716e-40, 8.358989e-18, 9.447051e-07, 0.003584166, 0.1961792, 2.018858, 9.116238, 25.88363, 55.22245, 97.64918 };
   graph = new TGraph(17,Graph_fx336,Graph_fy336);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph336 = new TH1F("Graph_Graph336","",100,0,197.7);
   Graph_Graph336->SetMinimum(1.024924e-146);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(104.1631,0,104.1631,2.511853);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(104.1581,0,"  104.16 TeV");
