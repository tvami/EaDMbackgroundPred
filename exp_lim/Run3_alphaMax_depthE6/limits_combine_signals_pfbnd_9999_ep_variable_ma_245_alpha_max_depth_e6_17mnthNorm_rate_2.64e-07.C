...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_2.64e-07()
{
...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx309[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy309[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx309,Graph0_fy309);
   ...
   TH1F *Graph_Graph0309 = new TH1F("Graph_Graph0309","",100,0,197.7);
   ...
   Double_t Graph1_fx310[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy310[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx310,Graph1_fy310);
   ...
   TH1F *Graph_Graph1310 = new TH1F("Graph_Graph1310","Graph",100,0,197.7);
   Graph_Graph1310->SetMinimum(0.4736673);
   Graph_Graph1310->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx311[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy311[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx311,Graph2_fy311);
   ...
   TH1F *Graph_Graph2311 = new TH1F("Graph_Graph2311","Graph",100,0,197.7);
   Graph_Graph2311->SetMinimum(0.837719);
   Graph_Graph2311->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx312[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy312[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx312,Graph0_fy312);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0312 = new TH1F("Graph_Graph0312","",100,0,197.7);
   ...
   Double_t Graph_fx313[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy313[17] = { 2.822499e-117, 1.287654e-86, 2.984078e-68, 4.987689e-56, 2.595617e-47, 8.723317e-41, 1.019524e-35, 1.137233e-31, 1.371427e-13, 9.302991e-05, 0.06414316, 1.496694, 9.234567, 29.64924, 65.98243, 117.2661, 179.892 };
   graph = new TGraph(17,Graph_fx313,Graph_fy313);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph313 = new TH1F("Graph_Graph313","",100,0,197.7);
   ...
   Double_t Graph_fx315[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy315[17] = { 3.104749e-117, 1.41642e-86, 3.282485e-68, 5.486458e-56, 2.855178e-47, 9.595649e-41, 1.121476e-35, 1.250956e-31, 1.508569e-13, 0.0001023329, 0.07055748, 1.646363, 10.15802, 32.61417, 72.58067, 128.9927, 197.8812 };
   graph = new TGraph(17,Graph_fx315,Graph_fy315);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph315 = new TH1F("Graph_Graph315","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(84.36395,0,84.36395,2.226235);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(84.35895,0,"  84.36 TeV");
