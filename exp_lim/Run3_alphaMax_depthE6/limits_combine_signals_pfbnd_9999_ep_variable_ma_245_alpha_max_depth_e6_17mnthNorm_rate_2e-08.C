...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx113[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy113[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx113,Graph0_fy113);
   ...
   TH1F *Graph_Graph0113 = new TH1F("Graph_Graph0113","",100,0,197.7);
   ...
   Double_t Graph1_fx114[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy114[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx114,Graph1_fy114);
   ...
   TH1F *Graph_Graph1114 = new TH1F("Graph_Graph1114","Graph",100,0,197.7);
   Graph_Graph1114->SetMinimum(0.4736673);
   Graph_Graph1114->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx115[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy115[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx115,Graph2_fy115);
   ...
   TH1F *Graph_Graph2115 = new TH1F("Graph_Graph2115","Graph",100,0,197.7);
   Graph_Graph2115->SetMinimum(0.837719);
   Graph_Graph2115->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx116[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy116[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx116,Graph0_fy116);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0116 = new TH1F("Graph_Graph0116","",100,0,197.7);
   ...
   Double_t Graph_fx117[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy117[17] = { 39.11063, 39.39833, 36.88902, 33.69698, 30.5547, 27.69352, 25.16297, 22.94818, 11.18085, 4.820878, 2.857947, 1.955406, 1.451579, 1.135841, 0.9221245, 0.7692662, 0.6553138 };
   graph = new TGraph(17,Graph_fx117,Graph_fy117);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph117 = new TH1F("Graph_Graph117","",100,0,197.7);
   ...
   Double_t Graph_fx119[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy119[17] = { 43.0217, 43.33817, 40.57792, 37.06668, 33.61017, 30.46287, 27.67927, 25.243, 12.29894, 5.302966, 3.143742, 2.150946, 1.596736, 1.249425, 1.014337, 0.8461929, 0.7208451 };
   graph = new TGraph(17,Graph_fx119,Graph_fy119);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph119 = new TH1F("Graph_Graph119","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.333052,0,4.333052,38.54419);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.328052,0,"  4.33 TeV");
