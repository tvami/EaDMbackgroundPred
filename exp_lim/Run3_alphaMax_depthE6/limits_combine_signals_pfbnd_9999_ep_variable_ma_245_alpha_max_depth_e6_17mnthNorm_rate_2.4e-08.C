...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx141[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy141[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx141,Graph0_fy141);
   ...
   TH1F *Graph_Graph0141 = new TH1F("Graph_Graph0141","",100,0,197.7);
   ...
   Double_t Graph1_fx142[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy142[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx142,Graph1_fy142);
   ...
   TH1F *Graph_Graph1142 = new TH1F("Graph_Graph1142","Graph",100,0,197.7);
   Graph_Graph1142->SetMinimum(0.4736673);
   Graph_Graph1142->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx143[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy143[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx143,Graph2_fy143);
   ...
   TH1F *Graph_Graph2143 = new TH1F("Graph_Graph2143","Graph",100,0,197.7);
   Graph_Graph2143->SetMinimum(0.837719);
   Graph_Graph2143->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx144[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy144[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx144,Graph0_fy144);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0144 = new TH1F("Graph_Graph0144","",100,0,197.7);
   ...
   Double_t Graph_fx145[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy145[17] = { 39.58912, 47.71114, 49.74571, 48.81958, 46.59368, 43.88455, 41.08395, 38.37426, 20.82012, 9.473115, 5.71751, 3.947142, 2.945929, 2.313431, 1.882958, 1.573845, 1.342714 };
   graph = new TGraph(17,Graph_fx145,Graph_fy145);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph145 = new TH1F("Graph_Graph145","",100,0,197.7);
   ...
   Double_t Graph_fx147[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy147[17] = { 43.54803, 52.48226, 54.72029, 53.70153, 51.25304, 48.273, 45.19235, 42.21169, 22.90214, 10.42043, 6.289261, 4.341856, 3.240521, 2.544774, 2.071254, 1.73123, 1.476985 };
   graph = new TGraph(17,Graph_fx147,Graph_fy147);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph147 = new TH1F("Graph_Graph147","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.135629,0,4.135629,47.98214);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.130629,0,"  4.14 TeV");
