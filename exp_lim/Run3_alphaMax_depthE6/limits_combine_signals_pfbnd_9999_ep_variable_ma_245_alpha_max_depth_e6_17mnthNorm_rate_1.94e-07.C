...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_1.94e-07()
{
...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx260[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy260[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0260 = new TH1F("Graph_Graph0260","",100,0,197.7);
   ...
   Double_t Graph1_fx261[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy261[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph1261 = new TH1F("Graph_Graph1261","Graph",100,0,197.7);
   Graph_Graph1261->SetMinimum(0.4736673);
   Graph_Graph1261->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx262[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy262[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph2262 = new TH1F("Graph_Graph2262","Graph",100,0,197.7);
   Graph_Graph2262->SetMinimum(0.837719);
   Graph_Graph2262->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx263[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy263[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0263 = new TH1F("Graph_Graph0263","",100,0,197.7);
   ...
   Double_t Graph_fx264[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy264[17] = { 4.443791e-61, 1.329969e-44, 9.528062e-35, 3.379568e-28, 1.559169e-23, 4.787426e-20, 2.420864e-17, 3.47012e-15, 1.293649e-05, 0.4879106, 12.83983, 58.53119, 135.5746, 226.5237, 316.1643, 396.0002, 462.7456 };
   ...
   TH1F *Graph_Graph264 = new TH1F("Graph_Graph264","",100,0,197.7);
   ...
   Double_t Graph_fx266[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy266[17] = { 4.88817e-61, 1.462966e-44, 1.048087e-34, 3.717525e-28, 1.715086e-23, 5.266168e-20, 2.662951e-17, 3.817132e-15, 1.423013e-05, 0.5367016, 14.12381, 64.38431, 149.1321, 249.1761, 347.7807, 435.6002, 509.0201 };
   ...
   TH1F *Graph_Graph266 = new TH1F("Graph_Graph266","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(48.2077,0,48.2077,1.86714);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(48.2027,0,"  48.21 TeV");
