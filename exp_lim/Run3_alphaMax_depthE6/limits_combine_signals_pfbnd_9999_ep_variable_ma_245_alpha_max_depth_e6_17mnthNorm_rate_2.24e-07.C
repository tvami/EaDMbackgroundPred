...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_2.24e-07()
{
...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx281[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy281[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx281,Graph0_fy281);
   ...
   TH1F *Graph_Graph0281 = new TH1F("Graph_Graph0281","",100,0,197.7);
   ...
   Double_t Graph1_fx282[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy282[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx282,Graph1_fy282);
   ...
   TH1F *Graph_Graph1282 = new TH1F("Graph_Graph1282","Graph",100,0,197.7);
   Graph_Graph1282->SetMinimum(0.4736673);
   Graph_Graph1282->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx283[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy283[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx283,Graph2_fy283);
   ...
   TH1F *Graph_Graph2283 = new TH1F("Graph_Graph2283","Graph",100,0,197.7);
   Graph_Graph2283->SetMinimum(0.837719);
   Graph_Graph2283->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx284[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy284[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx284,Graph0_fy284);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0284 = new TH1F("Graph_Graph0284","",100,0,197.7);
   ...
   Double_t Graph_fx285[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy285[17] = { 5.095216e-83, 5.380755e-61, 8.21414e-48, 4.824544e-39, 8.560815e-33, 4.059703e-28, 1.725686e-24, 1.358361e-21, 1.079056e-08, 0.01878653, 1.773475, 15.31204, 52.02978, 112.2378, 188.0138, 270.0293, 350.9843 };
   graph = new TGraph(17,Graph_fx285,Graph_fy285);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph285 = new TH1F("Graph_Graph285","",100,0,197.7);
   Graph_Graph285->SetMinimum(4.585695e-83);
   ...
   Double_t Graph_fx287[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy287[17] = { 5.604738e-83, 5.91883e-61, 9.035554e-48, 5.306999e-39, 9.416896e-33, 4.465673e-28, 1.898254e-24, 1.494197e-21, 1.186962e-08, 0.02066519, 1.950823, 16.84325, 57.23275, 123.4616, 206.8152, 297.0322, 386.0827 };
   graph = new TGraph(17,Graph_fx287,Graph_fy287);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph287 = new TH1F("Graph_Graph287","",100,0,197.7);
   Graph_Graph287->SetMinimum(5.044264e-83);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(60.85797,0,60.85797,1.945301);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(60.85297,0,"  60.86 TeV");
