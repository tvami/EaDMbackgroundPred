...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx204[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy204[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx204,Graph0_fy204);
   ...
   TH1F *Graph_Graph0204 = new TH1F("Graph_Graph0204","",100,0,197.7);
   ...
   Double_t Graph1_fx205[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy205[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx205,Graph1_fy205);
   ...
   TH1F *Graph_Graph1205 = new TH1F("Graph_Graph1205","Graph",100,0,197.7);
   Graph_Graph1205->SetMinimum(0.4736673);
   Graph_Graph1205->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx206[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy206[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx206,Graph2_fy206);
   ...
   TH1F *Graph_Graph2206 = new TH1F("Graph_Graph2206","Graph",100,0,197.7);
   Graph_Graph2206->SetMinimum(0.837719);
   Graph_Graph2206->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx207[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy207[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx207,Graph0_fy207);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0207 = new TH1F("Graph_Graph0207","",100,0,197.7);
   ...
   Double_t Graph_fx208[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy208[17] = { 2.1199e-18, 7.97752e-13, 1.647058e-09, 2.548888e-07, 9.035315e-06, 0.0001280332, 0.0009872673, 0.004982, 5.352447, 108.3714, 231.7819, 301.2179, 328.5909, 332.3381, 324.0837, 310.2047, 294.0745 };
   graph = new TGraph(17,Graph_fx208,Graph_fy208);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph208 = new TH1F("Graph_Graph208","",100,0,197.7);
   ...
   Double_t Graph_fx210[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy210[17] = { 2.33189e-18, 8.775272e-13, 1.811764e-09, 2.803776e-07, 9.938847e-06, 0.0001408366, 0.001085994, 0.0054802, 5.887692, 119.2085, 254.9601, 331.3397, 361.45, 365.5719, 356.4921, 341.2252, 323.482 };
   graph = new TGraph(17,Graph_fx210,Graph_fy210);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph210 = new TH1F("Graph_Graph210","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(19.30815,0,19.30815,3.302504);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(19.30315,0,"  19.31 TeV");
