...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_1.34e-07()
{
...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx218[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy218[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx218,Graph0_fy218);
   ...
   TH1F *Graph_Graph0218 = new TH1F("Graph_Graph0218","",100,0,197.7);
   ...
   Double_t Graph1_fx219[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy219[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx219,Graph1_fy219);
   ...
   TH1F *Graph_Graph1219 = new TH1F("Graph_Graph1219","Graph",100,0,197.7);
   Graph_Graph1219->SetMinimum(0.4736673);
   Graph_Graph1219->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx220[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy220[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx220,Graph2_fy220);
   ...
   TH1F *Graph_Graph2220 = new TH1F("Graph_Graph2220","Graph",100,0,197.7);
   Graph_Graph2220->SetMinimum(0.837719);
   Graph_Graph2220->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx221[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy221[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx221,Graph0_fy221);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0221 = new TH1F("Graph_Graph0221","",100,0,197.7);
   ...
   Double_t Graph_fx222[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy222[17] = { 6.76174e-27, 3.979925e-19, 1.703234e-14, 1.988941e-11, 2.986394e-09, 1.24947e-07, 2.236396e-06, 2.213534e-05, 0.4929394, 45.43965, 161.0744, 269.4889, 342.0925, 382.7837, 401.2151, 405.3949, 400.8417 };
   graph = new TGraph(17,Graph_fx222,Graph_fy222);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph222 = new TH1F("Graph_Graph222","",100,0,197.7);
   ...
   Double_t Graph_fx224[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy224[17] = { 7.437914e-27, 4.377918e-19, 1.873558e-14, 2.187835e-11, 3.285033e-09, 1.374417e-07, 2.460036e-06, 2.434888e-05, 0.5422333, 49.98362, 177.1818, 296.4378, 376.3018, 421.0621, 441.3366, 445.9344, 440.9258 };
   graph = new TGraph(17,Graph_fx224,Graph_fy224);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","",100,0,197.7);
   Graph_Graph224->SetMinimum(6.694122e-27);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(27.27356,0,27.27356,2.554407);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(27.26856,0,"  27.27 TeV");
