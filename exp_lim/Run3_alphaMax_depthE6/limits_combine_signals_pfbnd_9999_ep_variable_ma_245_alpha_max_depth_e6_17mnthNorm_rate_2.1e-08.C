...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx120[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy120[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx120,Graph0_fy120);
   ...
   TH1F *Graph_Graph0120 = new TH1F("Graph_Graph0120","",100,0,197.7);
   ...
   Graph_Graph0120->GetXaxis()->SetRange(1,92);
   ...
   Double_t Graph1_fx121[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy121[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx121,Graph1_fy121);
   ...
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","Graph",100,0,197.7);
   Graph_Graph1121->SetMinimum(0.4736673);
   Graph_Graph1121->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx122[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy122[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx122,Graph2_fy122);
   ...
   TH1F *Graph_Graph2122 = new TH1F("Graph_Graph2122","Graph",100,0,197.7);
   Graph_Graph2122->SetMinimum(0.837719);
   Graph_Graph2122->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx123[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy123[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx123,Graph0_fy123);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0123 = new TH1F("Graph_Graph0123","",100,0,197.7);
   ...
   Graph_Graph0123->GetXaxis()->SetRange(1,92);
   ...
   Double_t Graph_fx124[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy124[17] = { 40.22534, 42.24943, 40.56233, 37.67663, 34.57334, 31.61755, 28.9291, 26.53015, 13.25407, 5.786846, 3.444957, 2.361965, 1.755582, 1.374868, 1.116843, 0.9321236, 0.7943233 };
   graph = new TGraph(17,Graph_fx124,Graph_fy124);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,0,197.7);
   ...
   Double_t Graph_fx126[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy126[17] = { 44.24788, 46.47437, 44.61856, 41.44429, 38.03067, 34.77931, 31.82202, 29.18317, 14.57948, 6.365531, 3.789452, 2.598161, 1.93114, 1.512355, 1.228527, 1.025336, 0.8737556 };
   graph = new TGraph(17,Graph_fx126,Graph_fy126);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.259864,0,4.259864,41.80438);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.254864,0,"  4.26 TeV");
