...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx197[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy197[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0197 = new TH1F("Graph_Graph0197","",100,0,197.7);
   ...
   Double_t Graph1_fx198[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy198[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph1198 = new TH1F("Graph_Graph1198","Graph",100,0,197.7);
   Graph_Graph1198->SetMinimum(0.4736673);
   Graph_Graph1198->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx199[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy199[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph2199 = new TH1F("Graph_Graph2199","Graph",100,0,197.7);
   Graph_Graph2199->SetMinimum(0.837719);
   Graph_Graph2199->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx200[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy200[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0200 = new TH1F("Graph_Graph0200","",100,0,197.7);
   ...
   Double_t Graph_fx201[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy201[17] = { 1.058004e-14, 4.32141e-10, 2.354062e-07, 1.498628e-05, 0.0002816692, 0.002480039, 0.01320793, 0.04956958, 14.05125, 146.1345, 250.309, 291.1099, 297.0977, 287.4323, 271.5409, 253.801, 236.1922 };
   ...
   TH1F *Graph_Graph201 = new TH1F("Graph_Graph201","",100,0,197.7);
   Graph_Graph201->SetMinimum(9.52204e-15);
   ...
   Double_t Graph_fx203[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy203[17] = { 1.163805e-14, 4.753551e-10, 2.589468e-07, 1.648491e-05, 0.0003098362, 0.002728043, 0.01452873, 0.05452653, 15.45638, 160.748, 275.3399, 320.2209, 326.8075, 316.1755, 298.695, 279.1811, 259.8115 };
   ...
   TH1F *Graph_Graph203 = new TH1F("Graph_Graph203","",100,0,197.7);
   Graph_Graph203->SetMinimum(1.047424e-14);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(17.697,0,17.697,3.827413);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(17.692,0,"  17.70 TeV");
