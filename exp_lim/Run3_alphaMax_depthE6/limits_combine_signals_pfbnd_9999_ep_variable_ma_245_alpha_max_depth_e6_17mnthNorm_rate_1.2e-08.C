...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_1.2e-08()
{
...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx57[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy57[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx57,Graph0_fy57);
   ...
   TH1F *Graph_Graph057 = new TH1F("Graph_Graph057","",100,0,197.7);
   ...
   Double_t Graph1_fx58[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy58[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx58,Graph1_fy58);
   ...
   TH1F *Graph_Graph158 = new TH1F("Graph_Graph158","Graph",100,0,197.7);
   Graph_Graph158->SetMinimum(0.4736673);
   Graph_Graph158->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx59[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy59[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx59,Graph2_fy59);
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","Graph",100,0,197.7);
   Graph_Graph259->SetMinimum(0.837719);
   Graph_Graph259->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx60[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy60[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx60,Graph0_fy60);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph060 = new TH1F("Graph_Graph060","",100,0,197.7);
   ...
   Double_t Graph_fx61[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy61[17] = { 14.38498, 11.16452, 8.939387, 7.357, 6.191985, 5.307154, 4.617108, 4.06683, 1.69446, 0.6756268, 0.3902201, 0.2635298, 0.1941046, 0.1510942, 0.1222086, 0.101666, 0.08641805 };
   graph = new TGraph(17,Graph_fx61,Graph_fy61);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph61 = new TH1F("Graph_Graph61","",100,0,197.7);
   Graph_Graph61->SetMinimum(0.07777624);
   Graph_Graph61->SetMaximum(15.81484);
   ...
   Double_t Graph_fx63[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy63[17] = { 15.82348, 12.28097, 9.833326, 8.0927, 6.811183, 5.837869, 5.078819, 4.473513, 1.863906, 0.7431895, 0.4292421, 0.2898828, 0.2135151, 0.1662037, 0.1344295, 0.1118326, 0.09505985 };
   graph = new TGraph(17,Graph_fx63,Graph_fy63);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph63 = new TH1F("Graph_Graph63","",100,0,197.7);
   Graph_Graph63->SetMinimum(0.08555387);
   Graph_Graph63->SetMaximum(17.39632);
