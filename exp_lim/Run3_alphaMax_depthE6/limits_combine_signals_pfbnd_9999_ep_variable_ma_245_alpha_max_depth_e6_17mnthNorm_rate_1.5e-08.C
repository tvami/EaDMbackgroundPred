...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx78[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy78[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx78,Graph0_fy78);
   ...
   TH1F *Graph_Graph078 = new TH1F("Graph_Graph078","",100,0,197.7);
   ...
   Double_t Graph1_fx79[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy79[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx79,Graph1_fy79);
   ...
   TH1F *Graph_Graph179 = new TH1F("Graph_Graph179","Graph",100,0,197.7);
   Graph_Graph179->SetMinimum(0.4736673);
   Graph_Graph179->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx80[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy80[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx80,Graph2_fy80);
   ...
   TH1F *Graph_Graph280 = new TH1F("Graph_Graph280","Graph",100,0,197.7);
   Graph_Graph280->SetMinimum(0.837719);
   Graph_Graph280->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx81[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy81[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx81,Graph0_fy81);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph081 = new TH1F("Graph_Graph081","",100,0,197.7);
   ...
   Double_t Graph_fx82[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy82[17] = { 25.24726, 21.28035, 17.90386, 15.22907, 13.12323, 11.44857, 10.09792, 8.992814, 3.937052, 1.609151, 0.9370935, 0.6354695, 0.4692193, 0.3658513, 0.2962583, 0.2466767, 0.2098242 };
   graph = new TGraph(17,Graph_fx82,Graph_fy82);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph82 = new TH1F("Graph_Graph82","",100,0,197.7);
   Graph_Graph82->SetMinimum(0.1888418);
   Graph_Graph82->SetMaximum(27.75101);
   ...
   Double_t Graph_fx84[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy84[17] = { 27.77199, 23.40838, 19.69425, 16.75197, 14.43555, 12.59342, 11.10771, 9.892095, 4.330757, 1.770066, 1.030803, 0.6990165, 0.5161412, 0.4024364, 0.3258841, 0.2713444, 0.2308066 };
   graph = new TGraph(17,Graph_fx84,Graph_fy84);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph84 = new TH1F("Graph_Graph84","",100,0,197.7);
   Graph_Graph84->SetMinimum(0.207726);
   Graph_Graph84->SetMaximum(30.52611);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(6.549843,0,6.549843,14.03251);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(6.544843,0,"  6.55 TeV");
