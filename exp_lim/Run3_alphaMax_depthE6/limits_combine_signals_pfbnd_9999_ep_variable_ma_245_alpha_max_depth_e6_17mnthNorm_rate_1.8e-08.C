...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx99[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy99[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx99,Graph0_fy99);
   ...
   TH1F *Graph_Graph099 = new TH1F("Graph_Graph099","",100,0,197.7);
   ...
   Double_t Graph1_fx100[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy100[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx100,Graph1_fy100);
   ...
   TH1F *Graph_Graph1100 = new TH1F("Graph_Graph1100","Graph",100,0,197.7);
   Graph_Graph1100->SetMinimum(0.4736673);
   Graph_Graph1100->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx101[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy101[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx101,Graph2_fy101);
   ...
   TH1F *Graph_Graph2101 = new TH1F("Graph_Graph2101","Graph",100,0,197.7);
   Graph_Graph2101->SetMinimum(0.837719);
   Graph_Graph2101->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx102[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy102[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx102,Graph0_fy102);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0102 = new TH1F("Graph_Graph0102","",100,0,197.7);
   ...
   Double_t Graph_fx103[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy103[17] = { 34.97454, 32.60718, 29.14469, 25.81099, 22.89209, 20.40708, 18.30463, 16.52207, 7.684543, 3.237298, 1.904358, 1.297927, 0.9612696, 0.7510172, 0.6090339, 0.5076546, 0.4321761 };
   graph = new TGraph(17,Graph_fx103,Graph_fy103);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph103 = new TH1F("Graph_Graph103","",100,0,197.7);
   ...
   Double_t Graph_fx105[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy105[17] = { 38.472, 35.8679, 32.05916, 28.39209, 25.1813, 22.44779, 20.13509, 18.17428, 8.452998, 3.561028, 2.094794, 1.427719, 1.057397, 0.8261189, 0.6699373, 0.5584201, 0.4753938 };
   graph = new TGraph(17,Graph_fx105,Graph_fy105);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph105 = new TH1F("Graph_Graph105","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.538297,0,4.538297,30.69511);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.533297,0,"  4.54 TeV");
