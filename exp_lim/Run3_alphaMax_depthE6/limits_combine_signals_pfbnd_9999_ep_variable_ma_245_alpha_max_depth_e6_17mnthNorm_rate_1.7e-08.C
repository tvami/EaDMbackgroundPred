...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx92[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy92[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph092 = new TH1F("Graph_Graph092","",100,0,197.7);
   ...
   Double_t Graph1_fx93[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy93[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph193 = new TH1F("Graph_Graph193","Graph",100,0,197.7);
   Graph_Graph193->SetMinimum(0.4736673);
   Graph_Graph193->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx94[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy94[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph294 = new TH1F("Graph_Graph294","Graph",100,0,197.7);
   Graph_Graph294->SetMinimum(0.837719);
   Graph_Graph294->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx95[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy95[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph095 = new TH1F("Graph_Graph095","",100,0,197.7);
   ...
   Double_t Graph_fx96[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy96[17] = { 32.09169, 28.87155, 25.25957, 22.05351, 19.3613, 17.12822, 15.27255, 13.71989, 6.246172, 2.603356, 1.525987, 1.038194, 0.7680843, 0.5996584, 0.4860426, 0.4049816, 0.3446662 };
   ...
   TH1F *Graph_Graph96 = new TH1F("Graph_Graph96","",100,0,197.7);
   ...
   Double_t Graph_fx98[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy98[17] = { 35.30086, 31.7587, 27.78553, 24.25886, 21.29743, 18.84104, 16.79981, 15.09188, 6.870789, 2.863691, 1.678586, 1.142013, 0.8448928, 0.6596242, 0.5346468, 0.4454798, 0.3791328 };
   ...
   TH1F *Graph_Graph98 = new TH1F("Graph_Graph98","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.674796,0,4.674796,26.38166);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.669796,0,"  4.67 TeV");
