...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx316[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy316[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0316 = new TH1F("Graph_Graph0316","",100,0,197.7);
   ...
   Double_t Graph1_fx317[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy317[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph1317 = new TH1F("Graph_Graph1317","Graph",100,0,197.7);
   Graph_Graph1317->SetMinimum(0.4736673);
   Graph_Graph1317->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx318[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy318[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph2318 = new TH1F("Graph_Graph2318","Graph",100,0,197.7);
   Graph_Graph2318->SetMinimum(0.837719);
   Graph_Graph2318->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx319[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy319[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0319 = new TH1F("Graph_Graph0319","",100,0,197.7);
   ...
   Double_t Graph_fx320[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy320[17] = { 9.884384e-127, 1.081886e-93, 6.717889e-74, 1.005424e-60, 2.504434e-51, 2.723738e-44, 7.935222e-39, 1.838034e-34, 5.939061e-15, 2.085396e-05, 0.02487271, 0.7633243, 5.551301, 19.8881, 47.86399, 90.20984, 144.8529 };
   ...
   TH1F *Graph_Graph320 = new TH1F("Graph_Graph320","",100,0,197.7);
   Graph_Graph320->SetMinimum(8.895945e-127);
   ...
   Double_t Graph_fx322[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy322[17] = { 1.087282e-126, 1.190075e-93, 7.389678e-74, 1.105966e-60, 2.754878e-51, 2.996112e-44, 8.728744e-39, 2.021837e-34, 6.532967e-15, 2.293935e-05, 0.02735998, 0.8396568, 6.106431, 21.87691, 52.65039, 99.23082, 159.3382 };
   ...
   TH1F *Graph_Graph322 = new TH1F("Graph_Graph322","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(91.22108,0,91.22108,2.323599);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(91.21608,0,"  91.22 TeV");
