...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_8e-09()
{
...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx29[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy29[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   TGraph *graph = new TGraph(17,Graph0_fx29,Graph0_fy29);
   ...
   TH1F *Graph_Graph029 = new TH1F("Graph_Graph029","",100,0,197.7);
   ...
   Double_t Graph1_fx30[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy30[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   graph = new TGraph(36,Graph1_fx30,Graph1_fy30);
   ...
   TH1F *Graph_Graph130 = new TH1F("Graph_Graph130","Graph",100,0,197.7);
   Graph_Graph130->SetMinimum(0.4736673);
   Graph_Graph130->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx31[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy31[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   graph = new TGraph(36,Graph2_fx31,Graph2_fy31);
   ...
   TH1F *Graph_Graph231 = new TH1F("Graph_Graph231","Graph",100,0,197.7);
   Graph_Graph231->SetMinimum(0.837719);
   Graph_Graph231->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx32[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy32[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   graph = new TGraph(17,Graph0_fx32,Graph0_fy32);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph032 = new TH1F("Graph_Graph032","",100,0,197.7);
   ...
   Double_t Graph_fx33[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy33[17] = { 3.936495, 2.816106, 2.147247, 1.710482, 1.406487, 1.184633, 1.016702, 0.885851, 0.3514804, 0.13676, 0.07834709, 0.05269549, 0.03871843, 0.03008999, 0.02430919, 0.02020528, 0.01716322 };
   graph = new TGraph(17,Graph_fx33,Graph_fy33);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","",100,0,197.7);
   Graph_Graph33->SetMinimum(0.0154469);
   Graph_Graph33->SetMaximum(4.328428);
   ...
   Double_t Graph_fx35[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy35[17] = { 4.330144, 3.097716, 2.361972, 1.88153, 1.547136, 1.303096, 1.118372, 0.9744361, 0.3866285, 0.150436, 0.0861818, 0.05796503, 0.04259027, 0.03309899, 0.0267401, 0.02222581, 0.01887955 };
   graph = new TGraph(17,Graph_fx35,Graph_fy35);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","",100,0,197.7);
   Graph_Graph35->SetMinimum(0.01699159);
   Graph_Graph35->SetMaximum(4.761271);
