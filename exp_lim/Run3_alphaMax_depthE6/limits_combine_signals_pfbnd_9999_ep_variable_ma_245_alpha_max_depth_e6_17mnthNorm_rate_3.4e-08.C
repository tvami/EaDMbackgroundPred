...
//=========  (Wed Mar 11 02:53:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx148[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy148[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0148 = new TH1F("Graph_Graph0148","",100,0,197.7);
   ...
   Double_t Graph1_fx149[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy149[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph1149 = new TH1F("Graph_Graph1149","Graph",100,0,197.7);
   Graph_Graph1149->SetMinimum(0.4736673);
   Graph_Graph1149->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx150[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy150[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph2150 = new TH1F("Graph_Graph2150","Graph",100,0,197.7);
   Graph_Graph2150->SetMinimum(0.837719);
   Graph_Graph2150->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx151[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy151[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0151 = new TH1F("Graph_Graph0151","",100,0,197.7);
   ...
   Double_t Graph_fx152[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy152[17] = { 15.00711, 32.6534, 48.53071, 60.32397, 68.16063, 72.86203, 75.27078, 76.06868, 58.83037, 31.95857, 20.46257, 14.55008, 11.05357, 8.783519, 7.209717, 6.064413, 5.199342 };
   ...
   TH1F *Graph_Graph152 = new TH1F("Graph_Graph152","",100,0,197.7);
   ...
   Double_t Graph_fx154[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy154[17] = { 16.50782, 35.91874, 53.38378, 66.35637, 74.97669, 80.14823, 82.79786, 83.67555, 64.71341, 35.15443, 22.50883, 16.00509, 12.15892, 9.66187, 7.930689, 6.670854, 5.719277 };
   ...
   TH1F *Graph_Graph154 = new TH1F("Graph_Graph154","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.355557,0,4.355557,37.59375);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.350557,0,"  4.36 TeV");
