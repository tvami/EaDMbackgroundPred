...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e6_17mnthNorm_rate_2.54e-07()
{
...
//=========  (Wed Mar 11 02:53:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx302[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy302[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0302 = new TH1F("Graph_Graph0302","",100,0,197.7);
   ...
   Double_t Graph1_fx303[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph1_fy303[36] = { 218121.6, 77.40256, 35.87902, 31.73026, 24.03615, 25.22691, 19.13178, 17.07189, 8.359387, 5.536463, 5.886888, 6.587708, 7.463733, 8.339758, 9.11066, 9.881562, 10.89775,
   ...
   TH1F *Graph_Graph1303 = new TH1F("Graph_Graph1303","Graph",100,0,197.7);
   Graph_Graph1303->SetMinimum(0.4736673);
   Graph_Graph1303->SetMaximum(239933.8);
   ...
   Double_t Graph2_fx304[36] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   5, 4, 3 };
   Double_t Graph2_fy304[36] = { 182359.7, 65.22184, 26.08884, 23.43252, 17.31721, 18.69022, 13.44762, 11.66385, 5.225029, 3.627796, 3.909491, 4.377049, 4.959103, 5.541158, 6.053365, 6.565573, 7.240756,
   ...
   TH1F *Graph_Graph2304 = new TH1F("Graph_Graph2304","Graph",100,0,197.7);
   Graph_Graph2304->SetMinimum(0.837719);
   Graph_Graph2304->SetMaximum(200595.5);
   ...
   Double_t Graph0_fx305[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy305[17] = { 145989.6, 55.77344, 18.39141, 16.77812, 12.12266, 13.45938, 9.195703, 7.74375, 3.099805, 1.820703, 1.935938, 2.166406, 2.454492, 2.742578, 2.996094, 3.249609, 3.583789 };
   ...
   TH1F *Graph_Graph0305 = new TH1F("Graph_Graph0305","",100,0,197.7);
   ...
   Double_t Graph_fx306[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy306[17] = { 3.547404e-108, 8.26966e-80, 8.082489e-63, 1.636812e-51, 1.886253e-43, 2.046379e-37, 9.925908e-33, 5.478693e-29, 2.786417e-12, 0.0003881673, 0.157902, 2.830028, 14.90481, 43.06177, 88.87293, 149.266, 219.1309 };
   ...
   TH1F *Graph_Graph306 = new TH1F("Graph_Graph306","",100,0,197.7);
   ...
   Double_t Graph_fx308[17] = { 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy308[17] = { 3.902145e-108, 9.096626e-80, 8.890738e-63, 1.800493e-51, 2.074879e-43, 2.251017e-37, 1.09185e-32, 6.026562e-29, 3.065058e-12, 0.000426984, 0.1736922, 3.113031, 16.3953, 47.36794, 97.76023, 164.1926, 241.044 };
   ...
   TH1F *Graph_Graph308 = new TH1F("Graph_Graph308","",100,0,197.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(78.07313,0,78.07313,2.143057);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(78.06813,0,"  78.07 TeV");
