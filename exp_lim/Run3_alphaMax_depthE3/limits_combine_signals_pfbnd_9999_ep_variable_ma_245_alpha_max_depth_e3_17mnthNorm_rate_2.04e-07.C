...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e3_17mnthNorm_rate_2.04e-07()
{
...
//=========  (Wed Mar 11 02:52:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx267[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy267[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   TGraph *graph = new TGraph(18,Graph0_fx267,Graph0_fy267);
   ...
   TH1F *Graph_Graph0267 = new TH1F("Graph_Graph0267","",100,0,197.8);
   ...
   Double_t Graph1_fx268[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy268[38] = { 22.50189, 17.28028, 15.82433, 12.2149, 10.79262, 9.005536, 8.479922, 8.304717, 8.620086, 10.93279, 16.39919, 22.00575, 27.75247, 32.79838, 37.98445, 42.32953, 49.89839,
   ...
   graph = new TGraph(38,Graph1_fx268,Graph1_fy268);
   ...
   TH1F *Graph_Graph1268 = new TH1F("Graph_Graph1268","Graph",100,0,197.8);
   Graph_Graph1268->SetMinimum(0.7008996);
   Graph_Graph1268->SetMaximum(58.81904);
   ...
   Double_t Graph2_fx269[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy269[38] = { 14.98764, 11.1481, 10.44196, 7.320657, 6.406981, 5.841885, 5.612076, 5.50701, 5.727415, 7.264038, 10.89606, 14.62121, 18.43948, 21.79211, 25.23788, 28.12487, 33.15382,
   ...
   graph = new TGraph(38,Graph2_fx269,Graph2_fy269);
   ...
   TH1F *Graph_Graph2269 = new TH1F("Graph_Graph2269","Graph",100,0,197.8);
   Graph_Graph2269->SetMinimum(1.249978);
   Graph_Graph2269->SetMaximum(38.99379);
   ...
   Double_t Graph0_fx270[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy270[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   graph = new TGraph(18,Graph0_fx270,Graph0_fy270);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0270 = new TH1F("Graph_Graph0270","",100,0,197.8);
   ...
   Double_t Graph_fx271[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy271[18] = { 1.306509e-104, 4.922532e-68, 8.491724e-50, 6.927723e-39, 1.243755e-31, 1.827383e-26, 1.337629e-22, 1.329405e-19, 3.271856e-17, 1.388986e-06, 0.1767819, 6.977967, 38.95768, 101.9074, 184.6526, 273.0912, 357.2359,
   431.7921 };
   graph = new TGraph(18,Graph_fx271,Graph_fy271);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph271 = new TH1F("Graph_Graph271","",100,0,197.8);
   ...
   Double_t Graph_fx273[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy273[18] = { 1.43716e-104, 5.414785e-68, 9.340897e-50, 7.620495e-39, 1.368131e-31, 2.010122e-26, 1.471392e-22, 1.462346e-19, 3.599041e-17, 1.527885e-06, 0.1944601, 7.675763, 42.85345, 112.0981, 203.1178, 300.4003, 392.9595,
   474.9713 };
   graph = new TGraph(18,Graph_fx273,Graph_fy273);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph273 = new TH1F("Graph_Graph273","",100,0,197.8);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(60.48949,0,60.48949,7.27793);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(60.48449,0,"  60.49 TeV");
