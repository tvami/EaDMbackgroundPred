...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e3_17mnthNorm_rate_1.84e-07()
{
...
//=========  (Wed Mar 11 02:52:02 2026) by ROOT version 6.30/07
   ...
   180 };
   Double_t Graph0_fy253[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   ...
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy254[38] = { 22.50189, 17.28028, 15.82433, 12.2149, 10.79262, 9.005536, 8.479922, 8.304717, 8.620086, 10.93279, 16.39919, 22.00575, 27.75247, 32.79838, 37.98445, 42.32953, 49.89839,
   ...
   Graph_Graph1254->SetMinimum(0.7008996);
   Graph_Graph1254->SetMaximum(58.81904);
   ...
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy255[38] = { 14.98764, 11.1481, 10.44196, 7.320657, 6.406981, 5.841885, 5.612076, 5.50701, 5.727415, 7.264038, 10.89606, 14.62121, 18.43948, 21.79211, 25.23788, 28.12487, 33.15382,
   ...
   Graph_Graph2255->SetMinimum(1.249978);
   Graph_Graph2255->SetMaximum(38.99379);
   ...
   180 };
   Double_t Graph0_fy256[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(51.26387,0,51.26387,6.364371);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(51.25887,0,"  51.26 TeV");
