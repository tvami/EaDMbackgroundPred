...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e3_17mnthNorm_rate_2.74e-07()
{
...
//=========  (Wed Mar 11 02:52:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx316[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy316[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   TGraph *graph = new TGraph(18,Graph0_fx316,Graph0_fy316);
   ...
   Double_t Graph1_fx317[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy317[38] = { 22.50189, 17.28028, 15.82433, 12.2149, 10.79262, 9.005536, 8.479922, 8.304717, 8.620086, 10.93279, 16.39919, 22.00575, 27.75247, 32.79838, 37.98445, 42.32953, 49.89839,
   ...
   graph = new TGraph(38,Graph1_fx317,Graph1_fy317);
   ...
   Graph_Graph1317->SetMinimum(0.7008996);
   Graph_Graph1317->SetMaximum(58.81904);
   ...
   Double_t Graph2_fx318[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy318[38] = { 14.98764, 11.1481, 10.44196, 7.320657, 6.406981, 5.841885, 5.612076, 5.50701, 5.727415, 7.264038, 10.89606, 14.62121, 18.43948, 21.79211, 25.23788, 28.12487, 33.15382,
   ...
   graph = new TGraph(38,Graph2_fx318,Graph2_fy318);
   ...
   Graph_Graph2318->SetMinimum(1.249978);
   Graph_Graph2318->SetMaximum(38.99379);
   ...
   Double_t Graph0_fx319[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy319[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   graph = new TGraph(18,Graph0_fx319,Graph0_fy319);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx320[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy320[18] = { 6.516807e-193, 9.884384e-127, 1.081886e-93, 6.717889e-74, 1.005424e-60, 2.504434e-51, 2.723738e-44, 7.935222e-39, 1.838034e-34, 5.939061e-15, 2.085396e-05, 0.02487271, 0.7633243, 5.551301, 19.8881, 47.86399, 90.20984,
   144.8529 };
   graph = new TGraph(18,Graph_fx320,Graph_fy320);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx322[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy322[18] = { 7.168488e-193, 1.087282e-126, 1.190075e-93, 7.389678e-74, 1.105966e-60, 2.754878e-51, 2.996112e-44, 8.728744e-39, 2.021837e-34, 6.532967e-15, 2.293935e-05, 0.02735998, 0.8396568, 6.106431, 21.87691, 52.65039, 99.23082,
   159.3382 };
   graph = new TGraph(18,Graph_fx322,Graph_fy322);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(111.7633,0,111.7633,11.7586);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(111.7583,0,"  111.76 TeV");
