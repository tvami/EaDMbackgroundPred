...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e3_17mnthNorm_rate_7.4e-08()
{
...
//=========  (Wed Mar 11 02:52:02 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx176[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy176[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   TGraph *graph = new TGraph(18,Graph0_fx176,Graph0_fy176);
   ...
   TH1F *Graph_Graph0176 = new TH1F("Graph_Graph0176","",100,0,197.8);
   ...
   Double_t Graph1_fx177[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy177[38] = { 22.50189, 17.28028, 15.82433, 12.2149, 10.79262, 9.005536, 8.479922, 8.304717, 8.620086, 10.93279, 16.39919, 22.00575, 27.75247, 32.79838, 37.98445, 42.32953, 49.89839,
   ...
   graph = new TGraph(38,Graph1_fx177,Graph1_fy177);
   ...
   TH1F *Graph_Graph1177 = new TH1F("Graph_Graph1177","Graph",100,0,197.8);
   Graph_Graph1177->SetMinimum(0.7008996);
   Graph_Graph1177->SetMaximum(58.81904);
   ...
   Double_t Graph2_fx178[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy178[38] = { 14.98764, 11.1481, 10.44196, 7.320657, 6.406981, 5.841885, 5.612076, 5.50701, 5.727415, 7.264038, 10.89606, 14.62121, 18.43948, 21.79211, 25.23788, 28.12487, 33.15382,
   ...
   graph = new TGraph(38,Graph2_fx178,Graph2_fy178);
   ...
   TH1F *Graph_Graph2178 = new TH1F("Graph_Graph2178","Graph",100,0,197.8);
   Graph_Graph2178->SetMinimum(1.249978);
   Graph_Graph2178->SetMaximum(38.99379);
   ...
   Double_t Graph0_fx179[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy179[18] = { 9.794922, 7.029297, 6.960156, 4.332813, 3.549219, 2.961523, 2.788672, 2.731055, 2.834766, 3.595313, 5.392969, 7.236719, 9.126563, 10.78594, 12.49141, 13.92031, 16.40938,
   17.60781 };
   graph = new TGraph(18,Graph0_fx179,Graph0_fy179);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0179 = new TH1F("Graph_Graph0179","",100,0,197.8);
   ...
   Double_t Graph_fx180[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy180[18] = { 1.91769e-10, 7.634387e-06, 0.001353752, 0.02820378, 0.203814, 0.8096846, 2.222348, 4.780348, 8.68674, 94.17436, 191.5395, 190.4341, 168.7355, 146.2775, 126.9306, 110.9476, 97.82839,
   87.00631 };
   graph = new TGraph(18,Graph_fx180,Graph_fy180);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph180 = new TH1F("Graph_Graph180","",100,0,197.8);
   ...
   Double_t Graph_fx182[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy182[18] = { 2.109458e-10, 8.397825e-06, 0.001489127, 0.03102416, 0.2241954, 0.890653, 2.444583, 5.258383, 9.555414, 103.5918, 210.6935, 209.4775, 185.6091, 160.9053, 139.6237, 122.0424, 107.6112,
   95.70694 };
   graph = new TGraph(18,Graph_fx182,Graph_fy182);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph182 = new TH1F("Graph_Graph182","",100,0,197.8);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(8.288502,0,8.288502,2.771926);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(8.283502,0,"  8.29 TeV");
