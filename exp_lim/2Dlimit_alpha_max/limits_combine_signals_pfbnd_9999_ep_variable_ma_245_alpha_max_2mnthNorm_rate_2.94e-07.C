...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_2mnthNorm_rate_2.94e-07()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Sep 19 20:08:06 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx267[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy267[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 18.50586, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   TGraph *graph = new TGraph(28,Graph0_fx267,Graph0_fy267);
   ...
   TH1F *Graph_Graph0267 = new TH1F("Graph_Graph0267","",100,1.42,10.78);
   ...
   Graph_Graph0267->GetXaxis()->SetTitle("m(X) [TeV]");
   Graph_Graph0267->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph1_fx268[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   ...
   Double_t Graph1_fy268[58] = { 58.779, 51.64776, 45.92929, 43.98549, 45.6157, 46.96366, 45.67817, 44.11966, 42.26104, 41.07864, 41.22047, 41.3882, 41.46952, 41.86501, 42.41551, 41.4595, 41.57227,
   ...
   graph = new TGraph(58,Graph1_fx268,Graph1_fy268);
   ...
   TH1F *Graph_Graph1268 = new TH1F("Graph_Graph1268","Graph",100,1.42,10.78);
   Graph_Graph1268->SetMinimum(1.19432);
   Graph_Graph1268->SetMaximum(64.01397);
   ...
   Double_t Graph2_fx269[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10, 10, 9.5, 9,
   8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4,
   3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2 };
   Double_t Graph2_fy269[58] = { 41.08932, 34.68272, 30.43059, 29.10126, 30.56705, 31.66236, 30.49195, 28.98051, 27.44781, 26.52774, 26.5394, 26.79385, 26.96737, 27.20667, 27.4908, 26.67214, 26.60195,
   ...
   graph = new TGraph(58,Graph2_fx269,Graph2_fy269);
   ...
   TH1F *Graph_Graph2269 = new TH1F("Graph_Graph2269","Graph",100,1.42,10.78);
   Graph_Graph2269->SetMinimum(6.357724);
   Graph_Graph2269->SetMaximum(44.24674);
   ...
   Double_t Graph0_fx270[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy270[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 18.50586, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   graph = new TGraph(28,Graph0_fx270,Graph0_fy270);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0270 = new TH1F("Graph_Graph0270","",100,1.42,10.78);
   ...
   Graph_Graph0270->GetXaxis()->SetTitle("m(X) [TeV]");
   Graph_Graph0270->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph_fx271[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy271[28] = { 3.826243e-202, 8.153347e-185, 3.716196e-170, 1.353433e-157, 1.035276e-146, 3.433277e-137, 8.591437e-129, 2.496317e-121, 1.183492e-114, 1.201866e-108, 3.258696e-103, 2.824874e-98, 9.086026e-94, 1.227555e-89, 7.731227e-86, 2.479024e-82, 4.362615e-79,
   4.493614e-76, 2.863641e-73, 1.184657e-70, 9.300711e-64, 8.05064e-60, 1.074796e-54, 1.045187e-51, 9.489525e-48, 2.094995e-45, 2.942856e-42, 2.270145e-40 };
   graph = new TGraph(28,Graph_fx271,Graph_fy271);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph271 = new TH1F("Graph_Graph271","",100,1.42,10.78);
   Graph_Graph271->SetMinimum(3.443619e-202);
   Graph_Graph271->SetMaximum(2.49716e-40);
   ...
   Double_t Graph_fx273[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy273[28] = { 4.208867e-202, 8.968681e-185, 4.087816e-170, 1.488777e-157, 1.138804e-146, 3.776605e-137, 9.450581e-129, 2.745948e-121, 1.301841e-114, 1.322052e-108, 3.584565e-103, 3.107361e-98, 9.994629e-94, 1.35031e-89, 8.50435e-86, 2.726926e-82, 4.798877e-79,
   4.942975e-76, 3.150005e-73, 1.303123e-70, 1.023078e-63, 8.855704e-60, 1.182276e-54, 1.149706e-51, 1.043848e-47, 2.304495e-45, 3.237141e-42, 2.49716e-40 };
   graph = new TGraph(28,Graph_fx273,Graph_fy273);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph273 = new TH1F("Graph_Graph273","",100,1.42,10.78);
   Graph_Graph273->SetMinimum(3.78798e-202);
   Graph_Graph273->SetMaximum(2.746876e-40);
