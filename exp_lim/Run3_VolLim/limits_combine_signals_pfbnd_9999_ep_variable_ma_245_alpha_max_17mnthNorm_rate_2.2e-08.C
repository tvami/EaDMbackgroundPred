...
//=========  (Sun Jun  7 15:43:28 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy127[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy128[42] = { 966.8369, 28.31147, 23.14656, 12.0047, 11.00459, 10.84344, 10.11458, 17.58853, 24.27049, 31.64054, 38.51364, 70.28069, 71.92749, 70.07542, 71.33798, 70.4891, 68.03181,
   ...
   Graph_Graph1128->SetMinimum(0.9501868);
   Graph_Graph1128->SetMaximum(1063.415);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy129[42] = { 615.0603, 17.62199, 14.72369, 7.853728, 7.417407, 7.257318, 6.59187, 11.68629, 16.12596, 21.02282, 25.58949, 46.69636, 47.79054, 46.55998, 47.39885, 46.83484, 45.20215,
   ...
   Graph_Graph2129->SetMinimum(1.60754);
   Graph_Graph2129->SetMaximum(676.3877);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy130[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   23.26456, 23.36614, 23.36614 };
   ...
   Double_t Graph_fx131[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy131[20] = { 40.6651, 44.62372, 43.98267, 41.57573, 38.63174, 35.66215, 32.86887, 6.879369, 4.113322, 2.826399, 2.033161, 0.7432414, 0.4266028, 0.2874009, 0.2113818, 0.164385, 0.1328673,
   0.110476, 0.09386914, 0.09386914 };
   graph = new TGraph(20,Graph_fx131,Graph_fy131);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph131 = new TH1F("Graph_Graph131","",100,2.7,1099.7);
   Graph_Graph131->SetMinimum(0.08448223);
   Graph_Graph131->SetMaximum(49.07671);
   ...
   Double_t Graph_fx133[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy133[20] = { 44.73161, 49.08609, 48.38094, 45.7333, 42.49491, 39.22836, 36.15576, 7.567306, 4.524654, 3.109039, 2.236477, 0.8175655, 0.4692631, 0.316141, 0.23252, 0.1808235, 0.146154,
   0.1215236, 0.1032561, 0.1032561 };
   graph = new TGraph(20,Graph_fx133,Graph_fy133);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph133 = new TH1F("Graph_Graph133","",100,2.7,1099.7);
   Graph_Graph133->SetMinimum(0.09293045);
   Graph_Graph133->SetMaximum(53.98438);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(3.602222,0,3.602222,43.00489);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(3.597222,0,"  3.60 TeV");
