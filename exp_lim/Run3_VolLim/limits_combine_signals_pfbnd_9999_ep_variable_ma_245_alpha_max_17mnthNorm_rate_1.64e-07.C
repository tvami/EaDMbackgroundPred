...
//=========  (Sun Jun  7 15:43:31 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy239[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy240[42] = { 966.8369, 28.31147, 23.14656, 12.0047, 11.00459, 10.84344, 10.11458, 17.58853, 24.27049, 31.64054, 38.51364, 70.28069, 71.92749, 70.07542, 71.33798, 70.4891, 68.03181,
   ...
   Graph_Graph1240->SetMinimum(0.9501868);
   Graph_Graph1240->SetMaximum(1063.415);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy241[42] = { 615.0603, 17.62199, 14.72369, 7.853728, 7.417407, 7.257318, 6.59187, 11.68629, 16.12596, 21.02282, 25.58949, 46.69636, 47.79054, 46.55998, 47.39885, 46.83484, 45.20215,
   ...
   Graph_Graph2241->SetMinimum(1.60754);
   Graph_Graph2241->SetMaximum(676.3877);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy242[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   23.26456, 23.36614, 23.36614 };
   ...
   Double_t Graph_fx243[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy243[20] = { 2.296564e-42, 1.218649e-30, 1.231029e-23, 5.490467e-19, 1.112064e-15, 3.274956e-13, 2.67419e-11, 6.635839, 58.47709, 154.2586, 248.7262, 456.8221, 449.0865, 395.9488, 342.2357, 296.386, 258.7007,
   227.8693, 202.4952, 202.4952 };
   graph = new TGraph(20,Graph_fx243,Graph_fy243);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph243 = new TH1F("Graph_Graph243","",100,2.7,1099.7);
   Graph_Graph243->SetMinimum(2.066908e-42);
   Graph_Graph243->SetMaximum(502.5043);
   ...
   Double_t Graph_fx245[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy245[20] = { 2.52622e-42, 1.340514e-30, 1.354132e-23, 6.039514e-19, 1.22327e-15, 3.602452e-13, 2.941609e-11, 7.299423, 64.3248, 169.6845, 273.5988, 502.5043, 493.9952, 435.5437, 376.4593, 326.0246, 284.5708,
   250.6562, 222.7447, 222.7447 };
   graph = new TGraph(20,Graph_fx245,Graph_fy245);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph245 = new TH1F("Graph_Graph245","",100,2.7,1099.7);
   Graph_Graph245->SetMinimum(2.273598e-42);
   Graph_Graph245->SetMaximum(552.7547);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(39.83435,0,39.83435,5.767764);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(39.82935,0,"  39.83 TeV");
