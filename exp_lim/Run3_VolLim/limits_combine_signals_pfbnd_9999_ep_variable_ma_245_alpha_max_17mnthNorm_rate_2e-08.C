...
//=========  (Sun Jun  7 15:43:28 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy113[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy114[42] = { 966.8369, 28.31147, 23.14656, 12.0047, 11.00459, 10.84344, 10.11458, 17.58853, 24.27049, 31.64054, 38.51364, 70.28069, 71.92749, 70.07542, 71.33798, 70.4891, 68.03181,
   ...
   Graph_Graph1114->SetMinimum(0.9501868);
   Graph_Graph1114->SetMaximum(1063.415);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy115[42] = { 615.0603, 17.62199, 14.72369, 7.853728, 7.417407, 7.257318, 6.59187, 11.68629, 16.12596, 21.02282, 25.58949, 46.69636, 47.79054, 46.55998, 47.39885, 46.83484, 45.20215,
   ...
   Graph_Graph2115->SetMinimum(1.60754);
   Graph_Graph2115->SetMaximum(676.3877);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy116[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   23.26456, 23.36614, 23.36614 };
   ...
   Double_t Graph_fx117[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy117[20] = { 39.11063, 39.39833, 36.88902, 33.69698, 30.5547, 27.69352, 25.16297, 4.820878, 2.857947, 1.955406, 1.403009, 0.5102568, 0.2923744, 0.1968032, 0.1446734, 0.1124695, 0.09088333,
   0.07555351, 0.06418707, 0.06418707 };
   graph = new TGraph(20,Graph_fx117,Graph_fy117);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph117 = new TH1F("Graph_Graph117","",100,2.7,1099.7);
   Graph_Graph117->SetMinimum(0.05776836);
   Graph_Graph117->SetMaximum(43.33174);
   ...
   Double_t Graph_fx119[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy119[20] = { 43.02169, 43.33816, 40.57792, 37.06668, 33.61017, 30.46287, 27.67927, 5.302966, 3.143742, 2.150947, 1.54331, 0.5612825, 0.3216118, 0.2164835, 0.1591407, 0.1237165, 0.09997166,
   0.08310886, 0.07060578, 0.07060578 };
   graph = new TGraph(20,Graph_fx119,Graph_fy119);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph119 = new TH1F("Graph_Graph119","",100,2.7,1099.7);
   Graph_Graph119->SetMinimum(0.0635452);
   Graph_Graph119->SetMaximum(47.66492);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(3.629306,0,3.629306,39.29144);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(3.624306,0,"  3.63 TeV");
