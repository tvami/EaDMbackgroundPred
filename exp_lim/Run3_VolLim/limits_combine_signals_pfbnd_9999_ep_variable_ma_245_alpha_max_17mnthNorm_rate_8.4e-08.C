...
//=========  (Sun Jun  7 15:43:29 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy183[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy184[42] = { 966.8369, 28.31147, 23.14656, 12.0047, 11.00459, 10.84344, 10.11458, 17.58853, 24.27049, 31.64054, 38.51364, 70.28069, 71.92749, 70.07542, 71.33798, 70.4891, 68.03181,
   ...
   Graph_Graph1184->SetMinimum(0.9501868);
   Graph_Graph1184->SetMaximum(1063.415);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy185[42] = { 615.0603, 17.62199, 14.72369, 7.853728, 7.417407, 7.257318, 6.59187, 11.68629, 16.12596, 21.02282, 25.58949, 46.69636, 47.79054, 46.55998, 47.39885, 46.83484, 45.20215,
   ...
   Graph_Graph2185->SetMinimum(1.60754);
   Graph_Graph2185->SetMaximum(676.3877);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy186[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   23.26456, 23.36614, 23.36614 };
   ...
   Double_t Graph_fx187[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy187[20] = { 2.027902e-08, 1.798006e-05, 0.0009838913, 0.01353523, 0.08516394, 0.3300147, 0.9282764, 196.2253, 229.1601, 220.0644, 193.513, 105.7091, 69.36718, 49.96807, 38.25749, 30.55911, 25.17696,
   21.23652, 18.24668, 18.24668 };
   graph = new TGraph(20,Graph_fx187,Graph_fy187);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph187 = new TH1F("Graph_Graph187","",100,2.7,1099.7);
   ...
   Double_t Graph_fx189[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy189[20] = { 2.230692e-08, 1.977807e-05, 0.00108228, 0.01488875, 0.09368033, 0.3630162, 1.021104, 215.8478, 252.0761, 242.0708, 212.8643, 116.28, 76.3039, 54.96488, 42.08324, 33.61502, 27.69466,
   23.36017, 20.07135, 20.07135 };
   graph = new TGraph(20,Graph_fx189,Graph_fy189);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph189 = new TH1F("Graph_Graph189","",100,2.7,1099.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(17.35632,0,17.35632,3.930268);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(17.35132,0,"  17.36 TeV");
