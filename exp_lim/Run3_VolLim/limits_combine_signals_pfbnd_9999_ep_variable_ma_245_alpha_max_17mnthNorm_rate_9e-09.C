...
//=========  (Sun Jun  7 15:43:27 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy36[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy37[42] = { 966.8369, 28.31147, 23.14656, 12.0047, 11.00459, 10.84344, 10.11458, 17.58853, 24.27049, 31.64054, 38.51364, 70.28069, 71.92749, 70.07542, 71.33798, 70.4891, 68.03181,
   ...
   Graph_Graph137->SetMinimum(0.9501868);
   Graph_Graph137->SetMaximum(1063.415);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy38[42] = { 615.0603, 17.62199, 14.72369, 7.853728, 7.417407, 7.257318, 6.59187, 11.68629, 16.12596, 21.02282, 25.58949, 46.69636, 47.79054, 46.55998, 47.39885, 46.83484, 45.20215,
   ...
   Graph_Graph238->SetMinimum(1.60754);
   Graph_Graph238->SetMaximum(676.3877);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy39[20] = { 320.329, 11.41549, 8.891878, 4.124951, 4.141319, 3.988183, 3.40795, 5.784091, 7.981492, 10.40518, 12.66543, 23.11222, 23.65378, 23.04471, 23.45991, 23.18075, 22.37266,
   23.26456, 23.36614, 23.36614 };
   ...
   Double_t Graph_fx40[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy40[20] = { 5.883518, 4.282497, 3.299457, 2.646593, 2.187023, 1.848897, 1.591388, 0.217928, 0.125063, 0.08418901, 0.05981983, 0.02133567, 0.01214603, 0.008149219, 0.005978962, 0.004642022, 0.003747603,
   0.003113304, 0.0026435, 0.0026435 };
   graph = new TGraph(20,Graph_fx40,Graph_fy40);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","",100,2.7,1099.7);
   Graph_Graph40->SetMinimum(0.00237915);
   Graph_Graph40->SetMaximum(6.471605);
   ...
   Double_t Graph_fx42[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy42[20] = { 6.47187, 4.710747, 3.629403, 2.911252, 2.405725, 2.033787, 1.750527, 0.2397208, 0.1375693, 0.09260791, 0.06580181, 0.02346924, 0.01336063, 0.008964141, 0.006576858, 0.005106224, 0.004122363,
   0.003424634, 0.00290785, 0.00290785 };
   graph = new TGraph(20,Graph_fx42,Graph_fy42);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","",100,2.7,1099.7);
   Graph_Graph42->SetMinimum(0.002617065);
   Graph_Graph42->SetMaximum(7.118766);
