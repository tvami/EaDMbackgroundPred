...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_2mnthNorm_rate_1e-08()
{
...
//=========  (Wed Mar 11 03:47:19 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx43[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy43[50] = { 37.59766, 32.8125, 23.33984, 18.89648, 20.41016, 22.26562, 21.14258, 18.84766, 16.8457, 15.52734, 14.84375, 14.20898, 13.57422, 13.08594, 12.20703, 11.47461, 10.79102,
   ...
   153.9062 };
   TGraph *graph = new TGraph(50,Graph0_fx43,Graph0_fy43);
   ...
   Double_t Graph1_fx44[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   ...
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy44[102] = { 74.54662, 68.53737, 53.50381, 45.35591, 46.50549, 48.47651, 47.21983, 44.54715, 41.61218, 39.16454, 37.98207, 36.98527, 36.18023, 36.19005, 35.18717, 34.61032, 32.8137,
   ...
   graph = new TGraph(102,Graph1_fx44,Graph1_fy44);
   ...
   TH1F *Graph_Graph144 = new TH1F("Graph_Graph144","Graph",102,0,197.84);
   Graph_Graph144->SetMinimum(2.596207);
   Graph_Graph144->SetMaximum(514.5173);
   ...
   Double_t Graph2_fx45[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85, 75,
   70, 60, 55, 50, 45, 40, 30, 25, 20, 10, 9, 8.5, 8, 7.5, 7, 6,
   5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6,
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy45[102] = { 53.70824, 48.18056, 35.62028, 29.66756, 31.06776, 32.91583, 31.67698, 29.14013, 26.61569, 24.81124, 23.83726, 23.04445, 22.36667, 22.05765, 21.16006, 20.43931, 19.82384,
   ...
   graph = new TGraph(102,Graph2_fx45,Graph2_fy45);
   ...
   TH1F *Graph_Graph245 = new TH1F("Graph_Graph245","Graph",102,0,197.84);
   Graph_Graph245->SetMinimum(4.495673);
   Graph_Graph245->SetMaximum(341.5511);
   ...
   Double_t Graph0_fx46[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy46[50] = { 37.59766, 32.8125, 23.33984, 18.89648, 20.41016, 22.26562, 21.14258, 18.84766, 16.8457, 15.52734, 14.84375, 14.20898, 13.57422, 13.08594, 12.20703, 11.47461, 10.79102,
   10.40039, 9.814453, 9.716797, 9.423828, 9.423828, 9.423828, 9.667969, 9.716797, 9.863281, 10.10742, 10.44922, 30.07812, 34.76562, 39.0625, 46.48438, 48.82812,
   53.90625, 55.85938, 61.13281, 67.1875, 71.09375, 82.8125, 85.54688, 89.45312, 90.23438, 98.82812, 108.5938, 114.0625, 125, 125.7812, 137.5, 150.7812,
   153.9062 };
   graph = new TGraph(50,Graph0_fx46,Graph0_fy46);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx47[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy47[50] = { 13.94168, 12.87929, 11.90278, 11.01905, 10.22474, 9.512393, 8.873428, 8.299373, 7.782424, 7.315623, 6.892868, 6.508858, 6.159007, 5.83935, 5.546461, 5.277373, 5.029513,
   4.800642, 4.588809, 4.392305, 4.209633, 3.880666, 3.224586, 2.964657, 2.737377, 2.539316, 2.363735, 2.069614, 0.839432, 0.6231425, 0.4875998, 0.3302337, 0.2813156,
   0.2436522, 0.2138945, 0.1898793, 0.1537041, 0.1398113, 0.1177112, 0.1088077, 0.1010023, 0.09411236, 0.0825265, 0.07319298, 0.06553758, 0.05916234, 0.05378352, 0.04919382, 0.04523853,
   0.04180008 };
   graph = new TGraph(50,Graph_fx47,Graph_fy47);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx49[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy49[50] = { 15.33584, 14.16722, 13.09305, 12.12096, 11.24721, 10.46363, 9.760771, 9.12931, 8.560667, 8.047185, 7.582154, 7.159744, 6.774907, 6.423285, 6.101107, 5.805111, 5.532464,
   5.280707, 5.04769, 4.831536, 4.630596, 4.268732, 3.547044, 3.261123, 3.011114, 2.793248, 2.600108, 2.276576, 0.9233752, 0.6854568, 0.5363597, 0.3632571, 0.3094471,
   0.2680174, 0.2352839, 0.2088673, 0.1690745, 0.1537924, 0.1294823, 0.1196885, 0.1111026, 0.1035236, 0.09077915, 0.08051228, 0.07209134, 0.06507858, 0.05916188, 0.0541132, 0.04976238,
   0.04598009 };
   graph = new TGraph(50,Graph_fx49,Graph_fy49);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
