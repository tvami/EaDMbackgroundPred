...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_2mnthNorm_rate_5e-09()
{
//=========Macro generated from canvas: climits/climits
//=========  (Wed Mar 11 03:47:18 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx8[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy8[50] = { 37.59766, 32.8125, 23.33984, 18.89648, 20.41016, 22.26562, 21.14258, 18.84766, 16.8457, 15.52734, 14.84375, 14.20898, 13.57422, 13.08594, 12.20703, 11.47461, 10.79102,
   ...
   153.9062 };
   TGraph *graph = new TGraph(50,Graph0_fx8,Graph0_fy8);
   ...
   Double_t Graph1_fx9[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   ...
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy9[102] = { 74.54662, 68.53737, 53.50381, 45.35591, 46.50549, 48.47651, 47.21983, 44.54715, 41.61218, 39.16454, 37.98207, 36.98527, 36.18023, 36.19005, 35.18717, 34.61032, 32.8137,
   ...
   graph = new TGraph(102,Graph1_fx9,Graph1_fy9);
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Graph",102,0,197.84);
   Graph_Graph19->SetMinimum(2.596207);
   Graph_Graph19->SetMaximum(514.5173);
   ...
   Double_t Graph2_fx10[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85, 75,
   70, 60, 55, 50, 45, 40, 30, 25, 20, 10, 9, 8.5, 8, 7.5, 7, 6,
   5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6,
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy10[102] = { 53.70824, 48.18056, 35.62028, 29.66756, 31.06776, 32.91583, 31.67698, 29.14013, 26.61569, 24.81124, 23.83726, 23.04445, 22.36667, 22.05765, 21.16006, 20.43931, 19.82384,
   ...
   graph = new TGraph(102,Graph2_fx10,Graph2_fy10);
   ...
   TH1F *Graph_Graph210 = new TH1F("Graph_Graph210","Graph",102,0,197.84);
   Graph_Graph210->SetMinimum(4.495673);
   Graph_Graph210->SetMaximum(341.5511);
   ...
   Double_t Graph0_fx11[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy11[50] = { 37.59766, 32.8125, 23.33984, 18.89648, 20.41016, 22.26562, 21.14258, 18.84766, 16.8457, 15.52734, 14.84375, 14.20898, 13.57422, 13.08594, 12.20703, 11.47461, 10.79102,
   10.40039, 9.814453, 9.716797, 9.423828, 9.423828, 9.423828, 9.667969, 9.716797, 9.863281, 10.10742, 10.44922, 30.07812, 34.76562, 39.0625, 46.48438, 48.82812,
   53.90625, 55.85938, 61.13281, 67.1875, 71.09375, 82.8125, 85.54688, 89.45312, 90.23438, 98.82812, 108.5938, 114.0625, 125, 125.7812, 137.5, 150.7812,
   153.9062 };
   graph = new TGraph(50,Graph0_fx11,Graph0_fy11);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx12[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy12[50] = { 1.545399, 1.339578, 1.176535, 1.044727, 0.9363305, 0.8458737, 0.7694296, 0.7041139, 0.6477653, 0.5987356, 0.5557481, 0.5177998, 0.4840931, 0.4539864, 0.4269581, 0.4025805, 0.3804998,
   0.3604209, 0.3420959, 0.3253153, 0.309901, 0.2825824, 0.229738, 0.2093935, 0.1918597, 0.1767882, 0.1635754, 0.1417701, 0.05492539, 0.04040113, 0.03142066, 0.02111812, 0.0179441,
   0.01551006, 0.01359311, 0.01205018, 0.009733149, 0.008845672, 0.007436726, 0.00687011, 0.006373861, 0.005936196, 0.005201074, 0.004609644, 0.004125087, 0.00372194, 0.003382078, 0.003092281, 0.002842697,
   0.002625845 };
   graph = new TGraph(50,Graph_fx12,Graph_fy12);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx14[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy14[50] = { 1.699938, 1.473536, 1.294188, 1.1492, 1.029964, 0.9304611, 0.8463726, 0.7745253, 0.7125418, 0.6586092, 0.6113229, 0.5695798, 0.5325024, 0.499385, 0.4696539, 0.4428386, 0.4185498,
   0.396463, 0.3763055, 0.3578469, 0.3408911, 0.3108406, 0.2527118, 0.2303328, 0.2110456, 0.194467, 0.1799329, 0.1559471, 0.06041793, 0.04444124, 0.03456272, 0.02322993, 0.01973851,
   0.01706106, 0.01495242, 0.0132552, 0.01070646, 0.00973024, 0.008180399, 0.007557121, 0.007011247, 0.006529815, 0.005721181, 0.005070609, 0.004537596, 0.004094134, 0.003720286, 0.003401509, 0.003126967,
   0.00288843 };
   graph = new TGraph(50,Graph_fx14,Graph_fy14);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
