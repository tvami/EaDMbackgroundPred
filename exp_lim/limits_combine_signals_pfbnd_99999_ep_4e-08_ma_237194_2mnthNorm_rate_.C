...
#endif
void limits_combine_signals_pfbnd_99999_ep_4e-08_ma_237194_2mnthNorm_rate_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Jun 23 23:01:31 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 17.87109, 16.30859, 17.1875, 16.50391, 16.50391, 17.04102, 17.48047, 19.04297 };
   ...
   3 };
   Double_t Graph1_fy2[18] = { 49.31436, 48.68424, 51.17079, 50.18581, 50.18581, 51.81908, 53.15539, 57.90672, 57.90672, 6.694794, 6.694794, 6.41861, 6.323814, 6.317902, 6.446838, 7.049561, 6.625366,
   7.818604 };
   ...
   Graph_Graph12->SetMinimum(1.15902);
   Graph_Graph12->SetMaximum(63.0656);
   ...
   3 };
   Double_t Graph2_fy3[18] = { 30.05227, 28.46486, 29.86187, 29.39782, 29.79253, 31.2376, 32.18251, 35.89412, 35.89412, 10.74654, 10.74654, 10.04828, 9.840396, 9.699973, 9.825385, 10.49488, 9.878325,
   11.35268 };
   ...
   Graph_Graph23->SetMinimum(7.080559);
   Graph_Graph23->SetMaximum(38.51353);
   ...
   Double_t Graph0_fy4[8] = { 17.87109, 16.30859, 17.1875, 16.50391, 16.50391, 17.04102, 17.48047, 19.04297 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.070224,0,4.070224,16.36882);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.065224,0,"  4.07 TeV");
