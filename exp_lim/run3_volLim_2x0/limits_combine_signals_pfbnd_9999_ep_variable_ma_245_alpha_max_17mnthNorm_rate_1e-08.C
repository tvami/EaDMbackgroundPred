...
//=========  (Thu Jun 11 01:13:34 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy43[20] = { 757.5462, 10.21849, 10.34327, 6.892724, 6.856261, 6.805988, 6.792314, 12.65785, 17.70313, 23.2699, 28.51126, 53.76754, 55.00202, 53.61712, 54.59753, 53.87332, 52.0452,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy44[42] = { 1720.352, 27.90013, 27.43299, 20.45865, 19.60471, 19.58701, 20.18621, 38.49057, 53.8325, 70.7602, 86.69836, 163.4988, 167.2527, 163.0414, 166.0227, 163.8205, 158.2614,
   ...
   Graph_Graph144->SetMinimum(2.429904);
   Graph_Graph144->SetMaximum(1892.117);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy45[42] = { 1160.926, 17.02504, 16.96798, 12.58076, 12.12039, 12.15113, 12.34657, 25.46744, 35.67231, 46.93706, 57.5468, 108.633, 111.1271, 108.3291, 110.3099, 108.8467, 105.1531,
   ...
   Graph_Graph245->SetMinimum(3.660614);
   Graph_Graph245->SetMaximum(1276.612);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy46[20] = { 757.5462, 10.21849, 10.34327, 6.892724, 6.856261, 6.805988, 6.792314, 12.65785, 17.70313, 23.2699, 28.51126, 53.76754, 55.00202, 53.61712, 54.59753, 53.87332, 52.0452,
   54.09839, 54.3541, 54.3541 };
   ...
   Double_t Graph_fx47[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy47[20] = { 8.299373, 6.159007, 4.800642, 3.880666, 3.224586, 2.737377, 2.363735, 0.3302337, 0.1898793, 0.1279454, 0.09096336, 0.03248119, 0.01849814, 0.01241349, 0.009108651, 0.007072437, 0.005710044,
   0.00474379, 0.004028071, 0.004028071 };
   graph = new TGraph(20,Graph_fx47,Graph_fy47);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph47 = new TH1F("Graph_Graph47","",100,2.7,1099.7);
   Graph_Graph47->SetMinimum(0.003625264);
   Graph_Graph47->SetMaximum(9.128907);
   ...
   Double_t Graph_fx49[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy49[20] = { 9.12931, 6.774908, 5.280706, 4.268733, 3.547045, 3.011115, 2.600109, 0.3632571, 0.2088672, 0.1407399, 0.1000597, 0.03572931, 0.02034795, 0.01365484, 0.01001952, 0.007779681, 0.006281048,
   0.005218169, 0.004430878, 0.004430878 };
   graph = new TGraph(20,Graph_fx49,Graph_fy49);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph49 = new TH1F("Graph_Graph49","",100,2.7,1099.7);
   Graph_Graph49->SetMinimum(0.00398779);
   Graph_Graph49->SetMaximum(10.0418);
