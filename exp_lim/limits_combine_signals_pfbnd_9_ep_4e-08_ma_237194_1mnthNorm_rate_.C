...
#endif
void limits_combine_signals_pfbnd_9_ep_4e-08_ma_237194_1mnthNorm_rate_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Jun 23 00:20:31 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 106.6406, 81.25, 87.89062, 72.46094, 67.96875, 64.45312, 62.5, 59.76562 };
   ...
   3 };
   Double_t Graph1_fy2[18] = { 209.2844, 164.2052, 176.167, 150.2632, 141.0522, 138.2152, 135.3506, 133.3423, 133.3423, 28.94897, 28.94897, 31.00586, 32.22656, 34.51538, 36.79657, 45.66193, 41.89453,
   55.8197 };
   ...
   Graph_Graph12->SetMinimum(10.91543);
   Graph_Graph12->SetMaximum(227.3179);
   ...
   3 };
   Double_t Graph2_fy3[18] = { 152.1236, 117.523, 126.7779, 106.2543, 99.66713, 96.05342, 93.64096, 90.97354, 90.97354, 40.26446, 40.26446, 42.81616, 44.05975, 47.06039, 50.17071, 61.8276, 56.9603,
   75.27459 };
   ...
   Graph_Graph23->SetMinimum(29.07855);
   Graph_Graph23->SetMaximum(163.3095);
   ...
   Double_t Graph0_fy4[8] = { 106.6406, 81.25, 87.89062, 72.46094, 67.96875, 64.45312, 62.5, 59.76562 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(7.278925,0,7.278925,66.96931);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(7.273925,0,"  7.28 TeV");
