...
#endif
void limits_combine_signals_ep_variable_ma_245_alpha_max_2023DNorm_rate_1.24e-07()
{
...
//=========  (Mon Feb  9 23:41:16 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx211[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph0_fy211[51] = { 45.60547, 42.38281, 47.07031, 47.65625, 37.98828, 36.71875, 38.96484, 41.21094, 39.45312, 38.47656, 36.71875, 35.74219, 36.23047, 36.81641, 37.59766, 38.57422, 39.16016,
   ...
   395.3125, 400 };
   TGraph *graph = new TGraph(51,Graph0_fx211,Graph0_fy211);
   ...
   TH1F *Graph_Graph0211 = new TH1F("Graph_Graph0211","",100,0,197.84);
   ...
   Graph_Graph0211->GetXaxis()->SetRange(1,91);
   ...
   Double_t Graph1_fx212[104] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   ...
   Double_t Graph1_fy212[104] = { 102.1954, 95.09992, 103.5276, 104.4253, 89.88257, 87.1575, 90.84357, 94.04445, 91.02211, 91.14931, 88.61798, 87.35803, 88.75735, 89.1701, 90.17774, 91.97331, 93.63119,
   ...
   graph = new TGraph(104,Graph1_fx212,Graph1_fy212);
   ...
   TH1F *Graph_Graph1212 = new TH1F("Graph_Graph1212","Graph",104,0,197.84);
   Graph_Graph1212->SetMinimum(15.07874);
   Graph_Graph1212->SetMaximum(1274.703);
   ...
   Double_t Graph2_fx213[104] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85,
   80, 75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy213[104] = { 69.23757, 64.34497, 70.71097, 71.40123, 59.18749, 57.35586, 60.24307, 62.89439, 60.68348, 59.94825, 57.79495, 56.68526, 57.45965, 57.94866, 58.87861, 60.17728, 61.16942,
   ...
   graph = new TGraph(104,Graph2_fx213,Graph2_fy213);
   ...
   TH1F *Graph_Graph2213 = new TH1F("Graph_Graph2213","Graph",104,0,197.84);
   Graph_Graph2213->SetMinimum(21.22018);
   Graph_Graph2213->SetMaximum(751.5829);
   ...
   Double_t Graph0_fx214[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph0_fy214[51] = { 45.60547, 42.38281, 47.07031, 47.65625, 37.98828, 36.71875, 38.96484, 41.21094, 39.45312, 38.47656, 36.71875, 35.74219, 36.23047, 36.81641, 37.59766, 38.57422, 39.16016,
   37.98828, 37.10938, 37.69531, 37.10938, 37.89062, 38.37891, 39.25781, 39.45312, 40.82031, 41.40625, 41.99219, 113.6719, 121.875, 128.125, 139.0625, 143.75,
   157.0312, 161.7188, 172.2656, 189.0625, 200.7812, 214.0625, 228.9062, 237.5, 246.0938, 251.5625, 270.3125, 292.9688, 315.625, 329.6875, 348.4375, 373.4375,
   395.3125, 400 };
   graph = new TGraph(51,Graph0_fx214,Graph0_fy214);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0214 = new TH1F("Graph_Graph0214","",100,0,197.84);
   ...
   Graph_Graph0214->GetXaxis()->SetRange(1,91);
   ...
   Double_t Graph_fx215[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph_fy215[51] = { 6.810091e-46, 2.693885e-40, 7.969938e-36, 3.581967e-32, 1.449769e-26, 2.28563e-24, 1.823103e-22, 8.363262e-21, 2.433565e-19, 4.847141e-18, 7.017801e-17, 7.749192e-16, 6.784783e-15, 4.862361e-14, 2.928131e-13, 1.514474e-12, 6.852249e-12,
   9.968848e-11, 3.285068e-10, 9.953667e-10, 2.796611e-09, 3.018177e-08, 1.981761e-07, 1.127713e-06, 4.72118e-06, 1.774766e-05, 5.453116e-05, 0.0001543568, 8.403175, 22.83274, 45.10239, 73.30169, 104.8944,
   137.5757, 169.5969, 199.7875, 252.2675, 274.1271, 293.0989, 309.3403, 323.0594, 334.4865, 343.8553, 357.3106, 365.0549, 368.4373, 368.5332, 366.1825, 362.0335,
   356.5835, 350.2127 };
   graph = new TGraph(51,Graph_fx215,Graph_fy215);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph215 = new TH1F("Graph_Graph215","",100,0,197.84);
   ...
   Double_t Graph_fx217[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph_fy217[51] = { 7.4911e-46, 2.963274e-40, 8.766932e-36, 3.940164e-32, 1.594746e-26, 2.514193e-24, 2.005413e-22, 9.199588e-21, 2.676921e-19, 5.331855e-18, 7.719581e-17, 8.524111e-16, 7.463261e-15, 5.348597e-14, 3.220944e-13, 1.665921e-12, 7.537474e-12,
   1.096573e-10, 3.613575e-10, 1.094903e-09, 3.076272e-09, 3.319995e-08, 2.179937e-07, 1.240484e-06, 5.193298e-06, 1.952243e-05, 5.998428e-05, 0.0001697925, 9.243493, 25.11601, 49.61263, 80.63186, 115.3839,
   151.3333, 186.5566, 219.7663, 277.4942, 301.5398, 322.4088, 340.2743, 355.3654, 367.9351, 378.2408, 393.0417, 401.5603, 405.281, 405.3865, 402.8007, 398.2368,
   392.2419, 385.2339 };
   graph = new TGraph(51,Graph_fx217,Graph_fy217);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph217 = new TH1F("Graph_Graph217","",100,0,197.84);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(53.67753,0,53.67753,160.4655);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(53.67253,0,"  53.68 TeV");
