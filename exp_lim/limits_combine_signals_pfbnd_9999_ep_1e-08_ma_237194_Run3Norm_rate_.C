...
#endif
void limits_combine_signals_pfbnd_9999_ep_1e-08_ma_237194_Run3Norm_rate_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Jul 14 22:34:53 2025) by ROOT version 6.30/07
   ...
   Double_t Graph_fy5[8] = { 9.75759, 7.27341, 5.6844, 4.60324, 3.82986, 3.25429, 2.81218, 2.46371 };
   ...
   Graph_Graph5->SetMinimum(1.734322);
   Graph_Graph5->SetMaximum(10.48698);
   ...
   Double_t Graph_fy6[8] = { 8.781831, 6.546069, 5.11596, 4.142916, 3.446874, 2.928861, 2.530962, 2.217339 };
   ...
   Graph_Graph6->SetMinimum(1.56089);
   Graph_Graph6->SetMaximum(9.43828);
   ...
   Double_t Graph_fy7[8] = { 10.73335, 8.000751, 6.25284, 5.063564, 4.212846, 3.579719, 3.093398, 2.710081 };
   ...
   Graph_Graph7->SetMinimum(1.907754);
   Graph_Graph7->SetMaximum(11.53568);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.209957,0,4.209957,6.906555);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.204957,0,"  4.21 TeV");
