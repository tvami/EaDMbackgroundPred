...
#endif
void limits_combine_signals_pfbnd_99_ep_4e-08_ma_237194_1mnthNorm_rate_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Jun 23 00:20:25 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 78.71094, 61.71875, 66.79688, 55.85938, 53.32031, 50.78125, 50, 49.21875 };
   ...
   3 };
   Double_t Graph1_fy2[18] = { 163.3952, 133.7988, 142.8073, 124.3897, 121.3915, 118.4887, 118.0134, 120.6159, 120.6159, 22.49451, 22.49451, 23.4375, 24.20044, 25.82703, 27.27509, 33.65936, 30.85938,
   40.27786 };
   ...
   Graph_Graph12->SetMinimum(8.404441);
   Graph_Graph12->SetMaximum(177.4852);
   ...
   3 };
   Double_t Graph2_fy3[18] = { 115.1054, 92.22444, 99.14688, 84.58224, 81.58774, 78.71469, 77.9023, 78.15649, 78.15649, 31.99414, 31.99414, 32.9834, 33.75292, 35.92222, 37.77088, 46.08593, 42.43164,
   54.69027 };
   ...
   Graph_Graph23->SetMinimum(23.68302);
   Graph_Graph23->SetMaximum(123.4165);
   ...
   Double_t Graph0_fy4[8] = { 78.71094, 61.71875, 66.79688, 55.85938, 53.32031, 50.78125, 50, 49.21875 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(6.440505,0,6.440505,54.72634);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(6.435505,0,"  6.44 TeV");
