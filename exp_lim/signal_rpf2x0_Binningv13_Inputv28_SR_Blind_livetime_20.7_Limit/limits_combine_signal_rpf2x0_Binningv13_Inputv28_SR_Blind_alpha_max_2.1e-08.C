...
#endif
void limits_combine_signal_rpf2x0_Binningv13_Inputv28_SR_Blind_alpha_max_2.1e-08()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  7 21:09:39 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy120[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy121[42] = { 263.3536, 22.30594, 21.12988, 17.06116, 15.59377, 14.93766, 14.53641, 20.4565, 28.18569, 36.74017, 44.96066, 82.49234, 84.78023, 82.23738, 83.81629, 83.02227, 79.57681,
   ...
   Graph_Graph1121->SetMinimum(1.711043);
   Graph_Graph1121->SetMaximum(289.4988);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy122[42] = { 167.9571, 13.70932, 12.9865, 10.4326, 9.578931, 9.239235, 9.0445, 13.54376, 18.70133, 24.41077, 29.87306, 54.81011, 56.33024, 54.64071, 55.68977, 55.1622, 52.87295,
   ...
   Graph_Graph2122->SetMinimum(2.607585);
   Graph_Graph2122->SetMaximum(184.4631);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy123[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   27.37479, 27.47854, 27.47854 };
   ...
   Double_t Graph_fx124[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy124[72] = { 20.03432, 24.72091, 28.79992, 32.22347, 37.23145, 38.94433, 40.22534, 41.1418, 41.75386, 42.11384, 42.26643, 42.24943, 42.09451, 41.82814, 41.47233, 41.04535, 40.56233,
   ...
   4.359555, 3.856229, 3.444957, 2.816448, 2.572068, 2.361965, 2.179704, 2.020333, 1.845423, 1.69684, 1.458802, 1.277076, 1.133977, 1.018352, 0.9229092, 0.8427223,
   0.774359, 0.7153599, 0.6887876, 0.6639167, 0.6405896, 0.6186681, 0.52633, 0.4555622, 0.3997681, 0.3547897, 0.3178662, 0.2870909, 0.2611051, 0.238916, 0.219782, 0.203139,
   0.1885508, 0.1756753, 0.1365932, 0.1103902, 0.09177825, 0.07797635, 0.07797635 };
   graph = new TGraph(72,Graph_fx124,Graph_fy124);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,1.44,1099.84);
   Graph_Graph124->SetMinimum(0.07017872);
   Graph_Graph124->SetMaximum(46.48528);
   ...
   Double_t Graph_fx126[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy126[72] = { 22.03775, 27.193, 31.67991, 35.44582, 40.9546, 42.83876, 44.24787, 45.25598, 45.92925, 46.32522, 46.49307, 46.47437, 46.30396, 46.01095, 45.61956, 45.14989, 44.61856,
   43.42377, 42.7811, 42.11914, 41.44429, 39.73319, 38.03067, 36.37404, 34.77931, 33.2625, 31.82201, 30.46489, 11.28357, 9.07802, 7.51766, 6.365531, 5.485743,
   4.795511, 4.241852, 3.789453, 3.098093, 2.829275, 2.598162, 2.397674, 2.222366, 2.029965, 1.866524, 1.604682, 1.404784, 1.247375, 1.120187, 1.0152, 0.9269945,
   0.8517949, 0.7868959, 0.7576664, 0.7303084, 0.7046486, 0.6805349, 0.578963, 0.5011184, 0.4397449, 0.3902687, 0.3496528, 0.3158, 0.2872156, 0.2628076, 0.2417602, 0.2234529,
   0.2074059, 0.1932428, 0.1502525, 0.1214292, 0.1009561, 0.08577399, 0.08577399 };
   graph = new TGraph(72,Graph_fx126,Graph_fy126);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,1.44,1099.84);
   Graph_Graph126->SetMinimum(0.07719659);
   Graph_Graph126->SetMaximum(51.1338);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(3.356814,0,3.356814,41.87495);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(3.351814,0,"  3.36 TeV");
