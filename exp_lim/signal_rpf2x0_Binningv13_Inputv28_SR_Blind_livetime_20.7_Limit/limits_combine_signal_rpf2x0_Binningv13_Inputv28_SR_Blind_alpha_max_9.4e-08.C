...
#endif
void limits_combine_signal_rpf2x0_Binningv13_Inputv28_SR_Blind_alpha_max_9.4e-08()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  7 21:09:50 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx190[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph0_fy190[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   27.37479, 27.47854, 27.47854 };
   TGraph *graph = new TGraph(20,Graph0_fx190,Graph0_fy190);
   ...
   TH1F *Graph_Graph0190 = new TH1F("Graph_Graph0190","",100,2.7,1099.7);
   ...
   Graph_Graph0190->GetXaxis()->SetRange(0,91);
   ...
   Double_t Graph1_fx191[42] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy191[42] = { 263.3536, 22.30594, 21.12988, 17.06116, 15.59377, 14.93766, 14.53641, 20.4565, 28.18569, 36.74017, 44.96066, 82.49234, 84.78023, 82.23738, 83.81629, 83.02227, 79.57681,
   ...
   graph = new TGraph(42,Graph1_fx191,Graph1_fy191);
   ...
   TH1F *Graph_Graph1191 = new TH1F("Graph_Graph1191","Graph",100,2.7,1099.7);
   Graph_Graph1191->SetMinimum(1.711043);
   Graph_Graph1191->SetMaximum(289.4988);
   ...
   Double_t Graph2_fx192[42] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy192[42] = { 167.9571, 13.70932, 12.9865, 10.4326, 9.578931, 9.239235, 9.0445, 13.54376, 18.70133, 24.41077, 29.87306, 54.81011, 56.33024, 54.64071, 55.68977, 55.1622, 52.87295,
   ...
   graph = new TGraph(42,Graph2_fx192,Graph2_fy192);
   ...
   TH1F *Graph_Graph2192 = new TH1F("Graph_Graph2192","Graph",100,2.7,1099.7);
   Graph_Graph2192->SetMinimum(2.607585);
   Graph_Graph2192->SetMaximum(184.4631);
   ...
   Double_t Graph0_fx193[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph0_fy193[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   27.37479, 27.47854, 27.47854 };
   graph = new TGraph(20,Graph0_fx193,Graph0_fy193);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0193 = new TH1F("Graph_Graph0193","",100,2.7,1099.7);
   ...
   Graph_Graph0193->GetXaxis()->SetRange(0,91);
   ...
   Double_t Graph_fx194[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy194[72] = { 1.125389e-24, 1.727798e-21, 6.021993e-19, 7.149479e-17, 1.080327e-13, 1.894287e-12, 2.252217e-11, 1.953727e-10, 1.307723e-09, 7.054331e-09, 3.173837e-08, 1.224086e-07, 4.137816e-07, 1.24835e-06, 3.411987e-06, 8.55452e-06, 1.98812e-05,
   ...
   224.7734, 239.6049, 250.0586, 261.0181, 262.8425, 262.9211, 261.649, 259.3421, 251.5408, 244.1234, 230.3987, 218.0031, 206.7372, 196.4262, 186.9316, 178.1466,
   169.9888, 162.3928, 158.7885, 155.3055, 151.9384, 148.6822, 133.9117, 121.3153, 110.505, 101.1696, 93.05736, 85.96478, 79.727, 74.21011, 69.30489, 64.92184,
   60.98715, 57.43965, 46.2153, 38.2735, 32.40901, 27.9305, 27.9305 };
   graph = new TGraph(72,Graph_fx194,Graph_fy194);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph194 = new TH1F("Graph_Graph194","",100,1.44,1099.84);
   ...
   Double_t Graph_fx196[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy196[72] = { 1.237928e-24, 1.900578e-21, 6.624192e-19, 7.864427e-17, 1.18836e-13, 2.083716e-12, 2.477439e-11, 2.1491e-10, 1.438495e-09, 7.759764e-09, 3.491221e-08, 1.346495e-07, 4.551598e-07, 1.373185e-06, 3.753186e-06, 9.409972e-06, 2.186932e-05,
   9.734033e-05, 0.000189047, 0.0003501241, 0.0006213508, 0.00227283, 0.006563191, 0.01689069, 0.03750883, 0.07683498, 0.1427317, 0.2500759, 74.71673, 119.1442, 160.8371, 196.4738, 225.1653,
   247.2507, 263.5654, 275.0645, 287.1199, 289.1268, 289.2132, 287.8139, 285.2763, 276.6949, 268.5357, 253.4386, 239.8034, 227.4109, 216.0688, 205.6248, 195.9613,
   186.9877, 178.6321, 174.6673, 170.8361, 167.1322, 163.5504, 147.3029, 133.4468, 121.5555, 111.2866, 102.3631, 94.56126, 87.6997, 81.63112, 76.23538, 71.41402,
   67.08586, 63.18362, 50.83683, 42.10085, 35.64991, 30.72355, 30.72355 };
   graph = new TGraph(72,Graph_fx196,Graph_fy196);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph196 = new TH1F("Graph_Graph196","",100,1.44,1099.84);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(18.10531,0,18.10531,5.382011);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(18.10031,0,"  18.11 TeV");
