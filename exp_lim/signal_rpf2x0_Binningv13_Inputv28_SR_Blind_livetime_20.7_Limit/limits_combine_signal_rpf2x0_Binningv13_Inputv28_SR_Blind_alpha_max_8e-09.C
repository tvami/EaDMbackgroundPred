...
#endif
void limits_combine_signal_rpf2x0_Binningv13_Inputv28_SR_Blind_alpha_max_8e-09()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  7 21:09:26 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy29[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy30[42] = { 263.3536, 22.30594, 21.12988, 17.06116, 15.59377, 14.93766, 14.53641, 20.4565, 28.18569, 36.74017, 44.96066, 82.49234, 84.78023, 82.23738, 83.81629, 83.02227, 79.57681,
   ...
   Graph_Graph130->SetMinimum(1.711043);
   Graph_Graph130->SetMaximum(289.4988);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy31[42] = { 167.9571, 13.70932, 12.9865, 10.4326, 9.578931, 9.239235, 9.0445, 13.54376, 18.70133, 24.41077, 29.87306, 54.81011, 56.33024, 54.64071, 55.68977, 55.1622, 52.87295,
   ...
   Graph_Graph231->SetMinimum(2.607585);
   Graph_Graph231->SetMaximum(184.4631);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy32[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   27.37479, 27.47854, 27.47854 };
   ...
   Double_t Graph_fx33[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy33[72] = { 7.51832, 6.73637, 6.07526, 5.512822, 4.614821, 4.253106, 3.936495, 3.657613, 3.410524, 3.190413, 2.993352, 2.816106, 2.655997, 2.510792, 2.378615, 2.257882, 2.147247,
   ...
   0.1006822, 0.08831497, 0.07834709, 0.06335423, 0.05760368, 0.05269549, 0.04846475, 0.0447861, 0.04079867, 0.03742291, 0.0320386, 0.02794972, 0.0247447, 0.02216544, 0.020044, 0.01826736,
   0.01675706, 0.01545703, 0.01487258, 0.01432616, 0.01381421, 0.0133336, 0.01131451, 0.009773181, 0.008561871, 0.007587961, 0.006790242, 0.006126612, 0.005567179, 0.005090161, 0.004679335, 0.004322387,
   0.004009818, 0.003734188, 0.002898996, 0.002340305, 0.001944125, 0.001650705, 0.001650705 };
   graph = new TGraph(72,Graph_fx33,Graph_fy33);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","",100,1.44,1099.84);
   Graph_Graph33->SetMinimum(0.001485634);
   Graph_Graph33->SetMaximum(8.269987);
   ...
   Double_t Graph_fx35[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy35[72] = { 8.270152, 7.410007, 6.682786, 6.064104, 5.076303, 4.678417, 4.330145, 4.023374, 3.751576, 3.509454, 3.292687, 3.097717, 2.921597, 2.761871, 2.616477, 2.48367, 2.361972,
   2.147022, 2.05175, 1.963487, 1.88153, 1.700907, 1.547136, 1.416509, 1.303096, 1.204926, 1.118372, 1.042323, 0.2857489, 0.2229393, 0.1806125, 0.150436, 0.1279951,
   0.1107504, 0.09714647, 0.0861818, 0.06968965, 0.06336405, 0.05796504, 0.05331123, 0.04926471, 0.04487854, 0.0411652, 0.03524246, 0.03074469, 0.02721917, 0.02438198, 0.0220484, 0.0200941,
   0.01843277, 0.01700273, 0.01635984, 0.01575878, 0.01519563, 0.01466696, 0.01244596, 0.0107505, 0.009418058, 0.008346757, 0.007469266, 0.006739273, 0.006123897, 0.005599177, 0.005147268, 0.004754626,
   0.0044108, 0.004107607, 0.003188896, 0.002574336, 0.002138538, 0.001815776, 0.001815776 };
   graph = new TGraph(72,Graph_fx35,Graph_fy35);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","",100,1.44,1099.84);
   Graph_Graph35->SetMinimum(0.001634198);
   Graph_Graph35->SetMaximum(9.096986);
