...
#endif
void limits_combine_signal_rpf2x0_Binningv13_Inputv28_SR_Blind_alpha_max_7e-09()
{
//=========Macro generated from canvas: climits/climits
//=========  (Tue Jul  7 21:09:25 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy22[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy23[42] = { 263.3536, 22.30594, 21.12988, 17.06116, 15.59377, 14.93766, 14.53641, 20.4565, 28.18569, 36.74017, 44.96066, 82.49234, 84.78023, 82.23738, 83.81629, 83.02227, 79.57681,
   ...
   Graph_Graph123->SetMinimum(1.711043);
   Graph_Graph123->SetMaximum(289.4988);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy24[42] = { 167.9571, 13.70932, 12.9865, 10.4326, 9.578931, 9.239235, 9.0445, 13.54376, 18.70133, 24.41077, 29.87306, 54.81011, 56.33024, 54.64071, 55.68977, 55.1622, 52.87295,
   ...
   Graph_Graph224->SetMinimum(2.607585);
   Graph_Graph224->SetMaximum(184.4631);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy25[20] = { 102.3402, 8.363508, 7.354474, 5.768814, 5.291376, 5.044252, 4.905126, 6.727238, 9.269029, 12.08222, 14.78557, 27.12809, 27.88047, 27.04424, 27.56347, 27.30236, 26.1693,
   27.37479, 27.47854, 27.47854 };
   ...
   Double_t Graph_fx26[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy26[72] = { 4.94222, 4.372173, 3.903124, 3.512383, 2.902781, 2.661815, 2.452932, 2.270464, 2.109959, 1.967881, 1.841388, 1.728179, 1.626371, 1.534408, 1.451, 1.375065, 1.305691,
   ...
   0.05923486, 0.05194148, 0.04606619, 0.03723449, 0.03384887, 0.03096, 0.02847049, 0.02630633, 0.02396163, 0.02197688, 0.01881177, 0.01640867, 0.01452536, 0.01301, 0.01176379, 0.01072027,
   0.009833284, 0.009069864, 0.008726679, 0.008405842, 0.008105256, 0.00782308, 0.006637767, 0.005733063, 0.005022159, 0.004450643, 0.003982562, 0.00359319, 0.003264974, 0.002985127, 0.002744124, 0.002534737,
   0.002351389, 0.002189716, 0.001699857, 0.001372203, 0.001139872, 0.0009678101, 0.0009678101 };
   graph = new TGraph(72,Graph_fx26,Graph_fy26);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,1.44,1099.84);
   Graph_Graph26->SetMinimum(0.0008710291);
   Graph_Graph26->SetMaximum(5.436345);
   ...
   Double_t Graph_fx28[72] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 185, 190, 195, 200, 225, 250, 275, 300, 325, 350, 375, 400, 425, 450,
   475, 500, 600, 700, 800, 900, 1000 };
   Double_t Graph_fy28[72] = { 5.436442, 4.80939, 4.293436, 3.863621, 3.193059, 2.927996, 2.698225, 2.49751, 2.320955, 2.164669, 2.025527, 1.900997, 1.789008, 1.687849, 1.5961, 1.512572, 1.43626,
   1.302013, 1.242728, 1.187926, 1.137143, 1.025582, 0.9309716, 0.8508893, 0.7815601, 0.721712, 0.6690618, 0.6229006, 0.1687337, 0.1314841, 0.1064278, 0.08858799, 0.07533471,
   0.06515835, 0.05713563, 0.05067281, 0.04095794, 0.03723376, 0.034056, 0.03131754, 0.02893696, 0.02635779, 0.02417457, 0.02069295, 0.01804954, 0.0159779, 0.014311, 0.01294017, 0.0117923,
   0.01081661, 0.00997685, 0.009599347, 0.009246426, 0.008915782, 0.008605388, 0.007301544, 0.006306369, 0.005524375, 0.004895707, 0.004380818, 0.003952509, 0.003591471, 0.00328364, 0.003018536, 0.002788211,
   0.002586528, 0.002408688, 0.001869843, 0.001509423, 0.001253859, 0.001064591, 0.001064591 };
   graph = new TGraph(72,Graph_fx28,Graph_fy28);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,1.44,1099.84);
   Graph_Graph28->SetMinimum(0.000958132);
   Graph_Graph28->SetMaximum(5.97998);
