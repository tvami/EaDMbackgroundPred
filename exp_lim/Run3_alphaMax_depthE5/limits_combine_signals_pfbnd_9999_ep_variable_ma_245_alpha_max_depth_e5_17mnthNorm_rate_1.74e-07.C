...
//=========  (Tue Feb  3 11:48:00 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy246[16] = { 6.914062, 5.519727, 4.955078, 4.229102, 4.183008, 4.079297, 4.067773, 4.033203, 5.485156, 7.052344, 8.85, 10.41719, 12.03047, 13.82812, 16.31719, 17.7 };
   ...
   1 };
   Double_t Graph1_fy247[34] = { 14.91576, 12.75073, 11.69612, 10.73249, 10.59214, 10.87939, 10.89486, 11.01324, 16.67951, 21.44508, 26.91148, 31.67705, 36.58279, 42.04918, 49.61804, 53.82296, 53.82296,
   ...
   Graph_Graph1247->SetMinimum(1.545536);
   Graph_Graph1247->SetMaximum(59.03352);
   ...
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph2_fy248[34] = { 10.27635, 8.489978, 7.690613, 6.808281, 6.734076, 6.745978, 6.735029, 6.742097, 10.05475, 13.01186, 16.39917, 19.38623, 22.38853, 25.84418, 30.36604, 33.22165, 33.22165,
   ...
   Graph_Graph2248->SetMinimum(2.26203);
   Graph_Graph2248->SetMaximum(36.29248);
   ...
   Double_t Graph0_fy249[16] = { 6.914062, 5.519727, 4.955078, 4.229102, 4.183008, 4.079297, 4.067773, 4.033203, 5.485156, 7.052344, 8.85, 10.41719, 12.03047, 13.82812, 16.31719, 17.7 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(22.66935,0,22.66935,5.865749);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(22.66435,0,"  22.67 TeV");
