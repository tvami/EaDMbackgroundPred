...
#endif
void limits_combine_signals_pfbnd_99999_ep_4e-08_ma_237194_1mnthNorm_rate_()
{
//=========Macro generated from canvas: climits/climits
//=========  (Mon Jun 23 23:01:28 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fy1[8] = { 35.74219, 32.61719, 34.375, 33.00781, 33.00781, 34.08203, 34.96094, 38.08594 };
   ...
   3 };
   Double_t Graph1_fy2[18] = { 98.62873, 97.36848, 102.3416, 100.3716, 100.3716, 103.6382, 106.3108, 115.8134, 115.8134, 13.38959, 13.38959, 12.83722, 12.64763, 12.6358, 12.89368, 14.09912, 13.25073,
   15.63721 };
   ...
   Graph_Graph12->SetMinimum(2.31804);
   Graph_Graph12->SetMaximum(126.1312);
   ...
   3 };
   Double_t Graph2_fy3[18] = { 60.10454, 56.92971, 59.72374, 58.79564, 59.58506, 62.47519, 64.36501, 71.78824, 71.78824, 21.49308, 21.49308, 20.09656, 19.68079, 19.39995, 19.65077, 20.98975, 19.75665,
   22.70536 };
   ...
   Graph_Graph23->SetMinimum(14.16112);
   Graph_Graph23->SetMaximum(77.02707);
   ...
   Double_t Graph0_fy4[8] = { 35.74219, 32.61719, 34.375, 33.00781, 33.00781, 34.08203, 34.96094, 38.08594 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(5.174445,0,5.174445,34.13249);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(5.169445,0,"  5.17 TeV");
