...
//=========  (Tue Feb  3 11:45:44 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx78[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy78[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   TGraph *graph = new TGraph(15,Graph0_fx78,Graph0_fy78);
   ...
   Double_t Graph1_fx79[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph1_fy79[32] = { 19.39498, 14.95966, 13.16604, 13.43362, 13.26618, 13.28264, 13.22557, 13.72007, 19.76312, 24.80902, 36.44263, 41.90902, 51.01968, 60.55083, 66.15739, 66.15739, 7.818652,
   ...
   graph = new TGraph(32,Graph1_fx79,Graph1_fy79);
   ...
   Graph_Graph179->SetMaximum(72.57138);
   ...
   Double_t Graph2_fx80[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph2_fy80[32] = { 13.22503, 9.802909, 8.331504, 8.522975, 8.176744, 8.138355, 8.060918, 8.254497, 11.96542, 15.08546, 22.44606, 25.64816, 31.29072, 37.45373, 41.00839, 41.00839, 12.39193,
   ...
   graph = new TGraph(32,Graph2_fx80,Graph2_fy80);
   ...
   Graph_Graph280->SetMaximum(44.81244);
   ...
   Double_t Graph0_fx81[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy81[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   graph = new TGraph(15,Graph0_fx81,Graph0_fy81);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx82[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy82[15] = { 28.0685, 25.24726, 21.28035, 17.90386, 15.22907, 13.12323, 11.44857, 10.09792, 1.609151, 0.9370935, 0.4692193, 0.3658513, 0.2962583, 0.2466767, 0.2098242 };
   graph = new TGraph(15,Graph_fx82,Graph_fy82);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx84[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy84[15] = { 30.87536, 27.77199, 23.40838, 19.69425, 16.75197, 14.43555, 12.59342, 11.10771, 1.770066, 1.030803, 0.5161412, 0.4024364, 0.3258841, 0.2713444, 0.2308066 };
   graph = new TGraph(15,Graph_fx84,Graph_fy84);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(9.848271,0,9.848271,5.358065);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(9.843271,0,"  9.85 TeV");
