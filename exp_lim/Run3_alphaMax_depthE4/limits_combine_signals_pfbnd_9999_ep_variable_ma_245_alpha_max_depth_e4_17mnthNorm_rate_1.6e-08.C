...
//=========  (Wed Mar 11 02:52:37 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx85[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy85[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   TGraph *graph = new TGraph(18,Graph0_fx85,Graph0_fy85);
   ...
   Double_t Graph1_fx86[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy86[38] = { 22.68253, 17.88353, 16.02638, 12.53069, 11.03791, 9.215782, 8.374799, 8.269676, 8.550004, 10.93279, 16.67952, 21.30493, 27.33198, 33.4992, 35.74182, 44.29183, 53.26232,
   ...
   graph = new TGraph(38,Graph1_fx86,Graph1_fy86);
   ...
   Graph_Graph186->SetMinimum(0.6883813);
   Graph_Graph186->SetMaximum(64.06256);
   ...
   Double_t Graph2_fx87[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy87[38] = { 15.15963, 11.60818, 10.61303, 7.495885, 6.509188, 5.929949, 5.542505, 5.494593, 5.68085, 7.264038, 11.08232, 14.15556, 18.1601, 22.25776, 23.74782, 29.42867, 35.3889,
   ...
   graph = new TGraph(38,Graph2_fx87,Graph2_fy87);
   ...
   Graph_Graph287->SetMinimum(1.23813);
   Graph_Graph287->SetMaximum(42.47812);
   ...
   Double_t Graph0_fx88[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy88[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   graph = new TGraph(18,Graph0_fx88,Graph0_fy88);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx89[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy89[18] = { 30.06417, 28.80531, 25.05827, 21.48561, 18.50802, 16.09332, 14.13497, 12.53318, 11.20866, 5.001008, 2.063467, 1.205466, 0.8187522, 0.6051249, 0.4721153, 0.382481, 0.318577,
   0.2710542 };
   graph = new TGraph(18,Graph_fx89,Graph_fy89);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx91[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy91[18] = { 33.07059, 31.68584, 27.5641, 23.63417, 20.35882, 17.70265, 15.54846, 13.78649, 12.32952, 5.501109, 2.269813, 1.326013, 0.9006275, 0.6656374, 0.5193268, 0.4207291, 0.3504347,
   0.2981597 };
   graph = new TGraph(18,Graph_fx91,Graph_fy91);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(25.04729,0,25.04729,3.999756);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(25.04229,0,"  25.05 TeV");
