...
//=========  (Tue Feb  3 11:45:45 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx274[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy274[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   TGraph *graph = new TGraph(15,Graph0_fx274,Graph0_fy274);
   ...
   Double_t Graph1_fx275[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph1_fy275[32] = { 19.39498, 14.95966, 13.16604, 13.43362, 13.26618, 13.28264, 13.22557, 13.72007, 19.76312, 24.80902, 36.44263, 41.90902, 51.01968, 60.55083, 66.15739, 66.15739, 7.818652,
   ...
   graph = new TGraph(32,Graph1_fx275,Graph1_fy275);
   ...
   Graph_Graph1275->SetMaximum(72.57138);
   ...
   Double_t Graph2_fx276[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph2_fy276[32] = { 13.22503, 9.802909, 8.331504, 8.522975, 8.176744, 8.138355, 8.060918, 8.254497, 11.96542, 15.08546, 22.44606, 25.64816, 31.29072, 37.45373, 41.00839, 41.00839, 12.39193,
   ...
   graph = new TGraph(32,Graph2_fx276,Graph2_fy276);
   ...
   Graph_Graph2276->SetMaximum(44.81244);
   ...
   Double_t Graph0_fx277[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy277[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   graph = new TGraph(15,Graph0_fx277,Graph0_fy277);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx278[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy278[15] = { 1.270752e-115, 2.390732e-75, 2.91431e-55, 3.05949e-43, 3.016287e-35, 1.495925e-29, 2.72692e-25, 5.510536e-22, 0.05967779, 3.605982, 74.03485, 146.073, 229.5828, 314.34, 393.6671 };
   graph = new TGraph(15,Graph_fx278,Graph_fy278);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx280[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy280[15] = { 1.397827e-115, 2.629805e-75, 3.205741e-55, 3.365439e-43, 3.317916e-35, 1.645517e-29, 2.999613e-25, 6.06159e-22, 0.06564557, 3.966581, 81.43834, 160.6803, 252.5411, 345.774, 433.0339 };
   graph = new TGraph(15,Graph_fx280,Graph_fy280);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(36.19151,0,36.19151,9.189978);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(36.18651,0,"  36.19 TeV");
