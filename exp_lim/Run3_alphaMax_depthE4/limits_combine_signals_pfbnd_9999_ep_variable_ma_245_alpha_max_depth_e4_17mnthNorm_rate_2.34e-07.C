...
//=========  (Tue Feb  3 11:45:45 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx288[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy288[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   TGraph *graph = new TGraph(15,Graph0_fx288,Graph0_fy288);
   ...
   Double_t Graph1_fx289[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph1_fy289[32] = { 19.39498, 14.95966, 13.16604, 13.43362, 13.26618, 13.28264, 13.22557, 13.72007, 19.76312, 24.80902, 36.44263, 41.90902, 51.01968, 60.55083, 66.15739, 66.15739, 7.818652,
   ...
   graph = new TGraph(32,Graph1_fx289,Graph1_fy289);
   ...
   Graph_Graph1289->SetMaximum(72.57138);
   ...
   Double_t Graph2_fx290[32] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90, 90, 90,
   90, 80, 70, 60, 50, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5, 1 };
   Double_t Graph2_fy290[32] = { 13.22503, 9.802909, 8.331504, 8.522975, 8.176744, 8.138355, 8.060918, 8.254497, 11.96542, 15.08546, 22.44606, 25.64816, 31.29072, 37.45373, 41.00839, 41.00839, 12.39193,
   ...
   graph = new TGraph(32,Graph2_fx290,Graph2_fy290);
   ...
   Graph_Graph2290->SetMaximum(44.81244);
   ...
   Double_t Graph0_fx291[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy291[15] = { 8.826953, 6.291797, 5.1625, 5.300781, 4.908984, 4.885938, 4.782227, 4.839844, 6.499219, 8.158594, 11.98438, 13.78203, 16.77812, 19.9125, 21.75625 };
   graph = new TGraph(15,Graph0_fx291,Graph0_fy291);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx292[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy292[15] = { 2.994253e-139, 4.76887e-91, 5.348722e-67, 1.341719e-52, 5.093514e-43, 3.427502e-36, 4.417055e-31, 4.085948e-27, 0.005519139, 0.8307406, 35.39848, 83.82914, 150.1034, 226.6316, 306.2542 };
   graph = new TGraph(15,Graph_fx292,Graph_fy292);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx294[15] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 50, 60, 70, 80, 90 };
   Double_t Graph_fy294[15] = { 3.293679e-139, 5.245757e-91, 5.883595e-67, 1.475891e-52, 5.602866e-43, 3.770252e-36, 4.858761e-31, 4.494543e-27, 0.006071053, 0.9138146, 38.93833, 92.21205, 165.1138, 249.2948, 336.8796 };
   graph = new TGraph(15,Graph_fx294,Graph_fy294);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(43.56768,0,43.56768,10.59023);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(43.56268,0,"  43.57 TeV");
