...
//=========  (Wed Mar 11 02:52:38 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx211[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy211[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   TGraph *graph = new TGraph(18,Graph0_fx211,Graph0_fy211);
   ...
   Double_t Graph1_fx212[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy212[38] = { 22.68253, 17.88353, 16.02638, 12.53069, 11.03791, 9.215782, 8.374799, 8.269676, 8.550004, 10.93279, 16.67952, 21.30493, 27.33198, 33.4992, 35.74182, 44.29183, 53.26232,
   ...
   graph = new TGraph(38,Graph1_fx212,Graph1_fy212);
   ...
   Graph_Graph1212->SetMinimum(0.6883813);
   Graph_Graph1212->SetMaximum(64.06256);
   ...
   Double_t Graph2_fx213[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy213[38] = { 15.15963, 11.60818, 10.61303, 7.495885, 6.509188, 5.929949, 5.542505, 5.494593, 5.68085, 7.264038, 11.08232, 14.15556, 18.1601, 22.25776, 23.74782, 29.42867, 35.3889,
   ...
   graph = new TGraph(38,Graph2_fx213,Graph2_fy213);
   ...
   Graph_Graph2213->SetMinimum(1.23813);
   Graph_Graph2213->SetMaximum(42.47812);
   ...
   Double_t Graph0_fx214[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy214[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   graph = new TGraph(18,Graph0_fx214,Graph0_fy214);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx215[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy215[18] = { 7.969938e-36, 1.823103e-22, 7.749192e-16, 6.852249e-12, 2.796611e-09, 1.981761e-07, 4.72118e-06, 5.453116e-05, 0.0003801889, 1.749379, 73.30169, 199.7875, 293.0989, 343.8553, 365.0549, 368.5332, 362.0335,
   350.2127 };
   graph = new TGraph(18,Graph_fx215,Graph_fy215);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx217[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy217[18] = { 8.766932e-36, 2.005413e-22, 8.524111e-16, 7.537474e-12, 3.076272e-09, 2.179937e-07, 5.193298e-06, 5.998428e-05, 0.0004182078, 1.924317, 80.63186, 219.7663, 322.4088, 378.2408, 401.5603, 405.3865, 398.2368,
   385.2339 };
   graph = new TGraph(18,Graph_fx217,Graph_fy217);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(24.34887,0,24.34887,3.941188);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(24.34387,0,"  24.35 TeV");
