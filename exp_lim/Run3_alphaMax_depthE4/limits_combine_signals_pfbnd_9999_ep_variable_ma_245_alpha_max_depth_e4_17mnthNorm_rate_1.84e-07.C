...
//=========  (Wed Mar 11 02:52:38 2026) by ROOT version 6.30/07
   ...
   180 };
   Double_t Graph0_fy253[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   ...
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy254[38] = { 22.68253, 17.88353, 16.02638, 12.53069, 11.03791, 9.215782, 8.374799, 8.269676, 8.550004, 10.93279, 16.67952, 21.30493, 27.33198, 33.4992, 35.74182, 44.29183, 53.26232,
   ...
   Graph_Graph1254->SetMinimum(0.6883813);
   Graph_Graph1254->SetMaximum(64.06256);
   ...
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy255[38] = { 15.15963, 11.60818, 10.61303, 7.495885, 6.509188, 5.929949, 5.542505, 5.494593, 5.68085, 7.264038, 11.08232, 14.15556, 18.1601, 22.25776, 23.74782, 29.42867, 35.3889,
   ...
   Graph_Graph2255->SetMinimum(1.23813);
   Graph_Graph2255->SetMaximum(42.47812);
   ...
   180 };
   Double_t Graph0_fy256[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(51.18188,0,51.18188,6.289539);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(51.17688,0,"  51.18 TeV");
