...
//=========  (Wed Mar 11 02:52:38 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx162[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy162[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   TGraph *graph = new TGraph(18,Graph0_fx162,Graph0_fy162);
   ...
   TH1F *Graph_Graph0162 = new TH1F("Graph_Graph0162","",100,0,197.8);
   ...
   Double_t Graph1_fx163[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph1_fy163[38] = { 22.68253, 17.88353, 16.02638, 12.53069, 11.03791, 9.215782, 8.374799, 8.269676, 8.550004, 10.93279, 16.67952, 21.30493, 27.33198, 33.4992, 35.74182, 44.29183, 53.26232,
   ...
   graph = new TGraph(38,Graph1_fx163,Graph1_fy163);
   ...
   TH1F *Graph_Graph1163 = new TH1F("Graph_Graph1163","Graph",100,0,197.8);
   Graph_Graph1163->SetMinimum(0.6883813);
   Graph_Graph1163->SetMaximum(64.06256);
   ...
   Double_t Graph2_fx164[38] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180, 180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7,
   6, 5, 4, 3, 2 };
   Double_t Graph2_fy164[38] = { 15.15963, 11.60818, 10.61303, 7.495885, 6.509188, 5.929949, 5.542505, 5.494593, 5.68085, 7.264038, 11.08232, 14.15556, 18.1601, 22.25776, 23.74782, 29.42867, 35.3889,
   ...
   graph = new TGraph(38,Graph2_fx164,Graph2_fy164);
   ...
   TH1F *Graph_Graph2164 = new TH1F("Graph_Graph2164","Graph",100,0,197.8);
   Graph_Graph2164->SetMinimum(1.23813);
   Graph_Graph2164->SetMaximum(42.47812);
   ...
   Double_t Graph0_fx165[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph0_fy165[18] = { 9.933203, 7.375, 7.121484, 4.436523, 3.629883, 3.030664, 2.754102, 2.719531, 2.811719, 3.595313, 5.485156, 7.00625, 8.988281, 11.01641, 11.75391, 14.56563, 17.51562,
   19.175 };
   graph = new TGraph(18,Graph0_fx165,Graph0_fy165);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0165 = new TH1F("Graph_Graph0165","",100,0,197.8);
   ...
   Double_t Graph_fx166[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy166[18] = { 0.0003392874, 0.07336967, 0.9588659, 4.17842, 10.6397, 20.06472, 31.4953, 43.86712, 56.30322, 127.6718, 118.7582, 90.96987, 70.7511, 56.719, 46.71613, 39.34048, 33.7328,
   29.35624 };
   graph = new TGraph(18,Graph_fx166,Graph_fy166);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph166 = new TH1F("Graph_Graph166","",100,0,197.8);
   Graph_Graph166->SetMinimum(0.0003053586);
   Graph_Graph166->SetMaximum(140.4389);
   ...
   Double_t Graph_fx168[18] = { 2, 3, 4, 5, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160,
   180 };
   Double_t Graph_fy168[18] = { 0.0003732161, 0.08070664, 1.054753, 4.596262, 11.70367, 22.07119, 34.64482, 48.25384, 61.93355, 140.439, 130.634, 100.0669, 77.82621, 62.3909, 51.38775, 43.27452, 37.10608,
   32.29187 };
   graph = new TGraph(18,Graph_fx168,Graph_fy168);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph168 = new TH1F("Graph_Graph168","",100,0,197.8);
   Graph_Graph168->SetMinimum(0.0003358945);
   Graph_Graph168->SetMaximum(154.4828);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(5.052793,0,5.052793,4.389771);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(5.047793,0,"  5.05 TeV");
