...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_thermal_2mnthNorm_rate_1.4e-08()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Sep 19 19:05:44 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx8[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy8[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 0.00743866, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   TGraph *graph = new TGraph(28,Graph0_fx8,Graph0_fy8);
   ...
   TH1F *Graph_Graph08 = new TH1F("Graph_Graph08","",100,1.42,10.78);
   ...
   Graph_Graph08->GetXaxis()->SetTitle("m(X) [TeV]");
   Graph_Graph08->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph1_fx9[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   ...
   Double_t Graph1_fy9[58] = { 58.779, 51.64776, 45.92929, 43.98549, 45.6157, 46.96366, 45.67817, 0.01811666, 42.26104, 41.07864, 41.22047, 41.3882, 41.46952, 41.86501, 42.41551, 41.4595, 41.57227,
   ...
   graph = new TGraph(58,Graph1_fx9,Graph1_fy9);
   ...
   TH1F *Graph_Graph19 = new TH1F("Graph_Graph19","Graph",100,1.42,10.78);
   Graph_Graph19->SetMinimum(0.003138185);
   Graph_Graph19->SetMaximum(64.65655);
   ...
   Double_t Graph2_fx10[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10, 10, 9.5, 9,
   8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4,
   3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2 };
   Double_t Graph2_fy10[58] = { 41.08932, 34.68272, 30.43059, 29.10126, 30.56705, 31.66236, 30.49195, 0.01194558, 27.44781, 26.52774, 26.5394, 26.79385, 26.96737, 27.20667, 27.4908, 26.67214, 26.60195,
   ...
   graph = new TGraph(58,Graph2_fx10,Graph2_fy10);
   ...
   TH1F *Graph_Graph210 = new TH1F("Graph_Graph210","Graph",100,1.42,10.78);
   Graph_Graph210->SetMinimum(0.004694201);
   Graph_Graph210->SetMaximum(45.19773);
   ...
   Double_t Graph0_fx11[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy11[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 0.00743866, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   graph = new TGraph(28,Graph0_fx11,Graph0_fy11);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph011 = new TH1F("Graph_Graph011","",100,1.42,10.78);
   ...
   Graph_Graph011->GetXaxis()->SetTitle("m(X) [TeV]");
   Graph_Graph011->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph_fx12[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy12[28] = { 2.194039, 1.653256, 1.774335, 1.667875, 1.460809, 1.464494, 1.26116, 1.257458, 1.124047, 1.088546, 1.005855, 0.949037, 0.8895345, 0.8321012, 0.7852431, 0.7362696, 0.6975237,
   0.6575216, 0.6234034, 0.5904113, 0.506072, 0.4592758, 0.4003684, 0.3670699, 0.3243408, 0.2998391, 0.2679497, 0.2494189 };
   graph = new TGraph(28,Graph_fx12,Graph_fy12);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","",100,1.42,10.78);
   Graph_Graph12->SetMinimum(0.05495695);
   Graph_Graph12->SetMaximum(2.388501);
   ...
   Double_t Graph_fx14[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy14[28] = { 2.413443, 1.818582, 1.951769, 1.834662, 1.606889, 1.610944, 1.387276, 1.383204, 1.236451, 1.197401, 1.10644, 1.043941, 0.9784879, 0.9153114, 0.8637674, 0.8098966, 0.7672761,
   0.7232738, 0.6857438, 0.6494524, 0.5566792, 0.5052034, 0.4404053, 0.4037769, 0.3567749, 0.329823, 0.2947447, 0.2743608 };
   ...
   TH1F *Graph_Graph14 = new TH1F("Graph_Graph14","",100,1.42,10.78);
   Graph_Graph14->SetMinimum(0.06045265);
   Graph_Graph14->SetMaximum(2.627351);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(3.469876,0,3.469876,1.259866);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(3.464876,0,"  3.47 TeV");
