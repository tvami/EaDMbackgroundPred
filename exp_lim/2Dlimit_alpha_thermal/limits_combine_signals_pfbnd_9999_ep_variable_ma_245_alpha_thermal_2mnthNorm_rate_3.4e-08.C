...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_thermal_2mnthNorm_rate_3.4e-08()
{
//=========Macro generated from canvas: climits/climits
//=========  (Fri Sep 19 19:05:45 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy22[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 0.00743866, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   TGraph *graph = new TGraph(28,Graph0_fx22,Graph0_fy22);
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,1.42,10.78);
   ...
   Graph_Graph022->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph1_fx23[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   ...
   Double_t Graph1_fy23[58] = { 58.779, 51.64776, 45.92929, 43.98549, 45.6157, 46.96366, 45.67817, 0.01811666, 42.26104, 41.07864, 41.22047, 41.3882, 41.46952, 41.86501, 42.41551, 41.4595, 41.57227,
   ...
   graph = new TGraph(58,Graph1_fx23,Graph1_fy23);
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,1.42,10.78);
   Graph_Graph123->SetMinimum(0.003138185);
   Graph_Graph123->SetMaximum(64.65655);
   ...
   Double_t Graph2_fx24[58] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10, 10, 9.5, 9,
   8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4,
   3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2 };
   Double_t Graph2_fy24[58] = { 41.08932, 34.68272, 30.43059, 29.10126, 30.56705, 31.66236, 30.49195, 0.01194558, 27.44781, 26.52774, 26.5394, 26.79385, 26.96737, 27.20667, 27.4908, 26.67214, 26.60195,
   ...
   graph = new TGraph(58,Graph2_fx24,Graph2_fy24);
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,1.42,10.78);
   Graph_Graph224->SetMinimum(0.004694201);
   Graph_Graph224->SetMaximum(45.19773);
   ...
   Double_t Graph0_fx25[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy25[28] = { 27.83203, 22.60742, 19.53125, 18.75, 19.87305, 20.80078, 19.82422, 0.00743866, 17.28516, 16.60156, 16.65039, 16.89453, 17.08984, 17.28516, 17.33398, 16.65039, 16.50391,
   15.91797, 16.01562, 17.72461, 15.625, 15.33203, 15.47852, 15.33203, 15.52734, 15.82031, 16.25977, 17.1875 };
   graph = new TGraph(28,Graph0_fx25,Graph0_fy25);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,1.42,10.78);
   ...
   Graph_Graph025->GetXaxis()->SetRange(0,92);
   ...
   Double_t Graph_fx26[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy26[28] = { 0.3702503, 0.5296949, 0.7118183, 0.9048571, 1.103081, 1.301692, 1.49463, 1.679742, 1.853362, 2.014481, 2.161866, 2.295239, 2.41462, 2.52035, 2.612982, 2.693206, 2.761804,
   2.819595, 2.867415, 2.906091, 2.975062, 2.988927, 2.973652, 2.945153, 2.88274, 2.831587, 2.745279, 2.683474 };
   graph = new TGraph(28,Graph_fx26,Graph_fy26);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,1.42,10.78);
   Graph_Graph26->SetMinimum(0.1083826);
   Graph_Graph26->SetMaximum(3.250794);
   ...
   Double_t Graph_fx28[28] = { 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5, 5.2, 5.4,
   5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy28[28] = { 0.4072753, 0.5826644, 0.7830001, 0.9953428, 1.213389, 1.431861, 1.644093, 1.847716, 2.038698, 2.21593, 2.378053, 2.524763, 2.656082, 2.772385, 2.87428, 2.962527, 3.037984,
   3.101554, 3.154157, 3.1967, 3.272568, 3.287819, 3.271017, 3.239668, 3.171014, 3.114746, 3.019806, 2.951821 };
   graph = new TGraph(28,Graph_fx28,Graph_fy28);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,1.42,10.78);
   Graph_Graph28->SetMinimum(0.1192209);
   Graph_Graph28->SetMaximum(3.575874);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(3.464587,0,3.464587,1.552063);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(3.459587,0,"  3.46 TeV");
