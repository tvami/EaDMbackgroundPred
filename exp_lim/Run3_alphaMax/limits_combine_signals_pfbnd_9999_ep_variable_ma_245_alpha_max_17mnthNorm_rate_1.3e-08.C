...
//=========  (Wed Mar 11 02:27:54 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx64[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy64[50] = { 6.787305, 5.600391, 3.848828, 3.261133, 3.272656, 3.410938, 3.72207, 3.295703, 2.95, 2.846289, 2.938477, 2.978809, 2.880859, 2.690723, 2.350781, 2.103027, 1.930176,
   ...
   18.16094 };
   TGraph *graph = new TGraph(50,Graph0_fx64,Graph0_fy64);
   ...
   Double_t Graph1_fx65[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   ...
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy65[102] = { 13.48956, 11.81711, 8.546922, 7.278019, 7.30231, 7.831383, 7.60548, 6.864837, 6.894179, 6.495308, 6.427729, 6.378965, 6.241812, 6.141558, 5.794994, 5.509996, 5.212377,
   ...
   graph = new TGraph(102,Graph1_fx65,Graph1_fy65);
   ...
   TH1F *Graph_Graph165 = new TH1F("Graph_Graph165","Graph",102,0,197.84);
   Graph_Graph165->SetMinimum(0.3057852);
   Graph_Graph165->SetMaximum(60.7131);
   ...
   Double_t Graph2_fx66[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85, 75,
   70, 60, 55, 50, 45, 40, 30, 25, 20, 10, 9, 8.5, 8, 7.5, 7, 6,
   5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6,
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy66[102] = { 9.695662, 8.279198, 5.804881, 4.931506, 4.955454, 5.368782, 5.146358, 4.523995, 4.025933, 4.343886, 4.34988, 4.344279, 4.23588, 4.085016, 3.751643, 3.452651, 3.199647,
   ...
   graph = new TGraph(102,Graph2_fx66,Graph2_fy66);
   ...
   TH1F *Graph_Graph266 = new TH1F("Graph_Graph266","Graph",102,0,197.84);
   Graph_Graph266->SetMinimum(0.543457);
   Graph_Graph266->SetMaximum(40.30159);
   ...
   Double_t Graph0_fx67[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy67[50] = { 6.787305, 5.600391, 3.848828, 3.261133, 3.272656, 3.410938, 3.72207, 3.295703, 2.95, 2.846289, 2.938477, 2.978809, 2.880859, 2.690723, 2.350781, 2.103027, 1.930176,
   1.837988, 1.716992, 1.670898, 1.578711, 1.492285, 1.244531, 1.209961, 1.175391, 1.181152, 1.198438, 1.233008, 3.549219, 4.102344, 4.609375, 5.485156, 5.761719,
   6.360938, 6.591406, 7.213672, 7.928125, 8.389062, 9.771875, 10.09453, 10.55547, 10.64766, 11.66172, 12.81406, 13.45938, 14.75, 14.84219, 16.225, 17.79219,
   18.16094 };
   graph = new TGraph(50,Graph0_fx67,Graph0_fy67);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx68[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy68[50] = { 23.50447, 23.02316, 22.29828, 21.44951, 20.54945, 19.64167, 18.75181, 17.89446, 17.07731, 16.30381, 15.57482, 14.88961, 14.24652, 13.64343, 13.07794, 12.5476, 12.04999,
   11.58278, 11.14374, 10.73081, 10.34205, 9.630072, 8.164294, 7.566394, 7.035912, 6.567241, 6.147125, 5.432913, 2.298497, 1.720714, 1.354026, 0.9235009, 0.7885462,
   0.6842546, 0.6016071, 0.5347442, 0.4337365, 0.3948494, 0.3328753, 0.307867, 0.285923, 0.2665367, 0.2339035, 0.2075823, 0.1859714, 0.1679586, 0.1527498, 0.1397638, 0.1285663,
   0.1188271 };
   graph = new TGraph(50,Graph_fx68,Graph_fy68);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx70[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy70[50] = { 25.85492, 25.32548, 24.52811, 23.59447, 22.6044, 21.60583, 20.62699, 19.6839, 18.78504, 17.9342, 17.13231, 16.37857, 15.67118, 15.00777, 14.38573, 13.80236, 13.25499,
   12.74105, 12.25811, 11.80389, 11.37626, 10.59308, 8.980724, 8.323033, 7.739503, 7.223965, 6.761838, 5.976204, 2.528346, 1.892786, 1.489428, 1.015851, 0.8674009,
   0.7526801, 0.6617679, 0.5882187, 0.4771102, 0.4343344, 0.3661629, 0.3386537, 0.3145153, 0.2931904, 0.2572939, 0.2283405, 0.2045685, 0.1847545, 0.1680248, 0.1537401, 0.1414229,
   0.1307098 };
   graph = new TGraph(50,Graph_fx70,Graph_fy70);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(17.73416,0,17.73416,2.793142);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(17.72916,0,"  17.73 TeV");
