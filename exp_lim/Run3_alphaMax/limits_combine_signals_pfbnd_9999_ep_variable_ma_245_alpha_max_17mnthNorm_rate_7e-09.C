...
//=========  (Wed Mar 11 02:27:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy22[50] = { 6.787305, 5.600391, 3.848828, 3.261133, 3.272656, 3.410938, 3.72207, 3.295703, 2.95, 2.846289, 2.938477, 2.978809, 2.880859, 2.690723, 2.350781, 2.103027, 1.930176,
   ...
   18.16094 };
   TGraph *graph = new TGraph(50,Graph0_fx22,Graph0_fy22);
   ...
   Double_t Graph1_fx23[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   ...
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy23[102] = { 13.48956, 11.81711, 8.546922, 7.278019, 7.30231, 7.831383, 7.60548, 6.864837, 6.894179, 6.495308, 6.427729, 6.378965, 6.241812, 6.141558, 5.794994, 5.509996, 5.212377,
   ...
   graph = new TGraph(102,Graph1_fx23,Graph1_fy23);
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",102,0,197.84);
   Graph_Graph123->SetMinimum(0.3057852);
   Graph_Graph123->SetMaximum(60.7131);
   ...
   Double_t Graph2_fx24[102] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85, 75,
   70, 60, 55, 50, 45, 40, 30, 25, 20, 10, 9, 8.5, 8, 7.5, 7, 6,
   5.6, 5.4, 5.2, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6,
   2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy24[102] = { 9.695662, 8.279198, 5.804881, 4.931506, 4.955454, 5.368782, 5.146358, 4.523995, 4.025933, 4.343886, 4.34988, 4.344279, 4.23588, 4.085016, 3.751643, 3.452651, 3.199647,
   ...
   graph = new TGraph(102,Graph2_fx24,Graph2_fy24);
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",102,0,197.84);
   Graph_Graph224->SetMinimum(0.543457);
   Graph_Graph224->SetMaximum(40.30159);
   ...
   Double_t Graph0_fx25[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph0_fy25[50] = { 6.787305, 5.600391, 3.848828, 3.261133, 3.272656, 3.410938, 3.72207, 3.295703, 2.95, 2.846289, 2.938477, 2.978809, 2.880859, 2.690723, 2.350781, 2.103027, 1.930176,
   1.837988, 1.716992, 1.670898, 1.578711, 1.492285, 1.244531, 1.209961, 1.175391, 1.181152, 1.198438, 1.233008, 3.549219, 4.102344, 4.609375, 5.485156, 5.761719,
   6.360938, 6.591406, 7.213672, 7.928125, 8.389062, 9.771875, 10.09453, 10.55547, 10.64766, 11.66172, 12.81406, 13.45938, 14.75, 14.84219, 16.225, 17.79219,
   18.16094 };
   graph = new TGraph(50,Graph0_fx25,Graph0_fy25);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx26[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy26[50] = { 4.94222, 4.372173, 3.903124, 3.512383, 3.183129, 2.902781, 2.661815, 2.452932, 2.270464, 2.109959, 1.967881, 1.841388, 1.728179, 1.626371, 1.534408, 1.451, 1.375065,
   1.305691, 1.242105, 1.183648, 1.129753, 1.033766, 0.8463378, 0.7735357, 0.7105092, 0.6561018, 0.608238, 0.5288785, 0.2079289, 0.1533943, 0.119531, 0.08053454, 0.0684861,
   0.05923486, 0.05194148, 0.04606619, 0.03723449, 0.03384887, 0.02847049, 0.02630633, 0.02441033, 0.02273769, 0.01992723, 0.01766517, 0.01581121, 0.01426827, 0.01296721, 0.01185755, 0.01090167,
   0.01007102 };
   graph = new TGraph(50,Graph_fx26,Graph_fy26);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx28[50] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 6, 7, 7.5, 8, 8.5, 9, 10, 20, 25, 30, 40, 45,
   50, 55, 60, 70, 75, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160, 170,
   180 };
   Double_t Graph_fy28[50] = { 5.436442, 4.80939, 4.293437, 3.863622, 3.501442, 3.193059, 2.927996, 2.698225, 2.49751, 2.320955, 2.164669, 2.025527, 1.900997, 1.789008, 1.687849, 1.5961, 1.512571,
   1.43626, 1.366315, 1.302012, 1.242728, 1.137143, 0.9309716, 0.8508893, 0.7815602, 0.721712, 0.6690618, 0.5817664, 0.2287218, 0.1687338, 0.1314841, 0.088588, 0.07533472,
   0.06515835, 0.05713563, 0.05067281, 0.04095794, 0.03723376, 0.03131754, 0.02893696, 0.02685136, 0.02501145, 0.02191995, 0.01943169, 0.01739233, 0.0156951, 0.01426393, 0.0130433, 0.01199184,
   0.01107812 };
   graph = new TGraph(50,Graph_fx28,Graph_fy28);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.989289,0,1.989289,3.926917);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.984289,0,"  1.99 TeV");
