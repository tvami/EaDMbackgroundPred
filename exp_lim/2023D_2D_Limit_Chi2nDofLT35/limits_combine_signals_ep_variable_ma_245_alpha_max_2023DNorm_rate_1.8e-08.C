...
#endif
void limits_combine_signals_ep_variable_ma_245_alpha_max_2023DNorm_rate_1.8e-08()
{
...
//=========  (Tue Feb 17 10:14:00 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx99[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph0_fy99[51] = { 44.14062, 40.82031, 46.38672, 45.11719, 32.8125, 31.25, 33.10547, 34.17969, 31.93359, 30.66406, 28.90625, 27.73438, 27.83203, 28.125, 28.32031, 28.61328, 29.00391,
   ...
   293.75, 303.125 };
   TGraph *graph = new TGraph(51,Graph0_fx99,Graph0_fy99);
   ...
   Double_t Graph1_fx100[104] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   ...
   Double_t Graph1_fy100[104] = { 98.78161, 91.63651, 100.5267, 98.86166, 81.84521, 78.30399, 80.23781, 82.03911, 78.07549, 78.37128, 76.4536, 74.75047, 75.3972, 75.2802, 75.10097, 75.87788, 76.88124,
   ...
   graph = new TGraph(104,Graph1_fx100,Graph1_fy100);
   ...
   TH1F *Graph_Graph1100 = new TH1F("Graph_Graph1100","Graph",104,0,197.84);
   Graph_Graph1100->SetMinimum(10.03326);
   Graph_Graph1100->SetMaximum(1012.817);
   ...
   Double_t Graph2_fx101[104] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90, 85,
   80, 75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy101[104] = { 67.01366, 62.05416, 69.12935, 67.59707, 52.69289, 50.43283, 52.23964, 53.66225, 50.70868, 49.97613, 48.03303, 46.58322, 46.80271, 46.95905, 46.9465, 47.43215, 47.96408,
   ...
   graph = new TGraph(104,Graph2_fx101,Graph2_fy101);
   ...
   TH1F *Graph_Graph2101 = new TH1F("Graph_Graph2101","Graph",104,0,197.84);
   Graph_Graph2101->SetMinimum(15.07401);
   Graph_Graph2101->SetMaximum(640.1129);
   ...
   Double_t Graph0_fx102[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph0_fy102[51] = { 44.14062, 40.82031, 46.38672, 45.11719, 32.8125, 31.25, 33.10547, 34.17969, 31.93359, 30.66406, 28.90625, 27.73438, 27.83203, 28.125, 28.32031, 28.61328, 29.00391,
   28.32031, 27.63672, 27.73438, 27.34375, 27.63672, 27.44141, 28.125, 28.32031, 28.90625, 29.29688, 29.39453, 76.95312, 82.8125, 87.5, 95.3125, 99.21875,
   107.8125, 113.6719, 120.3125, 134.375, 142.9688, 152.3438, 162.5, 170.3125, 174.2188, 178.9062, 195.3125, 212.5, 225.7812, 243.75, 250, 267.1875,
   293.75, 303.125 };
   graph = new TGraph(51,Graph0_fx102,Graph0_fy102);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx103[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph_fy103[51] = { 26.43543, 29.53542, 31.7807, 33.32052, 34.8349, 35.03363, 34.97454, 34.72127, 34.32348, 33.81976, 33.23997, 32.60718, 31.93917, 31.24962, 30.549, 29.84533, 29.14469,
   ...
   2.42146, 2.136332, 1.904358, 1.551628, 1.415066, 1.297927, 1.196514, 1.107993, 1.030159, 0.9612696, 0.8450316, 0.7510172, 0.6736481, 0.6090339, 0.5543852, 0.5076546,
   0.4673083, 0.4321761 };
   graph = new TGraph(51,Graph_fx103,Graph_fy103);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx105[51] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 25, 30, 35, 40, 45,
   50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150, 160,
   170, 180 };
   Double_t Graph_fy105[51] = { 29.07897, 32.48896, 34.95877, 36.65257, 38.31839, 38.53699, 38.472, 38.1934, 37.75583, 37.20174, 36.56397, 35.8679, 35.13309, 34.37458, 33.6039, 32.82987, 32.05916,
   30.54656, 29.81115, 29.09255, 28.39209, 26.72765, 25.1813, 23.75999, 22.44779, 21.24512, 20.13509, 19.11644, 6.449174, 5.139346, 4.227092, 3.561028, 3.056687,
   2.663607, 2.349965, 2.094794, 1.706791, 1.556573, 1.427719, 1.316165, 1.218792, 1.133175, 1.057397, 0.9295348, 0.8261189, 0.741013, 0.6699373, 0.6098237, 0.5584201,
   0.5140391, 0.4753938 };
   graph = new TGraph(51,Graph_fx105,Graph_fy105);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(2.534075,0,2.534075,34.58065);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(2.529075,0,"  2.53 TeV");
