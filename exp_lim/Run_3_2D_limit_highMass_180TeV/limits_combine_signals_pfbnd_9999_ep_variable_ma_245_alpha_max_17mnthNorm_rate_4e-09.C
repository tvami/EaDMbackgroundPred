...
//=========  (Wed Jan 21 00:30:35 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx1[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph0_fy1[52] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(52,Graph0_fx1,Graph0_fy1);
   ...
   Graph_Graph01->GetXaxis()->SetRange(1,96);
   ...
   Double_t Graph1_fx2[106] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   ...
   Double_t Graph1_fy2[106] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(106,Graph1_fx2,Graph1_fy2);
   ...
   TH1F *Graph_Graph12 = new TH1F("Graph_Graph12","Graph",106,0,197.84);
   Graph_Graph12->SetMinimum(0.797055);
   Graph_Graph12->SetMaximum(68.98423);
   ...
   Double_t Graph2_fx3[106] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90,
   85, 80, 75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5,
   8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6,
   3.4, 3.2, 3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy3[106] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(106,Graph2_fx3,Graph2_fy3);
   ...
   TH1F *Graph_Graph23 = new TH1F("Graph_Graph23","Graph",106,0,197.84);
   Graph_Graph23->SetMinimum(1.166561);
   Graph_Graph23->SetMaximum(42.05212);
   ...
   Double_t Graph0_fx4[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph0_fy4[52] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438, 12.26094, 13.41328, 14.56563, 15.4875, 16.77812, 17.23906,
   18.34531, 20.09688, 20.65 };
   graph = new TGraph(52,Graph0_fx4,Graph0_fy4);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Graph_Graph04->GetXaxis()->SetRange(1,96);
   ...
   Double_t Graph_fx5[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph_fy5[52] = { 0.6780503, 0.5832724, 0.5091595, 0.449863, 0.3614446, 0.3277876, 0.2991775, 0.2746049, 0.2533072, 0.2346981, 0.2183208, 0.2038137, 0.190888, 0.1793098, 0.1688882, 0.159466, 0.1509126,
   ...
   0.007367893, 0.006366913, 0.005578885, 0.004944813, 0.003992969, 0.003628506, 0.003317712, 0.003050028, 0.002817439, 0.002613758, 0.002434142, 0.002132491, 0.001889842, 0.001691066, 0.001525705, 0.001386316,
   0.00126747, 0.001165122, 0.001076204 };
   graph = new TGraph(52,Graph_fx5,Graph_fy5);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx7[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph_fy7[52] = { 0.7458554, 0.6415996, 0.5600754, 0.4948493, 0.3975891, 0.3605664, 0.3290953, 0.3020654, 0.2786379, 0.258168, 0.2401529, 0.2241951, 0.2099768, 0.1972407, 0.185777, 0.1754127, 0.1660039,
   ...
   0.008104683, 0.007003605, 0.006136773, 0.005439294, 0.004392265, 0.003991357, 0.003649483, 0.003355031, 0.003099183, 0.002875134, 0.002677556, 0.002345741, 0.002078826, 0.001860173, 0.001678275, 0.001524947,
   0.001394217, 0.001281635, 0.001183824 };
   graph = new TGraph(52,Graph_fx7,Graph_fy7);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
