...
//=========  (Wed Jan 21 00:30:36 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx15[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph0_fy15[52] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(52,Graph0_fx15,Graph0_fy15);
   ...
   Graph_Graph015->GetXaxis()->SetRange(1,96);
   ...
   Double_t Graph1_fx16[106] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   ...
   Double_t Graph1_fy16[106] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(106,Graph1_fx16,Graph1_fy16);
   ...
   TH1F *Graph_Graph116 = new TH1F("Graph_Graph116","Graph",106,0,197.84);
   Graph_Graph116->SetMinimum(0.797055);
   Graph_Graph116->SetMaximum(68.98423);
   ...
   Double_t Graph2_fx17[106] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180, 180, 180, 180, 170, 160, 150, 140, 130, 120, 110, 100, 95, 90,
   85, 80, 75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5,
   8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6,
   3.4, 3.2, 3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy17[106] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(106,Graph2_fx17,Graph2_fy17);
   ...
   TH1F *Graph_Graph217 = new TH1F("Graph_Graph217","Graph",106,0,197.84);
   Graph_Graph217->SetMinimum(1.166561);
   Graph_Graph217->SetMaximum(42.05212);
   ...
   Double_t Graph0_fx18[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph0_fy18[52] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438, 12.26094, 13.41328, 14.56563, 15.4875, 16.77812, 17.23906,
   18.34531, 20.09688, 20.65 };
   graph = new TGraph(52,Graph0_fx18,Graph0_fy18);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Graph_Graph018->GetXaxis()->SetRange(1,96);
   ...
   Double_t Graph_fx19[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph_fy19[52] = { 2.94624, 2.57781, 2.281034, 2.037907, 1.6656, 1.520681, 1.396055, 1.287935, 1.193397, 1.110151, 1.036381, 0.9706328, 0.9117254, 0.8586941, 0.8107427, 0.767209, 0.7275382,
   ...
   0.03709787, 0.03207528, 0.02811784, 0.02493132, 0.02014393, 0.01830953, 0.01674467, 0.01539642, 0.01422459, 0.01319814, 0.01229276, 0.01077177, 0.009547854, 0.008544938, 0.007710405, 0.007006793,
   0.006406768, 0.005889956, 0.005440887 };
   graph = new TGraph(52,Graph_fx19,Graph_fy19);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx21[52] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 100, 110, 120, 130, 140, 150,
   160, 170, 180 };
   Double_t Graph_fy21[52] = { 3.240864, 2.835591, 2.509138, 2.241698, 1.83216, 1.67275, 1.535661, 1.416729, 1.312736, 1.221166, 1.140019, 1.067696, 1.002898, 0.9445635, 0.891817, 0.8439299, 0.800292,
   ...
   0.04080765, 0.03528281, 0.03092963, 0.02742446, 0.02215832, 0.02014048, 0.01841913, 0.01693606, 0.01564705, 0.01451796, 0.01352203, 0.01184895, 0.01050264, 0.009399432, 0.008481446, 0.007707473,
   0.007047445, 0.006478951, 0.005984976 };
   graph = new TGraph(52,Graph_fx21,Graph_fy21);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
