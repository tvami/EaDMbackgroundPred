...
//=========  (Fri Jun 12 12:26:04 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy190[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy191[42] = { 1457.687, 27.47935, 26.15284, 19.24384, 17.92632, 17.38699, 16.73084, 27.68956, 38.5269, 50.43768, 61.74458, 114.93, 117.6376, 114.6043, 116.7088, 115.2264, 111.2055,
   ...
   Graph_Graph1191->SetMinimum(1.945848);
   Graph_Graph1191->SetMaximum(1603.239);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy192[42] = { 947.109, 16.94284, 16.24654, 11.94261, 11.21071, 10.94063, 10.50743, 18.34658, 25.57006, 33.50286, 41.02474, 76.36258, 78.16154, 76.14616, 77.54447, 76.55948, 73.88788,
   ...
   Graph_Graph2192->SetMinimum(2.965129);
   Graph_Graph2192->SetMaximum(1041.49);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy193[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   38.04265, 38.21704, 38.21704 };
   ...
   Double_t Graph_fx194[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy194[20] = { 2.252217e-11, 1.224086e-07, 1.98812e-05, 0.0005648644, 0.005966537, 0.03409894, 0.1297561, 178.6125, 250.0586, 262.9211, 244.1234, 148.6822, 101.1696, 74.21011, 57.43965, 46.2153, 38.2735,
   32.40901, 27.9305, 27.9305 };
   graph = new TGraph(20,Graph_fx194,Graph_fy194);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph194 = new TH1F("Graph_Graph194","",100,2.7,1099.7);
   ...
   Double_t Graph_fx196[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy196[20] = { 2.477439e-11, 1.346495e-07, 2.186932e-05, 0.0006213508, 0.006563191, 0.03750883, 0.1427317, 196.4738, 275.0645, 289.2132, 268.5357, 163.5504, 111.2866, 81.63112, 63.18362, 50.83683, 42.10085,
   35.64991, 30.72355, 30.72355 };
   graph = new TGraph(20,Graph_fx196,Graph_fy196);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph196 = new TH1F("Graph_Graph196","",100,2.7,1099.7);
   Graph_Graph196->SetMinimum(2.229695e-11);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(26.32744,0,26.32744,7.371407);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(26.32244,0,"  26.33 TeV");
