...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_17mnthNorm_rate_Vol_1.04e-07()
{
...
//=========  (Fri Jun 12 12:26:04 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy197[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy198[42] = { 1457.687, 27.47935, 26.15284, 19.24384, 17.92632, 17.38699, 16.73084, 27.68956, 38.5269, 50.43768, 61.74458, 114.93, 117.6376, 114.6043, 116.7088, 115.2264, 111.2055,
   ...
   Graph_Graph1198->SetMinimum(1.945848);
   Graph_Graph1198->SetMaximum(1603.239);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy199[42] = { 947.109, 16.94284, 16.24654, 11.94261, 11.21071, 10.94063, 10.50743, 18.34658, 25.57006, 33.50286, 41.02474, 76.36258, 78.16154, 76.14616, 77.54447, 76.55948, 73.88788,
   ...
   Graph_Graph2199->SetMinimum(2.965129);
   Graph_Graph2199->SetMaximum(1041.49);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy200[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   38.04265, 38.21704, 38.21704 };
   ...
   Double_t Graph_fx201[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy201[20] = { 1.058004e-14, 4.32141e-10, 2.354062e-07, 1.498628e-05, 0.0002816692, 0.002480039, 0.01320793, 146.1345, 250.309, 291.1099, 287.1568, 197.3899, 139.841, 104.6663, 81.99951, 66.51031, 55.39928,
   47.11386, 40.74005, 40.74005 };
   graph = new TGraph(20,Graph_fx201,Graph_fy201);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph201 = new TH1F("Graph_Graph201","",100,2.7,1099.7);
   Graph_Graph201->SetMinimum(9.522036e-15);
   Graph_Graph201->SetMaximum(320.2209);
   ...
   Double_t Graph_fx203[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy203[20] = { 1.163804e-14, 4.753551e-10, 2.589468e-07, 1.648491e-05, 0.0003098361, 0.002728043, 0.01452872, 160.748, 275.3399, 320.2209, 315.8725, 217.1289, 153.8251, 115.1329, 90.19946, 73.16134, 60.93921,
   51.82525, 44.81406, 44.81406 };
   graph = new TGraph(20,Graph_fx203,Graph_fy203);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph203 = new TH1F("Graph_Graph203","",100,2.7,1099.7);
   Graph_Graph203->SetMinimum(1.047424e-14);
   Graph_Graph203->SetMaximum(352.243);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(30.25811,0,30.25811,7.833094);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(30.25311,0,"  30.26 TeV");
