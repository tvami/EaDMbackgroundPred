...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_17mnthNorm_rate_Vol_6.4e-08()
{
...
//=========  (Fri Jun 12 12:26:04 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy169[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy170[42] = { 1457.687, 27.47935, 26.15284, 19.24384, 17.92632, 17.38699, 16.73084, 27.68956, 38.5269, 50.43768, 61.74458, 114.93, 117.6376, 114.6043, 116.7088, 115.2264, 111.2055,
   ...
   Graph_Graph1170->SetMinimum(1.945848);
   Graph_Graph1170->SetMaximum(1603.239);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy171[42] = { 947.109, 16.94284, 16.24654, 11.94261, 11.21071, 10.94063, 10.50743, 18.34658, 25.57006, 33.50286, 41.02474, 76.36258, 78.16154, 76.14616, 77.54447, 76.55948, 73.88788,
   ...
   Graph_Graph2171->SetMinimum(2.965129);
   Graph_Graph2171->SetMaximum(1041.49);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy172[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   38.04265, 38.21704, 38.21704 };
   ...
   Double_t Graph_fx173[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy173[20] = { 0.001181874, 0.05138484, 0.4605775, 1.896833, 5.042919, 10.24134, 17.42825, 163.3811, 141.136, 116.5667, 93.63766, 42.68585, 26.37157, 18.43231, 13.85948, 10.93788, 8.93417,
   7.487354, 6.400979, 6.400979 };
   graph = new TGraph(20,Graph_fx173,Graph_fy173);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph173 = new TH1F("Graph_Graph173","",100,2.7,1099.7);
   Graph_Graph173->SetMinimum(0.001063687);
   ...
   Double_t Graph_fx175[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy175[20] = { 0.001300061, 0.05652332, 0.5066352, 2.086516, 5.547211, 11.26547, 19.17107, 179.7192, 155.2496, 128.2234, 103.0014, 46.95444, 29.00873, 20.27554, 15.24543, 12.03167, 9.827587,
   8.236089, 7.041077, 7.041077 };
   graph = new TGraph(20,Graph_fx175,Graph_fy175);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph175 = new TH1F("Graph_Graph175","",100,2.7,1099.7);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(7.290008,0,7.290008,6.193128);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(7.285008,0,"  7.29 TeV");
