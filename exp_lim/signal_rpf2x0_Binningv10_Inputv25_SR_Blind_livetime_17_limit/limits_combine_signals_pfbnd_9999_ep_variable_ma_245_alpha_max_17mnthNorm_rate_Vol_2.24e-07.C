...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_17mnthNorm_rate_Vol_2.24e-07()
{
...
//=========  (Fri Jun 12 12:26:05 2026) by ROOT version 6.30/07
   ...
   800, 900, 1000 };
   Double_t Graph0_fy281[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   ...
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph1_fy282[42] = { 1457.687, 27.47935, 26.15284, 19.24384, 17.92632, 17.38699, 16.73084, 27.68956, 38.5269, 50.43768, 61.74458, 114.93, 117.6376, 114.6043, 116.7088, 115.2264, 111.2055,
   ...
   Graph_Graph1282->SetMinimum(1.945848);
   Graph_Graph1282->SetMaximum(1603.239);
   ...
   800, 900, 1000, 1000, 1000, 1000, 900, 800, 700, 600, 500, 400, 300, 200, 100, 80,
   60, 40, 9, 8, 7, 6, 5, 4, 3 };
   Double_t Graph2_fy283[42] = { 947.109, 16.94284, 16.24654, 11.94261, 11.21071, 10.94063, 10.50743, 18.34658, 25.57006, 33.50286, 41.02474, 76.36258, 78.16154, 76.14616, 77.54447, 76.55948, 73.88788,
   ...
   Graph_Graph2283->SetMinimum(2.965129);
   Graph_Graph2283->SetMaximum(1041.49);
   ...
   800, 900, 1000 };
   Double_t Graph0_fy284[20] = { 589.2099, 10.5092, 9.887071, 6.494073, 6.255495, 6.043055, 5.639588, 9.105873, 12.6698, 16.58672, 20.30507, 37.79541, 38.68581, 37.6883, 38.38039, 37.89287, 36.57057,
   38.04265, 38.21704, 38.21704 };
   ...
   Double_t Graph_fx285[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy285[20] = { 5.095216e-83, 5.380755e-61, 8.21414e-48, 4.824544e-39, 8.560815e-33, 4.059703e-28, 1.725686e-24, 0.01878653, 1.773475, 15.31204, 50.28886, 383.2045, 605.3286, 676.5332, 674.169, 641.9433, 599.6005,
   555.6728, 513.704, 513.704 };
   graph = new TGraph(20,Graph_fx285,Graph_fy285);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph285 = new TH1F("Graph_Graph285","",100,2.7,1099.7);
   Graph_Graph285->SetMinimum(4.585694e-83);
   Graph_Graph285->SetMaximum(744.1865);
   ...
   Double_t Graph_fx287[20] = { 3, 4, 5, 6, 7, 8, 9, 40, 60, 80, 100, 200, 300, 400, 500, 600, 700,
   800, 900, 1000 };
   Double_t Graph_fy287[20] = { 5.604738e-83, 5.918831e-61, 9.035554e-48, 5.306998e-39, 9.416897e-33, 4.465673e-28, 1.898255e-24, 0.02066518, 1.950823, 16.84324, 55.31775, 421.525, 665.8615, 744.1865, 741.5859, 706.1376, 659.5606,
   611.2401, 565.0744, 565.0744 };
   graph = new TGraph(20,Graph_fx287,Graph_fy287);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph287 = new TH1F("Graph_Graph287","",100,2.7,1099.7);
   Graph_Graph287->SetMinimum(5.044264e-83);
   Graph_Graph287->SetMaximum(818.6052);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(81.62053,0,81.62053,16.8608);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(81.61553,0,"  81.62 TeV");
