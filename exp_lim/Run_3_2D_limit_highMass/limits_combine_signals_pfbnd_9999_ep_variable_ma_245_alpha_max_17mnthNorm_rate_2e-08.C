...
//=========  (Thu Jan 15 02:00:51 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx113[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy113[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx113,Graph0_fy113);
   ...
   TH1F *Graph_Graph0113 = new TH1F("Graph_Graph0113","",100,0,104.34);
   ...
   Graph_Graph0113->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx114[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy114[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx114,Graph1_fy114);
   ...
   TH1F *Graph_Graph1114 = new TH1F("Graph_Graph1114","Graph",100,0,104.34);
   Graph_Graph1114->SetMinimum(0.797055);
   Graph_Graph1114->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx115[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy115[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx115,Graph2_fy115);
   ...
   TH1F *Graph_Graph2115 = new TH1F("Graph_Graph2115","Graph",100,0,104.34);
   Graph_Graph2115->SetMinimum(1.166561);
   Graph_Graph2115->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx116[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy116[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx116,Graph0_fy116);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0116 = new TH1F("Graph_Graph0116","",100,0,104.34);
   ...
   Graph_Graph0116->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx117[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy117[43] = { 22.54514, 26.86754, 30.44126, 33.29278, 37.14214, 38.31966, 39.11063, 39.5862, 39.8067, 39.82244, 39.67496, 39.39833, 39.02036, 38.56371, 38.04678, 37.48452, 36.88902,
   35.63563, 34.99205, 34.34446, 33.69698, 31.78474, 30.5547, 28.79889, 27.69352, 26.13573, 25.16297, 23.79826, 11.18085, 8.609995, 6.903931, 5.703632, 4.820878,
   4.148799, 3.622748, 3.20157, 2.857947, 2.333748, 2.130234, 1.955406, 1.803852, 1.671414, 1.554845 };
   graph = new TGraph(43,Graph_fx117,Graph_fy117);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph117 = new TH1F("Graph_Graph117","",100,0,104.34);
   Graph_Graph117->SetMinimum(1.399361);
   Graph_Graph117->SetMaximum(43.6492);
   ...
   Double_t Graph_fx119[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy119[43] = { 24.79965, 29.55429, 33.48538, 36.62206, 40.85636, 42.15163, 43.0217, 43.54482, 43.78737, 43.80469, 43.64246, 43.33817, 42.9224, 42.42008, 41.85146, 41.23297, 40.57792,
   39.1992, 38.49125, 37.77891, 37.06668, 34.96321, 33.61017, 31.67878, 30.46287, 28.7493, 27.67927, 26.17808, 12.29894, 9.470995, 7.594324, 6.273996, 5.302966,
   4.563679, 3.985023, 3.521727, 3.143742, 2.567122, 2.343257, 2.150946, 1.984238, 1.838556, 1.71033 };
   graph = new TGraph(43,Graph_fx119,Graph_fy119);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph119 = new TH1F("Graph_Graph119","",100,0,104.34);
   Graph_Graph119->SetMinimum(1.539297);
   Graph_Graph119->SetMaximum(48.01412);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(33.74161,0,33.74161,5.984487);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(33.73661,0,"  33.74 TeV");
