...
//=========  (Thu Jan 15 02:00:50 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx29[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy29[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx29,Graph0_fy29);
   ...
   TH1F *Graph_Graph029 = new TH1F("Graph_Graph029","",100,0,104.34);
   ...
   Graph_Graph029->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx30[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy30[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx30,Graph1_fy30);
   ...
   TH1F *Graph_Graph130 = new TH1F("Graph_Graph130","Graph",100,0,104.34);
   Graph_Graph130->SetMinimum(0.797055);
   Graph_Graph130->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx31[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy31[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx31,Graph2_fy31);
   ...
   TH1F *Graph_Graph231 = new TH1F("Graph_Graph231","Graph",100,0,104.34);
   Graph_Graph231->SetMinimum(1.166561);
   Graph_Graph231->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx32[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy32[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx32,Graph0_fy32);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph032 = new TH1F("Graph_Graph032","",100,0,104.34);
   ...
   Graph_Graph032->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx33[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy33[43] = { 7.51832, 6.73637, 6.07526, 5.512822, 4.614821, 4.253106, 3.936495, 3.657613, 3.410524, 3.190413, 2.993352, 2.816106, 2.655997, 2.510792, 2.378615, 2.257882, 2.147247,
   ...
   0.1163592, 0.1006822, 0.08831497, 0.07834709, 0.06335423, 0.05760368, 0.05269549, 0.04846475, 0.0447861, 0.04156264 };
   graph = new TGraph(43,Graph_fx33,Graph_fy33);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph33 = new TH1F("Graph_Graph33","",100,0,104.34);
   Graph_Graph33->SetMinimum(0.03740638);
   Graph_Graph33->SetMaximum(8.265995);
   ...
   Double_t Graph_fx35[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy35[43] = { 8.270152, 7.410007, 6.682786, 6.064104, 5.076303, 4.678416, 4.330144, 4.023374, 3.751576, 3.509454, 3.292687, 3.097716, 2.921597, 2.761871, 2.616476, 2.48367, 2.361972,
   ...
   0.1279951, 0.1107504, 0.09714647, 0.0861818, 0.06968965, 0.06336405, 0.05796503, 0.05331122, 0.04926471, 0.04571891 };
   graph = new TGraph(43,Graph_fx35,Graph_fy35);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph35 = new TH1F("Graph_Graph35","",100,0,104.34);
   Graph_Graph35->SetMinimum(0.04114702);
   Graph_Graph35->SetMaximum(9.092595);
