...
//=========  (Thu Jan 15 02:00:50 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx50[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy50[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx50,Graph0_fy50);
   ...
   TH1F *Graph_Graph050 = new TH1F("Graph_Graph050","",100,0,104.34);
   ...
   Graph_Graph050->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx51[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy51[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx51,Graph1_fy51);
   ...
   TH1F *Graph_Graph151 = new TH1F("Graph_Graph151","Graph",100,0,104.34);
   Graph_Graph151->SetMinimum(0.797055);
   Graph_Graph151->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx52[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy52[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx52,Graph2_fy52);
   ...
   TH1F *Graph_Graph252 = new TH1F("Graph_Graph252","Graph",100,0,104.34);
   Graph_Graph252->SetMinimum(1.166561);
   Graph_Graph252->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx53[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy53[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx53,Graph0_fy53);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph053 = new TH1F("Graph_Graph053","",100,0,104.34);
   ...
   Graph_Graph053->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx54[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy54[43] = { 17.38637, 16.35038, 15.32772, 14.35625, 12.61777, 11.85351, 11.15463, 10.51592, 9.931915, 9.397303, 8.907133, 8.456891, 8.042512, 7.660369, 7.307236, 6.980252, 6.67688,
   ...
   0.4095313, 0.3549044, 0.3117047, 0.2768155, 0.2242145, 0.2039982, 0.1867247, 0.1718212, 0.1588517, 0.1474785 };
   graph = new TGraph(43,Graph_fx54,Graph_fy54);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph54 = new TH1F("Graph_Graph54","",100,0,104.34);
   Graph_Graph54->SetMinimum(0.1327307);
   Graph_Graph54->SetMaximum(19.11026);
   ...
   Double_t Graph_fx56[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy56[43] = { 19.12501, 17.98541, 16.86049, 15.79188, 13.87955, 13.03886, 12.27009, 11.56751, 10.92511, 10.33703, 9.797847, 9.30258, 8.846763, 8.426406, 8.03796, 7.678277, 7.344567,
   ...
   0.4504845, 0.3903949, 0.3428752, 0.304497, 0.2466359, 0.2243981, 0.2053972, 0.1890033, 0.1747369, 0.1622264 };
   graph = new TGraph(43,Graph_fx56,Graph_fy56);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph56 = new TH1F("Graph_Graph56","",100,0,104.34);
   Graph_Graph56->SetMinimum(0.1460037);
   Graph_Graph56->SetMaximum(21.02129);
