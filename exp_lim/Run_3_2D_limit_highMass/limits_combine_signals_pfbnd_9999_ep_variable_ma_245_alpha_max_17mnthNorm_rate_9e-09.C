...
//=========  (Thu Jan 15 02:00:50 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx36[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy36[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx36,Graph0_fy36);
   ...
   TH1F *Graph_Graph036 = new TH1F("Graph_Graph036","",100,0,104.34);
   ...
   Graph_Graph036->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx37[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy37[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx37,Graph1_fy37);
   ...
   TH1F *Graph_Graph137 = new TH1F("Graph_Graph137","Graph",100,0,104.34);
   Graph_Graph137->SetMinimum(0.797055);
   Graph_Graph137->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx38[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy38[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx38,Graph2_fy38);
   ...
   TH1F *Graph_Graph238 = new TH1F("Graph_Graph238","Graph",100,0,104.34);
   Graph_Graph238->SetMinimum(1.166561);
   Graph_Graph238->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx39[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy39[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx39,Graph0_fy39);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph039 = new TH1F("Graph_Graph039","",100,0,104.34);
   ...
   Graph_Graph039->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx40[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy40[43] = { 10.57611, 9.61387, 8.771038, 8.034563, 6.824239, 6.325354, 5.883518, 5.490417, 5.139106, 4.823787, 4.539608, 4.282497, 4.049022, 3.836277, 3.641792, 3.463455, 3.299457,
   ...
   0.1855262, 0.1606045, 0.14093, 0.125063, 0.1011804, 0.09201466, 0.08418901, 0.0774416, 0.07157322, 0.06642985 };
   graph = new TGraph(43,Graph_fx40,Graph_fy40);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph40 = new TH1F("Graph_Graph40","",100,0,104.34);
   Graph_Graph40->SetMinimum(0.05978686);
   Graph_Graph40->SetMaximum(11.62708);
   ...
   Double_t Graph_fx42[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy42[43] = { 11.63372, 10.57526, 9.648142, 8.83802, 7.506663, 6.957889, 6.47187, 6.039459, 5.653017, 5.306166, 4.993569, 4.710747, 4.453924, 4.219905, 4.005971, 3.809801, 3.629403,
   ...
   0.2040788, 0.1766649, 0.155023, 0.1375693, 0.1112985, 0.1012161, 0.09260791, 0.08518576, 0.07873054, 0.07307283 };
   graph = new TGraph(43,Graph_fx42,Graph_fy42);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph42 = new TH1F("Graph_Graph42","",100,0,104.34);
   Graph_Graph42->SetMinimum(0.06576555);
   Graph_Graph42->SetMaximum(12.78978);
