...
//=========  (Thu Jan 15 02:00:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx302[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy302[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx302,Graph0_fy302);
   ...
   TH1F *Graph_Graph0302 = new TH1F("Graph_Graph0302","",100,0,104.34);
   ...
   Graph_Graph0302->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx303[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy303[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx303,Graph1_fy303);
   ...
   TH1F *Graph_Graph1303 = new TH1F("Graph_Graph1303","Graph",100,0,104.34);
   Graph_Graph1303->SetMinimum(0.797055);
   Graph_Graph1303->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx304[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy304[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx304,Graph2_fy304);
   ...
   TH1F *Graph_Graph2304 = new TH1F("Graph_Graph2304","Graph",100,0,104.34);
   Graph_Graph2304->SetMinimum(1.166561);
   Graph_Graph2304->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx305[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy305[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx305,Graph0_fy305);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0305 = new TH1F("Graph_Graph0305","",100,0,104.34);
   ...
   Graph_Graph0305->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx306[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy306[43] = { 1.084726e-207, 5.603747e-184, 5.155871e-165, 1.669831e-149, 1.181607e-125, 2.734801e-116, 3.547404e-108, 4.428512e-101, 8.044919e-95, 2.933184e-89, 2.766544e-84, 8.26966e-80, 9.233317e-76, 4.404871e-72, 1.00332e-68, 1.196906e-65, 8.082489e-63,
   8.611767e-58, 1.507717e-55, 1.845435e-53, 1.636812e-51, 2.217124e-46, 1.886253e-43, 1.22656e-39, 2.046379e-37, 1.795603e-34, 9.925908e-33, 2.168971e-30, 2.786417e-12, 5.436291e-09, 8.101187e-07, 2.79529e-05, 0.0003881673,
   0.002946425, 0.01468234, 0.05394858, 0.157902, 0.8332954, 1.60449, 2.830028, 4.645463, 7.184193, 10.56889 };
   graph = new TGraph(43,Graph_fx306,Graph_fy306);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph306 = new TH1F("Graph_Graph306","",100,0,104.34);
   Graph_Graph306->SetMinimum(9.762536e-208);
   Graph_Graph306->SetMaximum(11.62578);
   ...
   Double_t Graph_fx308[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy308[43] = { 1.193199e-207, 6.164122e-184, 5.671458e-165, 1.836814e-149, 1.299768e-125, 3.008281e-116, 3.902145e-108, 4.871363e-101, 8.849411e-95, 3.226502e-89, 3.043198e-84, 9.096626e-80, 1.015665e-75, 4.845358e-72, 1.103652e-68, 1.316597e-65, 8.890738e-63,
   9.472944e-58, 1.658489e-55, 2.029979e-53, 1.800493e-51, 2.438836e-46, 2.074879e-43, 1.349216e-39, 2.251017e-37, 1.975163e-34, 1.09185e-32, 2.385868e-30, 3.065058e-12, 5.97992e-09, 8.911305e-07, 3.07482e-05, 0.000426984,
   0.003241068, 0.01615058, 0.05934343, 0.1736922, 0.9166249, 1.764939, 3.113031, 5.110009, 7.902613, 11.62578 };
   graph = new TGraph(43,Graph_fx308,Graph_fy308);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph308 = new TH1F("Graph_Graph308","",100,0,104.34);
   Graph_Graph308->SetMinimum(1.073879e-207);
   Graph_Graph308->SetMaximum(12.78836);
