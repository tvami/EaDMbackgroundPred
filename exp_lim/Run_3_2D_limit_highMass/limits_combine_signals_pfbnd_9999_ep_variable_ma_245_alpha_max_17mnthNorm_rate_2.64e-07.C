...
//=========  (Thu Jan 15 02:00:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx309[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy309[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx309,Graph0_fy309);
   ...
   TH1F *Graph_Graph0309 = new TH1F("Graph_Graph0309","",100,0,104.34);
   ...
   Graph_Graph0309->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx310[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy310[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx310,Graph1_fy310);
   ...
   TH1F *Graph_Graph1310 = new TH1F("Graph_Graph1310","Graph",100,0,104.34);
   Graph_Graph1310->SetMinimum(0.797055);
   Graph_Graph1310->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx311[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy311[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx311,Graph2_fy311);
   ...
   TH1F *Graph_Graph2311 = new TH1F("Graph_Graph2311","Graph",100,0,104.34);
   Graph_Graph2311->SetMinimum(1.166561);
   Graph_Graph2311->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx312[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy312[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx312,Graph0_fy312);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0312 = new TH1F("Graph_Graph0312","",100,0,104.34);
   ...
   Graph_Graph0312->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx313[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy313[43] = { 8.231683e-225, 3.45384e-199, 1.07115e-178, 6.168465e-162, 3.655848e-136, 4.818472e-126, 2.822499e-117, 1.317886e-109, 7.667244e-103, 7.866616e-97, 1.872489e-91, 1.287654e-86, 3.055197e-82, 2.892168e-78, 1.231572e-74, 2.607151e-71, 2.984078e-68,
   ...
   0.0008419483, 0.004829414, 0.01991028, 0.06414316, 0.3935824, 0.8049397, 1.496694, 2.573897, 4.148713, 6.333537 };
   graph = new TGraph(43,Graph_fx313,Graph_fy313);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph313 = new TH1F("Graph_Graph313","",100,0,104.34);
   Graph_Graph313->SetMinimum(7.408515e-225);
   Graph_Graph313->SetMaximum(6.96689);
   ...
   Double_t Graph_fx315[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy315[43] = { 9.054851e-225, 3.799224e-199, 1.178265e-178, 6.785312e-162, 4.021433e-136, 5.300319e-126, 3.104749e-117, 1.449675e-109, 8.433968e-103, 8.653278e-97, 2.059738e-91, 1.41642e-86, 3.360716e-82, 3.181385e-78, 1.354729e-74, 2.867866e-71, 3.282485e-68,
   ...
   0.0009261431, 0.005312355, 0.02190131, 0.07055748, 0.4329407, 0.8854337, 1.646363, 2.831287, 4.563585, 6.96689 };
   graph = new TGraph(43,Graph_fx315,Graph_fy315);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph315 = new TH1F("Graph_Graph315","",100,0,104.34);
   Graph_Graph315->SetMinimum(8.149366e-225);
   Graph_Graph315->SetMaximum(7.663579);
