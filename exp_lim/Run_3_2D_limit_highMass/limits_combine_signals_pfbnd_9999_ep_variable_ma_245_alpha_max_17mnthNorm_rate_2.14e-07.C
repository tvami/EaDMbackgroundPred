...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_17mnthNorm_rate_2.14e-07()
{
...
//=========  (Thu Jan 15 02:00:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx274[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy274[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx274,Graph0_fy274);
   ...
   TH1F *Graph_Graph0274 = new TH1F("Graph_Graph0274","",100,0,104.34);
   ...
   Graph_Graph0274->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx275[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy275[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx275,Graph1_fy275);
   ...
   TH1F *Graph_Graph1275 = new TH1F("Graph_Graph1275","Graph",100,0,104.34);
   Graph_Graph1275->SetMinimum(0.797055);
   Graph_Graph1275->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx276[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy276[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx276,Graph2_fy276);
   ...
   TH1F *Graph_Graph2276 = new TH1F("Graph_Graph2276","Graph",100,0,104.34);
   Graph_Graph2276->SetMinimum(1.166561);
   Graph_Graph2276->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx277[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy277[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx277,Graph0_fy277);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0277 = new TH1F("Graph_Graph0277","",100,0,104.34);
   ...
   Graph_Graph0277->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx278[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy278[43] = { 7.070136e-146, 4.584392e-129, 1.270752e-115, 1.250871e-104, 9.941328e-88, 4.282615e-81, 2.390732e-75, 2.537962e-70, 6.869604e-66, 5.95541e-62, 1.979714e-58, 2.91431e-55, 2.134637e-52, 8.557961e-50, 2.031758e-47, 3.050152e-45, 3.05949e-43,
   1.098794e-39, 4.235221e-38, 1.266823e-36, 3.016287e-35, 1.275038e-31, 1.495925e-29, 7.365187e-27, 2.72692e-25, 3.25252e-23, 5.510536e-22, 2.457797e-20, 1.307113e-07, 2.586905e-05, 0.0008384945, 0.009730732, 0.05967779,
   0.2399035, 0.7189429, 1.742569, 3.605982, 11.03617, 17.08873, 24.90851, 34.55519, 46.01599, 59.21666 };
   graph = new TGraph(43,Graph_fx278,Graph_fy278);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph278 = new TH1F("Graph_Graph278","",100,0,104.34);
   Graph_Graph278->SetMinimum(6.363123e-146);
   Graph_Graph278->SetMaximum(65.13833);
   ...
   Double_t Graph_fx280[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy280[43] = { 7.77715e-146, 5.042832e-129, 1.397827e-115, 1.375958e-104, 1.093546e-87, 4.710876e-81, 2.629805e-75, 2.791759e-70, 7.556564e-66, 6.550951e-62, 2.177685e-58, 3.205741e-55, 2.3481e-52, 9.413758e-50, 2.234933e-47, 3.355167e-45, 3.365439e-43,
   1.208673e-39, 4.658744e-38, 1.393506e-36, 3.317916e-35, 1.402542e-31, 1.645517e-29, 8.101706e-27, 2.999613e-25, 3.577772e-23, 6.06159e-22, 2.703577e-20, 1.437825e-07, 2.845596e-05, 0.000922344, 0.01070381, 0.06564557,
   0.2638939, 0.7908372, 1.916826, 3.966581, 12.13979, 18.79761, 27.39936, 38.01071, 50.61758, 65.13833 };
   graph = new TGraph(43,Graph_fx280,Graph_fy280);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph280 = new TH1F("Graph_Graph280","",100,0,104.34);
   Graph_Graph280->SetMinimum(6.999435e-146);
   Graph_Graph280->SetMaximum(71.65216);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(68.21428,0,68.21428,9.03793);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(68.20928,0,"  68.21 TeV");
