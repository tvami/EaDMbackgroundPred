...
//=========  (Thu Jan 15 02:00:52 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx295[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy295[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx295,Graph0_fy295);
   ...
   TH1F *Graph_Graph0295 = new TH1F("Graph_Graph0295","",100,0,104.34);
   ...
   Graph_Graph0295->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx296[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy296[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx296,Graph1_fy296);
   ...
   TH1F *Graph_Graph1296 = new TH1F("Graph_Graph1296","Graph",100,0,104.34);
   Graph_Graph1296->SetMinimum(0.797055);
   Graph_Graph1296->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx297[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy297[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx297,Graph2_fy297);
   ...
   TH1F *Graph_Graph2297 = new TH1F("Graph_Graph2297","Graph",100,0,104.34);
   Graph_Graph2297->SetMinimum(1.166561);
   Graph_Graph2297->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx298[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy298[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx298,Graph0_fy298);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0298 = new TH1F("Graph_Graph0298","",100,0,104.34);
   ...
   Graph_Graph0298->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx299[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy299[43] = { 3.082271e-191, 2.323302e-169, 7.264238e-152, 1.478648e-137, 1.482184e-115, 6.442505e-107, 1.961462e-99, 6.888893e-93, 4.087267e-87, 5.51148e-82, 2.134794e-77, 2.864485e-73, 1.549482e-69, 3.825107e-66, 4.77432e-63, 3.281434e-60, 1.334251e-57,
   5.769265e-53, 6.75302e-51, 5.681794e-49, 3.551784e-47, 1.912812e-42, 9.606995e-40, 3.144206e-36, 3.51462e-34, 1.813612e-31, 7.31943e-30, 1.048017e-27, 4.97895e-11, 5.284707e-08, 5.248292e-06, 0.0001355202, 0.001514178,
   0.009705468, 0.04224416, 0.138958, 0.370881, 1.693167, 3.076518, 5.158008, 8.096197, 12.03236, 17.08212 };
   graph = new TGraph(43,Graph_fx299,Graph_fy299);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph299 = new TH1F("Graph_Graph299","",100,0,104.34);
   Graph_Graph299->SetMinimum(2.774044e-191);
   Graph_Graph299->SetMaximum(18.79033);
   ...
   Double_t Graph_fx301[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy301[43] = { 3.390498e-191, 2.555632e-169, 7.990662e-152, 1.626512e-137, 1.630402e-115, 7.086756e-107, 2.157608e-99, 7.577782e-93, 4.495994e-87, 6.062628e-82, 2.348273e-77, 3.150933e-73, 1.70443e-69, 4.207618e-66, 5.251752e-63, 3.609577e-60, 1.467676e-57,
   6.346191e-53, 7.428322e-51, 6.249973e-49, 3.906963e-47, 2.104093e-42, 1.05677e-39, 3.458627e-36, 3.866083e-34, 1.994973e-31, 8.051373e-30, 1.152818e-27, 5.476845e-11, 5.813178e-08, 5.773121e-06, 0.0001490723, 0.001665596,
   0.01067601, 0.04646858, 0.1528538, 0.407969, 1.862484, 3.38417, 5.673808, 8.905816, 13.23559, 18.79033 };
   graph = new TGraph(43,Graph_fx301,Graph_fy301);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph301 = new TH1F("Graph_Graph301","",100,0,104.34);
   Graph_Graph301->SetMinimum(3.051448e-191);
   Graph_Graph301->SetMaximum(20.66937);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(89.56041,0,89.56041,11.62044);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(89.55541,0,"  89.56 TeV");
