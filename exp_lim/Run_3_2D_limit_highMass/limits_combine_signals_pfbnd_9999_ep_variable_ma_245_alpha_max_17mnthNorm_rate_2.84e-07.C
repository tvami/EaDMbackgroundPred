...
//=========  (Thu Jan 15 02:00:53 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx323[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy323[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx323,Graph0_fy323);
   ...
   TH1F *Graph_Graph0323 = new TH1F("Graph_Graph0323","",100,0,104.34);
   ...
   Graph_Graph0323->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx324[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy324[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx324,Graph1_fy324);
   ...
   TH1F *Graph_Graph1324 = new TH1F("Graph_Graph1324","Graph",100,0,104.34);
   Graph_Graph1324->SetMinimum(0.797055);
   Graph_Graph1324->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx325[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy325[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx325,Graph2_fy325);
   ...
   TH1F *Graph_Graph2325 = new TH1F("Graph_Graph2325","Graph",100,0,104.34);
   Graph_Graph2325->SetMinimum(1.166561);
   Graph_Graph2325->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx326[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy326[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx326,Graph0_fy326);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0326 = new TH1F("Graph_Graph0326","",100,0,104.34);
   ...
   Graph_Graph0326->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx327[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy327[43] = { 4.761724e-261, 2.193222e-231, 1.161543e-207, 2.9516e-188, 2.049422e-158, 1.071508e-146, 1.524183e-136, 1.159936e-127, 7.920302e-120, 7.254351e-113, 1.224232e-106, 4.906974e-101, 5.737366e-96, 2.315191e-91, 3.704737e-87, 2.639289e-83, 9.225548e-80,
   ...
   5.743527e-05, 0.0004436946, 0.002333754, 0.009210532, 0.07775028, 0.1806518, 0.3755762, 0.7127516, 1.253975, 2.070366 };
   graph = new TGraph(43,Graph_fx327,Graph_fy327);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph327 = new TH1F("Graph_Graph327","",100,0,104.34);
   Graph_Graph327->SetMinimum(4.285552e-261);
   Graph_Graph327->SetMaximum(2.277402);
   ...
   Double_t Graph_fx329[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy329[43] = { 5.237896e-261, 2.412545e-231, 1.277697e-207, 3.24676e-188, 2.254364e-158, 1.178658e-146, 1.676601e-136, 1.275929e-127, 8.712332e-120, 7.979786e-113, 1.346655e-106, 5.397672e-101, 6.311103e-96, 2.54671e-91, 4.075211e-87, 2.903218e-83, 1.01481e-79,
   ...
   6.31788e-05, 0.000488064, 0.00256713, 0.01013158, 0.0855253, 0.198717, 0.4131339, 0.7840268, 1.379372, 2.277402 };
   graph = new TGraph(43,Graph_fx329,Graph_fy329);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph329 = new TH1F("Graph_Graph329","",100,0,104.34);
   Graph_Graph329->SetMinimum(4.714107e-261);
   Graph_Graph329->SetMaximum(2.505143);
