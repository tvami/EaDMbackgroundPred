...
//=========  (Thu Jan 15 02:00:50 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx57[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy57[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx57,Graph0_fy57);
   ...
   TH1F *Graph_Graph057 = new TH1F("Graph_Graph057","",100,0,104.34);
   ...
   Graph_Graph057->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx58[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy58[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx58,Graph1_fy58);
   ...
   TH1F *Graph_Graph158 = new TH1F("Graph_Graph158","Graph",100,0,104.34);
   Graph_Graph158->SetMinimum(0.797055);
   Graph_Graph158->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx59[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy59[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx59,Graph2_fy59);
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","Graph",100,0,104.34);
   Graph_Graph259->SetMinimum(1.166561);
   Graph_Graph259->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx60[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy60[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx60,Graph0_fy60);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph060 = new TH1F("Graph_Graph060","",100,0,104.34);
   ...
   Graph_Graph060->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx61[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy61[43] = { 20.65621, 19.80836, 18.86174, 17.8935, 16.03892, 15.18427, 14.38498, 13.64097, 12.95017, 12.30951, 11.71549, 11.16452, 10.65306, 10.1778, 9.735626, 9.32369, 8.939387,
   ...
   0.5764054, 0.4998316, 0.4392154, 0.3902201, 0.3162813, 0.287841, 0.2635298, 0.2425463, 0.2242794, 0.2082561 };
   graph = new TGraph(43,Graph_fx61,Graph_fy61);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph61 = new TH1F("Graph_Graph61","",100,0,104.34);
   Graph_Graph61->SetMinimum(0.1874305);
   Graph_Graph61->SetMaximum(22.701);
   ...
   Double_t Graph_fx63[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy63[43] = { 22.72183, 21.7892, 20.74791, 19.68285, 17.64281, 16.7027, 15.82348, 15.00506, 14.24518, 13.54046, 12.88704, 12.28097, 11.71837, 11.19558, 10.70919, 10.25606, 9.833326,
   ...
   0.6340459, 0.5498147, 0.483137, 0.4292421, 0.3479095, 0.3166251, 0.2898828, 0.2668009, 0.2467073, 0.2290817 };
   graph = new TGraph(43,Graph_fx63,Graph_fy63);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph63 = new TH1F("Graph_Graph63","",100,0,104.34);
   Graph_Graph63->SetMinimum(0.2061735);
   Graph_Graph63->SetMaximum(24.9711);
