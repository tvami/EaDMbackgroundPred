...
//=========  (Thu Jan 15 02:00:51 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx120[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy120[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   ...
   TGraph *graph = new TGraph(43,Graph0_fx120,Graph0_fy120);
   ...
   TH1F *Graph_Graph0120 = new TH1F("Graph_Graph0120","",100,0,104.34);
   ...
   Graph_Graph0120->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph1_fx121[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph1_fy121[88] = { 7.709086, 7.130503, 8.058682, 7.95608, 6.063009, 5.788526, 6.060239, 6.271909, 5.89441, 5.787513, 5.524848, 5.344154, 5.386081, 5.428398, 5.45907, 5.528099, 5.591407,
   ...
   graph = new TGraph(88,Graph1_fx121,Graph1_fy121);
   ...
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","Graph",100,0,104.34);
   Graph_Graph1121->SetMinimum(0.797055);
   Graph_Graph1121->SetMaximum(39.99833);
   ...
   Double_t Graph2_fx122[88] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95, 95, 95, 95, 90, 85, 80,
   75, 70, 60, 55, 50, 45, 40, 35, 30, 25, 20, 9.5, 9, 8.5, 8, 7.5,
   7, 6.5, 6, 5.8, 5.6, 5.4, 5, 4.8, 4.6, 4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2,
   3, 2.8, 2.6, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy122[88] = { 5.366147, 4.953583, 5.660692, 5.565008, 4.033861, 3.848309, 4.073111, 4.245635, 3.954828, 3.799287, 3.581651, 3.443301, 3.46112, 3.508569, 3.545823, 3.595827, 3.623111,
   ...
   graph = new TGraph(88,Graph2_fx122,Graph2_fy122);
   ...
   TH1F *Graph_Graph2122 = new TH1F("Graph_Graph2122","Graph",100,0,104.34);
   Graph_Graph2122->SetMinimum(1.166561);
   Graph_Graph2122->SetMaximum(24.29831);
   ...
   Double_t Graph0_fx123[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph0_fy123[43] = { 3.629883, 3.341797, 3.860352, 3.779688, 2.61582, 2.489063, 2.661914, 2.800195, 2.58125, 2.419922, 2.24707, 2.154883, 2.160645, 2.206738, 2.24707, 2.281641, 2.281641,
   2.17793, 2.108789, 2.120313, 2.085742, 2.091504, 2.062695, 2.091504, 2.07998, 2.108789, 2.131836, 2.126074, 5.047266, 5.416016, 5.761719, 6.061328, 6.591406,
   6.821875, 7.421094, 7.789844, 8.250781, 9.21875, 9.817969, 10.46328, 11.20078, 11.66172, 11.98438 };
   graph = new TGraph(43,Graph0_fx123,Graph0_fy123);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0123 = new TH1F("Graph_Graph0123","",100,0,104.34);
   ...
   Graph_Graph0123->GetXaxis()->SetRange(2,96);
   ...
   Double_t Graph_fx124[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy124[43] = { 20.03432, 24.72091, 28.79992, 32.22347, 37.23145, 38.94433, 40.22534, 41.1418, 41.75386, 42.11384, 42.26643, 42.24943, 42.09451, 41.82814, 41.47233, 41.04535, 40.56233,
   39.47615, 38.89191, 38.29013, 37.67663, 35.80944, 34.57334, 32.77131, 31.61755, 29.96973, 28.9291, 27.45553, 13.25407, 10.25779, 8.252745, 6.834236, 5.786846,
   4.987039, 4.359555, 3.856229, 3.444957, 2.816448, 2.572068, 2.361965, 2.179704, 2.020333, 1.87998 };
   graph = new TGraph(43,Graph_fx124,Graph_fy124);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,0,104.34);
   Graph_Graph124->SetMinimum(1.691982);
   Graph_Graph124->SetMaximum(46.30508);
   ...
   Double_t Graph_fx126[43] = { 1.6, 1.8, 2, 2.2, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8, 5,
   5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 20, 25, 30, 35, 40,
   45, 50, 55, 60, 70, 75, 80, 85, 90, 95 };
   Double_t Graph_fy126[43] = { 22.03775, 27.19301, 31.67992, 35.44582, 40.9546, 42.83877, 44.24788, 45.25598, 45.92925, 46.32522, 46.49308, 46.47437, 46.30396, 46.01095, 45.61956, 45.14988, 44.61856,
   43.42377, 42.7811, 42.11914, 41.44429, 39.39038, 38.03067, 36.04844, 34.77931, 32.9667, 31.82202, 30.20108, 14.57948, 11.28357, 9.078019, 7.517659, 6.365531,
   5.485743, 4.795511, 4.241852, 3.789452, 3.098092, 2.829274, 2.598161, 2.397674, 2.222366, 2.067978 };
   graph = new TGraph(43,Graph_fx126,Graph_fy126);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,0,104.34);
   Graph_Graph126->SetMinimum(1.86118);
   Graph_Graph126->SetMaximum(50.93559);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(37.39844,0,37.39844,6.310059);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(37.39344,0,"  37.40 TeV");
