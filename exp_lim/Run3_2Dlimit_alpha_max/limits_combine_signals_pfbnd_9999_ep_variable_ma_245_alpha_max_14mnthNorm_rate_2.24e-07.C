...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_2.24e-07()
{
...
//=========  (Thu Nov  6 16:28:39 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx281[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy281[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TGraph *graph = new TGraph(31,Graph0_fx281,Graph0_fy281);
   ...
   TH1F *Graph_Graph0281 = new TH1F("Graph_Graph0281","",100,0.76,10.84);
   ...
   Graph_Graph0281->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx282[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy282[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   graph = new TGraph(64,Graph1_fx282,Graph1_fy282);
   ...
   TH1F *Graph_Graph1282 = new TH1F("Graph_Graph1282","Graph",100,0.76,10.84);
   Graph_Graph1282->SetMinimum(0.4554363);
   Graph_Graph1282->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx283[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy283[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   graph = new TGraph(64,Graph2_fx283,Graph2_fy283);
   ...
   TH1F *Graph_Graph2283 = new TH1F("Graph_Graph2283","Graph",100,0.76,10.84);
   Graph_Graph2283->SetMinimum(1.377724);
   Graph_Graph2283->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx284[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy284[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   graph = new TGraph(31,Graph0_fx284,Graph0_fy284);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0284 = new TH1F("Graph_Graph0284","",100,0.76,10.84);
   ...
   Graph_Graph0284->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx285[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy285[31] = { 2.489989e-160, 6.649364e-142, 3.608629e-127, 4.049556e-115, 4.411199e-105, 1.360381e-96, 2.551051e-89, 5.095216e-83, 1.650197e-77, 1.195118e-72, 2.485004e-68, 1.807012e-64, 5.380755e-61, 7.454907e-58, 5.335005e-55, 2.149812e-52, 5.241637e-50,
   ...
   graph = new TGraph(31,Graph_fx285,Graph_fy285);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph285 = new TH1F("Graph_Graph285","",100,0.76,10.84);
   Graph_Graph285->SetMinimum(2.24099e-160);
   Graph_Graph285->SetMaximum(1.494197e-21);
   ...
   Double_t Graph_fx287[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy287[31] = { 2.738988e-160, 7.3143e-142, 3.969492e-127, 4.454511e-115, 4.852318e-105, 1.496419e-96, 2.806156e-89, 5.604738e-83, 1.815217e-77, 1.31463e-72, 2.733505e-68, 1.987713e-64, 5.91883e-61, 8.200398e-58, 5.868506e-55, 2.364793e-52, 5.765801e-50,
   ...
   graph = new TGraph(31,Graph_fx287,Graph_fy287);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph287 = new TH1F("Graph_Graph287","",100,0.76,10.84);
   Graph_Graph287->SetMinimum(2.465089e-160);
   Graph_Graph287->SetMaximum(1.643616e-21);
