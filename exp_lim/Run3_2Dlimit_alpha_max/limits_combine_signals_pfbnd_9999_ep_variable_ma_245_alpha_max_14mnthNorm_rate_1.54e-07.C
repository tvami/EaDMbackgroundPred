...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_1.54e-07()
{
...
//=========  (Thu Nov  6 16:28:39 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx232[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy232[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TGraph *graph = new TGraph(31,Graph0_fx232,Graph0_fy232);
   ...
   TH1F *Graph_Graph0232 = new TH1F("Graph_Graph0232","",100,0.76,10.84);
   ...
   Graph_Graph0232->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx233[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy233[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   graph = new TGraph(64,Graph1_fx233,Graph1_fy233);
   ...
   TH1F *Graph_Graph1233 = new TH1F("Graph_Graph1233","Graph",100,0.76,10.84);
   Graph_Graph1233->SetMinimum(0.4554363);
   Graph_Graph1233->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx234[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy234[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   graph = new TGraph(64,Graph2_fx234,Graph2_fy234);
   ...
   TH1F *Graph_Graph2234 = new TH1F("Graph_Graph2234","Graph",100,0.76,10.84);
   Graph_Graph2234->SetMinimum(1.377724);
   Graph_Graph2234->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx235[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy235[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   graph = new TGraph(31,Graph0_fx235,Graph0_fy235);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0235 = new TH1F("Graph_Graph0235","",100,0.76,10.84);
   ...
   Graph_Graph0235->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx236[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy236[31] = { 3.450929e-73, 1.621007e-64, 1.382163e-57, 6.393027e-52, 3.327289e-47, 3.228554e-43, 8.376251e-40, 7.56853e-37, 2.903776e-34, 5.504291e-32, 5.799426e-30, 3.727259e-28, 1.574002e-26, 4.638347e-25, 1.001928e-23, 1.65225e-22, 2.151716e-21,
   2.276729e-20, 2.00493e-19, 1.499833e-18, 9.699818e-18, 5.50591e-17, 2.779264e-16, 1.967785e-14, 2.231032e-13, 5.23351e-12, 3.28188e-11, 3.719086e-10, 1.561859e-09, 1.069037e-08, 3.380153e-08 };
   graph = new TGraph(31,Graph_fx236,Graph_fy236);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph236 = new TH1F("Graph_Graph236","",100,0.76,10.84);
   Graph_Graph236->SetMinimum(3.105836e-73);
   Graph_Graph236->SetMaximum(3.718169e-08);
   ...
   Double_t Graph_fx238[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy238[31] = { 3.796021e-73, 1.783108e-64, 1.520379e-57, 7.03233e-52, 3.660018e-47, 3.551409e-43, 9.213876e-40, 8.325383e-37, 3.194154e-34, 6.05472e-32, 6.379369e-30, 4.099985e-28, 1.731402e-26, 5.102182e-25, 1.102121e-23, 1.817475e-22, 2.366888e-21,
   2.504401e-20, 2.205423e-19, 1.649816e-18, 1.06698e-17, 6.056501e-17, 3.05719e-16, 2.164564e-14, 2.454135e-13, 5.756861e-12, 3.610068e-11, 4.090995e-10, 1.718045e-09, 1.175941e-08, 3.718169e-08 };
   graph = new TGraph(31,Graph_fx238,Graph_fy238);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph238 = new TH1F("Graph_Graph238","",100,0.76,10.84);
   Graph_Graph238->SetMinimum(3.416419e-73);
   Graph_Graph238->SetMaximum(4.089985e-08);
