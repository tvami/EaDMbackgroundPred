...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_2.74e-07()
{
...
//=========  (Thu Nov  6 16:28:39 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx316[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy316[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TGraph *graph = new TGraph(31,Graph0_fx316,Graph0_fy316);
   ...
   TH1F *Graph_Graph0316 = new TH1F("Graph_Graph0316","",100,0.76,10.84);
   ...
   Graph_Graph0316->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx317[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy317[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   graph = new TGraph(64,Graph1_fx317,Graph1_fy317);
   ...
   TH1F *Graph_Graph1317 = new TH1F("Graph_Graph1317","Graph",100,0.76,10.84);
   Graph_Graph1317->SetMinimum(0.4554363);
   Graph_Graph1317->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx318[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy318[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   graph = new TGraph(64,Graph2_fx318,Graph2_fy318);
   ...
   TH1F *Graph_Graph2318 = new TH1F("Graph_Graph2318","Graph",100,0.76,10.84);
   Graph_Graph2318->SetMinimum(1.377724);
   Graph_Graph2318->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx319[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy319[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   graph = new TGraph(31,Graph0_fx319,Graph0_fy319);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0319 = new TH1F("Graph_Graph0319","",100,0.76,10.84);
   ...
   Graph_Graph0319->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx320[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy320[31] = { 1.34765e-242, 5.442234e-215, 6.516807e-193, 7.457258e-175, 8.256481e-160, 4.391855e-147, 3.525382e-136, 9.884384e-127, 1.816395e-118, 3.539862e-111, 1.063689e-104, 6.622191e-99, 1.081886e-93, 5.616052e-89, 1.083216e-84, 8.834313e-81, 3.392987e-77,
   6.717889e-74, 7.402294e-71, 4.845033e-68, 1.992007e-65, 5.398412e-63, 1.005424e-60, 9.627922e-55, 2.504434e-51, 6.983175e-47, 2.723738e-44, 7.366884e-41, 7.935222e-39, 4.249593e-36, 1.838034e-34 };
   graph = new TGraph(31,Graph_fx320,Graph_fy320);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph320 = new TH1F("Graph_Graph320","",100,0.76,10.84);
   Graph_Graph320->SetMinimum(1.212885e-242);
   Graph_Graph320->SetMaximum(2.021837e-34);
   ...
   Double_t Graph_fx322[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy322[31] = { 1.482415e-242, 5.986458e-215, 7.168488e-193, 8.202983e-175, 9.082129e-160, 4.83104e-147, 3.877921e-136, 1.087282e-126, 1.998035e-118, 3.893848e-111, 1.170058e-104, 7.284411e-99, 1.190075e-93, 6.177657e-89, 1.191538e-84, 9.717745e-81, 3.732286e-77,
   7.389678e-74, 8.142523e-71, 5.329536e-68, 2.191207e-65, 5.938253e-63, 1.105966e-60, 1.059071e-54, 2.754878e-51, 7.681493e-47, 2.996112e-44, 8.103572e-41, 8.728744e-39, 4.674553e-36, 2.021837e-34 };
   graph = new TGraph(31,Graph_fx322,Graph_fy322);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph322 = new TH1F("Graph_Graph322","",100,0.76,10.84);
   Graph_Graph322->SetMinimum(1.334173e-242);
   Graph_Graph322->SetMaximum(2.224021e-34);
