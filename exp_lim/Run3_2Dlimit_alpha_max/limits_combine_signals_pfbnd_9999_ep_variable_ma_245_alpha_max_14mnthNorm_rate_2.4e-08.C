...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_2.4e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx141[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy141[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph0141 = new TH1F("Graph_Graph0141","",100,0.76,10.84);
   ...
   Graph_Graph0141->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx142[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy142[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph1142 = new TH1F("Graph_Graph1142","Graph",100,0.76,10.84);
   Graph_Graph1142->SetMinimum(0.4554363);
   Graph_Graph1142->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx143[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy143[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph2143 = new TH1F("Graph_Graph2143","Graph",100,0.76,10.84);
   Graph_Graph2143->SetMinimum(1.377724);
   Graph_Graph2143->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx144[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy144[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph0144 = new TH1F("Graph_Graph0144","",100,0.76,10.84);
   ...
   Graph_Graph0144->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx145[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy145[31] = { 12.18486, 16.86085, 21.52889, 25.96443, 30.03337, 33.66926, 36.85163, 39.58912, 41.90734, 43.84072, 45.42723, 46.70514, 47.71114, 48.4793, 49.04058, 49.42279, 49.65059,
   ...
   TH1F *Graph_Graph145 = new TH1F("Graph_Graph145","",100,0.76,10.84);
   Graph_Graph145->SetMinimum(8.428771);
   Graph_Graph145->SetMaximum(53.5018);
   ...
   Double_t Graph_fx147[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy147[31] = { 13.40334, 18.54694, 23.68178, 28.56087, 33.03671, 37.03618, 40.53679, 43.54803, 46.09807, 48.22479, 49.96995, 51.37566, 52.48226, 53.32723, 53.94464, 54.36507, 54.61565,
   ...
   TH1F *Graph_Graph147 = new TH1F("Graph_Graph147","",100,0.76,10.84);
   Graph_Graph147->SetMinimum(9.271648);
   Graph_Graph147->SetMaximum(58.85198);
