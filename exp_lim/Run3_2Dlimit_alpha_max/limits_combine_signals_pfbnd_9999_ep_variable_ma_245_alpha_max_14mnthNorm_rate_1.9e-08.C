...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_1.9e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx106[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy106[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph0106 = new TH1F("Graph_Graph0106","",100,0.76,10.84);
   ...
   Graph_Graph0106->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx107[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy107[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph1107 = new TH1F("Graph_Graph1107","Graph",100,0.76,10.84);
   Graph_Graph1107->SetMinimum(0.4554363);
   Graph_Graph1107->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx108[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy108[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph2108 = new TH1F("Graph_Graph2108","Graph",100,0.76,10.84);
   Graph_Graph2108->SetMinimum(1.377724);
   Graph_Graph2108->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx109[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy109[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph0109 = new TH1F("Graph_Graph0109","",100,0.76,10.84);
   ...
   Graph_Graph0109->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx110[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy110[31] = { 24.737, 28.51965, 31.46855, 33.67855, 35.26509, 36.34059, 37.00486, 37.34242, 37.42296, 37.30307, 37.02826, 36.6349, 36.15198, 35.60253, 35.00481, 34.37328, 33.71938,
   33.05213, 32.37861, 31.7044, 31.03381, 30.37019, 29.71611, 27.82804, 26.64094, 24.97538, 23.94156, 22.50108, 21.6103, 20.37071, 19.60409 };
   ...
   TH1F *Graph_Graph110 = new TH1F("Graph_Graph110","",100,0.76,10.84);
   Graph_Graph110->SetMinimum(17.8222);
   Graph_Graph110->SetMaximum(39.20484);
   ...
   Double_t Graph_fx112[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy112[31] = { 27.2107, 31.37161, 34.61541, 37.0464, 38.79159, 39.97465, 40.70535, 41.07666, 41.16525, 41.03338, 40.73108, 40.29839, 39.76718, 39.16278, 38.50529, 37.81061, 37.09132,
   36.35734, 35.61648, 34.87484, 34.13719, 33.40721, 32.68773, 30.61085, 29.30503, 27.47292, 26.33572, 24.75119, 23.77132, 22.40778, 21.56449 };
   ...
   TH1F *Graph_Graph112 = new TH1F("Graph_Graph112","",100,0.76,10.84);
   Graph_Graph112->SetMinimum(19.60442);
   Graph_Graph112->SetMaximum(43.12533);
