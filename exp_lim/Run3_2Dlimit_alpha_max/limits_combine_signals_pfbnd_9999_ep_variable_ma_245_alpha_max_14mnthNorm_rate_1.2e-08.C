...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_1.2e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx57[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy57[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph057 = new TH1F("Graph_Graph057","",100,0.76,10.84);
   ...
   Graph_Graph057->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx58[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy58[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph158 = new TH1F("Graph_Graph158","Graph",100,0.76,10.84);
   Graph_Graph158->SetMinimum(0.4554363);
   Graph_Graph158->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx59[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy59[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph259 = new TH1F("Graph_Graph259","Graph",100,0.76,10.84);
   Graph_Graph259->SetMinimum(1.377724);
   Graph_Graph259->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx60[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy60[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph060 = new TH1F("Graph_Graph060","",100,0.76,10.84);
   ...
   Graph_Graph060->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx61[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy61[31] = { 20.65621, 19.80836, 18.86174, 17.8935, 16.94536, 16.03892, 15.18427, 14.38498, 13.64097, 12.95017, 12.30951, 11.71549, 11.16452, 10.65306, 10.1778, 9.735626, 9.32369,
   8.939387, 8.580353, 8.244444, 7.929722, 7.634435, 7.357, 6.618156, 6.191985, 5.633784, 5.307154, 4.873782, 4.617108, 4.27283, 4.06683 };
   ...
   TH1F *Graph_Graph61 = new TH1F("Graph_Graph61","",100,0.76,10.84);
   Graph_Graph61->SetMinimum(2.407893);
   Graph_Graph61->SetMaximum(22.31515);
   ...
   Double_t Graph_fx63[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy63[31] = { 22.72183, 21.7892, 20.74791, 19.68285, 18.6399, 17.64281, 16.7027, 15.82348, 15.00506, 14.24518, 13.54046, 12.88704, 12.28097, 11.71837, 11.19558, 10.70919, 10.25606,
   9.833326, 9.438388, 9.068889, 8.722695, 8.397879, 8.0927, 7.279972, 6.811183, 6.197163, 5.837869, 5.361161, 5.078819, 4.700113, 4.473513 };
   ...
   TH1F *Graph_Graph63 = new TH1F("Graph_Graph63","",100,0.76,10.84);
   Graph_Graph63->SetMinimum(2.648682);
   Graph_Graph63->SetMaximum(24.54666);
