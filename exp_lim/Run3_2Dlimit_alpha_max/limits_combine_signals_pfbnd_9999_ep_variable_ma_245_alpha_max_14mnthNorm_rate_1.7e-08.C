...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_1.7e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx92[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy92[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph092 = new TH1F("Graph_Graph092","",100,0.76,10.84);
   ...
   Graph_Graph092->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx93[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy93[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph193 = new TH1F("Graph_Graph193","Graph",100,0.76,10.84);
   Graph_Graph193->SetMinimum(0.4554363);
   Graph_Graph193->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx94[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy94[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph294 = new TH1F("Graph_Graph294","Graph",100,0.76,10.84);
   Graph_Graph294->SetMinimum(1.377724);
   Graph_Graph294->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx95[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy95[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph095 = new TH1F("Graph_Graph095","",100,0.76,10.84);
   ...
   Graph_Graph095->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx96[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy96[31] = { 27.48021, 29.80394, 31.31637, 32.20135, 32.61275, 32.67259, 32.47503, 32.09169, 31.57659, 30.9703, 30.30321, 29.59799, 28.87155, 28.1364, 27.40177, 26.67442, 25.95921,
   25.25957, 24.57789, 23.91572, 23.27401, 22.65322, 22.05351, 20.37873, 19.3613, 17.97159, 17.12822, 15.97459, 15.27255, 14.30879, 13.71989 };
   ...
   TH1F *Graph_Graph96 = new TH1F("Graph_Graph96","",100,0.76,10.84);
   Graph_Graph96->SetMinimum(11.82462);
   Graph_Graph96->SetMaximum(34.56786);
   ...
   Double_t Graph_fx98[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy98[31] = { 30.22823, 32.78433, 34.448, 35.42148, 35.87402, 35.93985, 35.72254, 35.30086, 34.73425, 34.06733, 33.33353, 32.55779, 31.7587, 30.95004, 30.14195, 29.34186, 28.55513,
   27.78553, 27.03568, 26.3073, 25.60141, 24.91855, 24.25886, 22.4166, 21.29743, 19.76875, 18.84104, 17.57204, 16.79981, 15.73966, 15.09188 };
   ...
   TH1F *Graph_Graph98 = new TH1F("Graph_Graph98","",100,0.76,10.84);
   Graph_Graph98->SetMinimum(13.00708);
   Graph_Graph98->SetMaximum(38.02464);
