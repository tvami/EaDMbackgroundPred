...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_1.4e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx71[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy71[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph071 = new TH1F("Graph_Graph071","",100,0.76,10.84);
   ...
   Graph_Graph071->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx72[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy72[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph172 = new TH1F("Graph_Graph172","Graph",100,0.76,10.84);
   Graph_Graph172->SetMinimum(0.4554363);
   Graph_Graph172->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx73[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy73[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph273 = new TH1F("Graph_Graph273","Graph",100,0.76,10.84);
   Graph_Graph273->SetMinimum(1.377724);
   Graph_Graph273->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx74[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy74[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph074 = new TH1F("Graph_Graph074","",100,0.76,10.84);
   ...
   Graph_Graph074->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx75[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy75[31] = { 25.72201, 25.77942, 25.42978, 24.83156, 24.08885, 23.26956, 22.41769, 21.5615, 20.71886, 19.9008, 19.11378, 18.36125, 17.64469, 16.96426, 16.31931, 15.70868, 15.13087,
   14.58426, 14.06712, 13.57775, 13.11445, 12.67561, 12.25968, 11.1352, 10.47565, 9.599855, 9.08118, 8.385986, 7.970484, 7.40879, 7.070302 };
   ...
   TH1F *Graph_Graph75 = new TH1F("Graph_Graph75","",100,0.76,10.84);
   Graph_Graph75->SetMinimum(5.19939);
   Graph_Graph75->SetMaximum(27.65033);
   ...
   Double_t Graph_fx77[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy77[31] = { 28.29421, 28.35736, 27.97276, 27.31471, 26.49774, 25.59652, 24.65946, 23.71765, 22.79075, 21.89088, 21.02516, 20.19738, 19.40915, 18.66068, 17.95124, 17.27954, 16.64396,
   16.04269, 15.47383, 14.93552, 14.42589, 13.94317, 13.48565, 12.24872, 11.52321, 10.55984, 9.989298, 9.224585, 8.767532, 8.149669, 7.777332 };
   ...
   TH1F *Graph_Graph77 = new TH1F("Graph_Graph77","",100,0.76,10.84);
   Graph_Graph77->SetMinimum(5.719329);
   Graph_Graph77->SetMaximum(30.41537);
