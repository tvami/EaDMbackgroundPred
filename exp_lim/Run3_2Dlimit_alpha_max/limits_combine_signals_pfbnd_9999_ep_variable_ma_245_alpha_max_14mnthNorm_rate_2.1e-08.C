...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_2.1e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx120[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy120[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph0120 = new TH1F("Graph_Graph0120","",100,0.76,10.84);
   ...
   Graph_Graph0120->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx121[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy121[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","Graph",100,0.76,10.84);
   Graph_Graph1121->SetMinimum(0.4554363);
   Graph_Graph1121->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx122[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy122[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph2122 = new TH1F("Graph_Graph2122","Graph",100,0.76,10.84);
   Graph_Graph2122->SetMinimum(1.377724);
   Graph_Graph2122->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx123[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy123[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph0123 = new TH1F("Graph_Graph0123","",100,0.76,10.84);
   ...
   Graph_Graph0123->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx124[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy124[31] = { 20.03432, 24.72091, 28.79992, 32.22347, 35.01474, 37.23145, 38.94433, 40.22534, 41.1418, 41.75386, 42.11384, 42.26643, 42.24943, 42.09451, 41.82814, 41.47233, 41.04535,
   40.56233, 40.03581, 39.47615, 38.89191, 38.29013, 37.67663, 35.80944, 34.57334, 32.77131, 31.61755, 29.96973, 28.9291, 27.45553, 26.53015 };
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,0.76,10.84);
   Graph_Graph124->SetMinimum(17.81111);
   Graph_Graph124->SetMaximum(44.48965);
   ...
   Double_t Graph_fx126[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy126[31] = { 22.03775, 27.19301, 31.67992, 35.44582, 38.51621, 40.9546, 42.83877, 44.24788, 45.25598, 45.92925, 46.32522, 46.49308, 46.47437, 46.30396, 46.01095, 45.61956, 45.14988,
   44.61856, 44.0394, 43.42377, 42.7811, 42.11914, 41.44429, 39.39038, 38.03067, 36.04844, 34.77931, 32.9667, 31.82202, 30.20108, 29.18317 };
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,0.76,10.84);
   Graph_Graph126->SetMinimum(19.59222);
   Graph_Graph126->SetMaximum(48.93861);
