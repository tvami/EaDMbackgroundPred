...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_7e-09()
{
...
//=========  (Thu Nov  6 16:28:37 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy22[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,0.76,10.84);
   ...
   Graph_Graph022->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx23[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy23[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,0.76,10.84);
   Graph_Graph123->SetMinimum(0.4554363);
   Graph_Graph123->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx24[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy24[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,0.76,10.84);
   Graph_Graph224->SetMinimum(1.377724);
   Graph_Graph224->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx25[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy25[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,0.76,10.84);
   ...
   Graph_Graph025->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx26[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy26[31] = { 4.94222, 4.372173, 3.903124, 3.512383, 3.183129, 2.902781, 2.661815, 2.452932, 2.270464, 2.109959, 1.967881, 1.841388, 1.728179, 1.626371, 1.534408, 1.451, 1.375065,
   1.305691, 1.242105, 1.183648, 1.129753, 1.079933, 1.033766, 0.9137289, 0.8463378, 0.7600221, 0.7105092, 0.6459159, 0.608238, 0.5583633, 0.5288785 };
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,0.76,10.84);
   Graph_Graph26->SetMinimum(0.08754434);
   Graph_Graph26->SetMaximum(5.383554);
   ...
   Double_t Graph_fx28[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy28[31] = { 5.436442, 4.80939, 4.293437, 3.863622, 3.501442, 3.193059, 2.927996, 2.698225, 2.49751, 2.320955, 2.164669, 2.025527, 1.900997, 1.789008, 1.687849, 1.5961, 1.512571,
   1.43626, 1.366315, 1.302012, 1.242728, 1.187927, 1.137143, 1.005102, 0.9309716, 0.8360243, 0.7815602, 0.7105075, 0.6690618, 0.6141996, 0.5817664 };
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,0.76,10.84);
   Graph_Graph28->SetMinimum(0.09629878);
   Graph_Graph28->SetMaximum(5.92191);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(1.720328,0,1.720328,4.590922);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(1.715328,0,"  1.72 TeV");
