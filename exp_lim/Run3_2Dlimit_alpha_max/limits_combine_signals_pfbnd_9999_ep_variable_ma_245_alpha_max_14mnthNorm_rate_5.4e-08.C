...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_5.4e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx162[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy162[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph0162 = new TH1F("Graph_Graph0162","",100,0.76,10.84);
   ...
   Graph_Graph0162->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx163[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy163[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph1163 = new TH1F("Graph_Graph1163","Graph",100,0.76,10.84);
   Graph_Graph1163->SetMinimum(0.4554363);
   Graph_Graph1163->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx164[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy164[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph2164 = new TH1F("Graph_Graph2164","Graph",100,0.76,10.84);
   Graph_Graph2164->SetMinimum(1.377724);
   Graph_Graph2164->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx165[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy165[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph0165 = new TH1F("Graph_Graph0165","",100,0.76,10.84);
   ...
   Graph_Graph0165->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx166[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy166[31] = { 5.377378e-06, 5.42368e-05, 0.0003392874, 0.001501682, 0.005132719, 0.01439228, 0.03456422, 0.07336967, 0.1409387, 0.2494423, 0.4124663, 0.6442442, 0.9588659, 1.369556, 1.888079, 2.524309, 3.285951,
   ...
   TH1F *Graph_Graph166 = new TH1F("Graph_Graph166","",100,0.76,10.84);
   Graph_Graph166->SetMinimum(4.83964e-06);
   Graph_Graph166->SetMaximum(61.93355);
   ...
   Double_t Graph_fx168[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy168[31] = { 5.915116e-06, 5.966048e-05, 0.0003732161, 0.00165185, 0.005645991, 0.01583151, 0.03802064, 0.08070664, 0.1550325, 0.2743865, 0.4537129, 0.7086686, 1.054753, 1.506511, 2.076887, 2.77674, 3.614546,
   ...
   TH1F *Graph_Graph168 = new TH1F("Graph_Graph168","",100,0.76,10.84);
   Graph_Graph168->SetMinimum(5.323604e-06);
   Graph_Graph168->SetMaximum(68.1269);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(4.779461,0,4.779461,3.198165);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(4.774461,0,"  4.78 TeV");
