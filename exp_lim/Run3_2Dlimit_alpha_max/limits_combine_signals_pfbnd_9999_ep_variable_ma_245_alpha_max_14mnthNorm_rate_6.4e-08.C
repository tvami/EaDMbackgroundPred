...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_6.4e-08()
{
...
//=========  (Thu Nov  6 16:28:38 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx169[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy169[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TH1F *Graph_Graph0169 = new TH1F("Graph_Graph0169","",100,0.76,10.84);
   ...
   Graph_Graph0169->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx170[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy170[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   TH1F *Graph_Graph1170 = new TH1F("Graph_Graph1170","Graph",100,0.76,10.84);
   Graph_Graph1170->SetMinimum(0.4554363);
   Graph_Graph1170->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx171[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy171[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   TH1F *Graph_Graph2171 = new TH1F("Graph_Graph2171","Graph",100,0.76,10.84);
   Graph_Graph2171->SetMinimum(1.377724);
   Graph_Graph2171->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx172[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy172[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   ...
   TH1F *Graph_Graph0172 = new TH1F("Graph_Graph0172","",100,0.76,10.84);
   ...
   Graph_Graph0172->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx173[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy173[31] = { 1.289871e-09, 3.542325e-08, 4.938296e-07, 4.210434e-06, 2.485304e-05, 0.000110647, 0.0003949408, 0.001181874, 0.003066128, 0.00707428, 0.01480669, 0.02855637, 0.05138484, 0.08714279, 0.1404323, 0.2165157, 0.3211807,
   0.4605775, 0.6410395, 0.8689028, 1.150335, 1.491182, 1.896833, 3.547677, 5.042919, 7.911683, 10.24134, 14.33264, 17.42825, 22.55765, 26.25736 };
   ...
   TH1F *Graph_Graph173 = new TH1F("Graph_Graph173","",100,0.76,10.84);
   Graph_Graph173->SetMinimum(1.160884e-09);
   Graph_Graph173->SetMaximum(28.88309);
   ...
   Double_t Graph_fx175[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy175[31] = { 1.418858e-09, 3.896558e-08, 5.432125e-07, 4.631478e-06, 2.733834e-05, 0.0001217117, 0.0004344348, 0.001300061, 0.003372741, 0.007781708, 0.01628736, 0.03141201, 0.05652332, 0.09585707, 0.1544756, 0.2381672, 0.3532988,
   0.5066353, 0.7051434, 0.9557931, 1.265369, 1.6403, 2.086516, 3.902445, 5.547211, 8.702851, 11.26547, 15.76591, 19.17108, 24.81342, 28.88309 };
   ...
   TH1F *Graph_Graph175 = new TH1F("Graph_Graph175","",100,0.76,10.84);
   Graph_Graph175->SetMinimum(1.276972e-09);
   Graph_Graph175->SetMaximum(31.7714);
