...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_14mnthNorm_rate_3.04e-07()
{
//=========Macro generated from canvas: climits/climits
//=========  (Thu Nov  6 16:28:40 2025) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx337[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy337[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   ...
   TGraph *graph = new TGraph(31,Graph0_fx337,Graph0_fy337);
   ...
   TH1F *Graph_Graph0337 = new TH1F("Graph_Graph0337","",100,0.76,10.84);
   ...
   Graph_Graph0337->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph1_fx338[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   ...
   Double_t Graph1_fy338[64] = { 9.981168, 9.272051, 10.55289, 10.5295, 8.999737, 7.890887, 7.541231, 7.944484, 8.272706, 7.989387, 7.610503, 7.223642, 6.994062, 7.04746, 7.155706, 7.232473, 7.360828,
   ...
   graph = new TGraph(64,Graph1_fx338,Graph1_fy338);
   ...
   TH1F *Graph_Graph1338 = new TH1F("Graph_Graph1338","Graph",100,0.76,10.84);
   Graph_Graph1338->SetMinimum(0.4554363);
   Graph_Graph1338->SetMaximum(11.47084);
   ...
   Double_t Graph2_fx339[64] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10, 10, 10,
   10, 9.5, 9, 8.5, 8, 7.5, 7, 6.5, 6, 5.8, 5.6, 5.4, 5.2, 5, 4.8, 4.6,
   4.4, 4.2, 4, 3.8, 3.6, 3.4, 3.2, 3, 2.8, 2.6, 2.4, 2.2, 2, 1.8, 1.6 };
   Double_t Graph2_fy339[64] = { 7.041793, 6.522612, 7.53601, 7.495786, 6.163175, 5.319945, 5.094251, 5.413108, 5.689595, 5.438096, 5.095623, 4.774285, 4.599689, 4.632096, 4.738912, 4.821813, 4.917635,
   ...
   graph = new TGraph(64,Graph2_fx339,Graph2_fy339);
   ...
   TH1F *Graph_Graph2339 = new TH1F("Graph_Graph2339","Graph",100,0.76,10.84);
   Graph_Graph2339->SetMinimum(1.377724);
   Graph_Graph2339->SetMaximum(8.095854);
   ...
   Double_t Graph0_fx340[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph0_fy340[31] = { 4.815293, 4.448145, 5.238926, 5.196563, 4.080996, 3.494971, 3.346699, 3.593818, 3.812695, 3.600879, 3.304336, 3.064277, 2.937188, 2.96543, 3.057217, 3.134883, 3.205488,
   3.23373, 3.106641, 3.064277, 2.958369, 2.979551, 2.937188, 3.007793, 2.993672, 3.043096, 3.028975, 3.09252, 3.156064, 3.247852, 3.403184 };
   graph = new TGraph(31,Graph0_fx340,Graph0_fy340);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph0340 = new TH1F("Graph_Graph0340","",100,0.76,10.84);
   ...
   Graph_Graph0340->GetXaxis()->SetRange(4,92);
   ...
   Double_t Graph_fx341[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy341[31] = { 5.984957e-300, 5.967745e-266, 9.291983e-239, 1.625057e-216, 5.519904e-198, 2.619354e-182, 7.106818e-169, 3.098503e-157, 4.711721e-147, 4.519629e-138, 4.335731e-130, 5.984818e-123, 1.590202e-116, 1.029364e-110, 1.968321e-105, 1.303667e-100, 3.41498e-96,
   3.954995e-92, 2.225247e-88, 6.591069e-85, 1.100944e-81, 1.100445e-78, 6.929325e-76, 1.646702e-68, 2.684025e-64, 8.171847e-59, 1.285416e-55, 2.207746e-51, 7.111313e-49, 1.659565e-45, 1.736018e-43 };
   graph = new TGraph(31,Graph_fx341,Graph_fy341);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph341 = new TH1F("Graph_Graph341","",100,0.76,10.84);
   Graph_Graph341->SetMinimum(5.386461e-300);
   Graph_Graph341->SetMaximum(1.909619e-43);
   ...
   Double_t Graph_fx343[31] = { 1.6, 1.8, 2, 2.2, 2.4, 2.6, 2.8, 3, 3.2, 3.4, 3.6, 3.8, 4, 4.2, 4.4, 4.6, 4.8,
   5, 5.2, 5.4, 5.6, 5.8, 6, 6.5, 7, 7.5, 8, 8.5, 9, 9.5, 10 };
   Double_t Graph_fy343[31] = { 6.583452e-300, 6.564519e-266, 1.022118e-238, 1.787563e-216, 6.071895e-198, 2.881289e-182, 7.8175e-169, 3.408353e-157, 5.182893e-147, 4.971592e-138, 4.769305e-130, 6.5833e-123, 1.749222e-116, 1.1323e-110, 2.165153e-105, 1.434034e-100, 3.756478e-96,
   4.350494e-92, 2.447772e-88, 7.250176e-85, 1.211038e-81, 1.21049e-78, 7.622257e-76, 1.811372e-68, 2.952428e-64, 8.989032e-59, 1.413958e-55, 2.42852e-51, 7.822444e-49, 1.825522e-45, 1.909619e-43 };
   graph = new TGraph(31,Graph_fx343,Graph_fy343);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph343 = new TH1F("Graph_Graph343","",100,0.76,10.84);
   Graph_Graph343->SetMinimum(5.925107e-300);
   Graph_Graph343->SetMaximum(2.100581e-43);
