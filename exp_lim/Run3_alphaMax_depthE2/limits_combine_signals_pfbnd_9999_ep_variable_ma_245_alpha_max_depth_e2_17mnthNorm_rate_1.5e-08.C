...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_1.5e-08()
{
...
//=========  (Wed Mar 11 02:50:57 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx78[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy78[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph1_fx79[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph1_fy79[36] = { 22.13127, 17.60809, 16.06013, 10.75758, 9.110659, 8.199594, 8.374799, 8.620086, 11.07296, 16.39919, 22.42624, 27.19182, 31.81723, 39.94674, 42.89018, 50.45904, 54.38363,
   ...
   Graph_Graph179->SetMinimum(0.6920274);
   Graph_Graph179->SetMaximum(59.7451);
   ...
   Double_t Graph2_fx80[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph2_fy80[36] = { 14.74078, 11.29431, 10.59756, 6.386179, 5.910078, 5.415805, 5.56444, 5.727415, 7.357167, 10.89606, 14.90059, 18.06697, 21.14021, 26.54168, 28.49738, 33.52633, 36.13394,
   ...
   Graph_Graph280->SetMinimum(1.234155);
   Graph_Graph280->SetMaximum(39.6102);
   ...
   Double_t Graph0_fx81[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy81[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph_fx82[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy82[17] = { 28.0685, 25.24726, 21.28035, 15.22907, 13.12323, 11.44857, 10.09792, 8.992814, 3.937052, 1.609151, 0.9370935, 0.6354695, 0.4692193, 0.3658513, 0.2962583, 0.2466767, 0.2098242 };
   ...
   Double_t Graph_fx84[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy84[17] = { 30.87536, 27.77199, 23.40838, 16.75197, 14.43555, 12.59342, 11.10771, 9.892095, 4.330757, 1.770066, 1.030803, 0.6990165, 0.5161412, 0.4024364, 0.3258841, 0.2713444, 0.2308066 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(21.21266,0,21.21266,3.729157);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(21.20766,0,"  21.21 TeV");
