...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_1.54e-07()
{
...
//=========  (Tue Feb  3 11:44:06 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx232[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy232[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   TGraph *graph = new TGraph(16,Graph0_fx232,Graph0_fy232);
   ...
   Double_t Graph1_fx233[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph1_fy233[34] = { 20.45958, 15.1478, 13.24202, 13.54486, 13.14658, 13.2636, 12.91702, 13.43259, 19.76311, 25.93033, 31.39673, 36.1623, 45.41312, 49.61804, 55.50492, 64.47542, 64.47542,
   ...
   4.738293 };
   graph = new TGraph(34,Graph1_fx233,Graph1_fy233);
   ...
   Graph_Graph1233->SetMinimum(1.780749);
   Graph_Graph1233->SetMaximum(70.7251);
   ...
   Double_t Graph2_fx234[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph2_fy234[34] = { 14.03206, 9.95691, 8.355768, 8.623442, 8.119161, 8.11935, 7.886832, 8.137666, 11.91361, 15.76729, 19.21467, 21.89417, 28.03077, 30.49613, 34.11431, 39.54322, 39.54322,
   ...
   6.487605 };
   graph = new TGraph(34,Graph2_fx234,Graph2_fy234);
   ...
   Graph_Graph2234->SetMinimum(2.619598);
   Graph_Graph2234->SetMaximum(43.20647);
   ...
   Double_t Graph0_fx235[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy235[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   graph = new TGraph(16,Graph0_fx235,Graph0_fy235);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx236[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy236[16] = { 1.382163e-57, 7.56853e-37, 1.574002e-26, 2.276729e-20, 2.779264e-16, 2.231032e-13, 3.28188e-11, 1.561859e-09, 13.63469, 86.90696, 194.9745, 295.1385, 371.3636, 423.278, 455.4373, 472.8877 };
   graph = new TGraph(16,Graph_fx236,Graph_fy236);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx238[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy238[16] = { 1.520379e-57, 8.325383e-37, 1.731402e-26, 2.504401e-20, 3.05719e-16, 2.454135e-13, 3.610068e-11, 1.718045e-09, 14.99816, 95.59766, 214.472, 324.6524, 408.4999, 465.6058, 500.9811, 520.1765 };
   graph = new TGraph(16,Graph_fx238,Graph_fy238);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(19.49151,0,19.49151,6.434647);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(19.48651,0,"  19.49 TeV");
