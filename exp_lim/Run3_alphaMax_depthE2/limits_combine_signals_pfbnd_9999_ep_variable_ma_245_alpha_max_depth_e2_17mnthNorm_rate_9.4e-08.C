...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_9.4e-08()
{
...
//=========  (Wed Mar 11 02:50:58 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx190[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy190[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph1_fx191[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph1_fy191[36] = { 22.13127, 17.60809, 16.06013, 10.75758, 9.110659, 8.199594, 8.374799, 8.620086, 11.07296, 16.39919, 22.42624, 27.19182, 31.81723, 39.94674, 42.89018, 50.45904, 54.38363,
   ...
   Graph_Graph1191->SetMinimum(0.6920274);
   Graph_Graph1191->SetMaximum(59.7451);
   ...
   Double_t Graph2_fx192[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph2_fy192[36] = { 14.74078, 11.29431, 10.59756, 6.386179, 5.910078, 5.415805, 5.56444, 5.727415, 7.357167, 10.89606, 14.90059, 18.06697, 21.14021, 26.54168, 28.49738, 33.52633, 36.13394,
   ...
   Graph_Graph2192->SetMinimum(1.234155);
   Graph_Graph2192->SetMaximum(39.6102);
   ...
   Double_t Graph0_fx193[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy193[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph_fx194[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy194[17] = { 6.021993e-19, 2.252217e-11, 1.224086e-07, 0.0005648644, 0.005966537, 0.03409894, 0.1297561, 0.3721489, 31.45248, 178.6125, 250.0586, 262.9211, 252.5746, 234.6968, 215.4238, 197.0456, 180.3182 };
   ...
   Double_t Graph_fx196[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy196[17] = { 6.624193e-19, 2.477438e-11, 1.346495e-07, 0.0006213509, 0.006563191, 0.03750884, 0.1427317, 0.4093638, 34.59773, 196.4737, 275.0644, 289.2132, 277.8321, 258.1665, 236.9661, 216.7501, 198.35 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(14.84989,0,14.84989,3.200816);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(14.84489,0,"  14.85 TeV");
