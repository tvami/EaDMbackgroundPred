...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_2.1e-08()
{
...
//=========  (Wed Mar 11 02:50:57 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx120[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy120[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   TH1F *Graph_Graph0120 = new TH1F("Graph_Graph0120","",100,0,197.8);
   ...
   Double_t Graph1_fx121[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph1_fy121[36] = { 22.13127, 17.60809, 16.06013, 10.75758, 9.110659, 8.199594, 8.374799, 8.620086, 11.07296, 16.39919, 22.42624, 27.19182, 31.81723, 39.94674, 42.89018, 50.45904, 54.38363,
   ...
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","Graph",100,0,197.8);
   Graph_Graph1121->SetMinimum(0.6920274);
   Graph_Graph1121->SetMaximum(59.7451);
   ...
   Double_t Graph2_fx122[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph2_fy122[36] = { 14.74078, 11.29431, 10.59756, 6.386179, 5.910078, 5.415805, 5.56444, 5.727415, 7.357167, 10.89606, 14.90059, 18.06697, 21.14021, 26.54168, 28.49738, 33.52633, 36.13394,
   ...
   TH1F *Graph_Graph2122 = new TH1F("Graph_Graph2122","Graph",100,0,197.8);
   Graph_Graph2122->SetMinimum(1.234155);
   Graph_Graph2122->SetMaximum(39.6102);
   ...
   Double_t Graph0_fx123[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy123[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   TH1F *Graph_Graph0123 = new TH1F("Graph_Graph0123","",100,0,197.8);
   ...
   Double_t Graph_fx124[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy124[17] = { 28.79992, 40.22534, 42.24943, 37.67663, 34.57334, 31.61755, 28.9291, 26.53015, 13.25407, 5.786846, 3.444957, 2.361965, 1.755582, 1.374868, 1.116843, 0.9321236, 0.7943233 };
   ...
   TH1F *Graph_Graph124 = new TH1F("Graph_Graph124","",100,0,197.8);
   ...
   Double_t Graph_fx126[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy126[17] = { 31.67992, 44.24788, 46.47437, 41.44429, 38.03067, 34.77931, 31.82202, 29.18317, 14.57948, 6.365531, 3.789452, 2.598161, 1.93114, 1.512355, 1.228527, 1.025336, 0.8737556 };
   ...
   TH1F *Graph_Graph126 = new TH1F("Graph_Graph126","",100,0,197.8);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(41.69516,0,41.69516,5.537955);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(41.69016,0,"  41.70 TeV");
