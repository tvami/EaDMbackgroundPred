...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_1.44e-07()
{
...
//=========  (Wed Mar 11 02:50:58 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx225[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy225[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   TGraph *graph = new TGraph(17,Graph0_fx225,Graph0_fy225);
   ...
   Double_t Graph1_fx226[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph1_fy226[36] = { 22.13127, 17.60809, 16.06013, 10.75758, 9.110659, 8.199594, 8.374799, 8.620086, 11.07296, 16.39919, 22.42624, 27.19182, 31.81723, 39.94674, 42.89018, 50.45904, 54.38363,
   ...
   graph = new TGraph(36,Graph1_fx226,Graph1_fy226);
   ...
   Graph_Graph1226->SetMinimum(0.6920274);
   Graph_Graph1226->SetMaximum(59.7451);
   ...
   Double_t Graph2_fx227[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph2_fy227[36] = { 14.74078, 11.29431, 10.59756, 6.386179, 5.910078, 5.415805, 5.56444, 5.727415, 7.357167, 10.89606, 14.90059, 18.06697, 21.14021, 26.54168, 28.49738, 33.52633, 36.13394,
   ...
   graph = new TGraph(36,Graph2_fx227,Graph2_fy227);
   ...
   Graph_Graph2227->SetMinimum(1.234155);
   Graph_Graph2227->SetMaximum(39.6102);
   ...
   Double_t Graph0_fx228[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy228[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   graph = new TGraph(17,Graph0_fx228,Graph0_fy228);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx229[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy229[17] = { 8.588033e-50, 1.085652e-31, 1.084817e-22, 9.203502e-14, 3.103587e-11, 2.382221e-09, 6.835649e-08, 9.869549e-07, 0.1202027, 25.91259, 121.9235, 235.0143, 324.7823, 384.5911, 419.7515, 437.1901, 442.6023 };
   graph = new TGraph(17,Graph_fx229,Graph_fy229);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx231[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy231[17] = { 9.446836e-50, 1.194217e-31, 1.193299e-22, 1.012385e-13, 3.413946e-11, 2.620443e-09, 7.519214e-08, 1.08565e-06, 0.132223, 28.50385, 134.1158, 258.5157, 357.2606, 423.0502, 461.7267, 480.9091, 486.8625 };
   graph = new TGraph(17,Graph_fx231,Graph_fy231);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(33.69699,0,33.69699,4.765146);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(33.69199,0,"  33.70 TeV");
