...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_7e-09()
{
...
//=========  (Tue Feb  3 11:44:05 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx22[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy22[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   TGraph *graph = new TGraph(16,Graph0_fx22,Graph0_fy22);
   ...
   TH1F *Graph_Graph022 = new TH1F("Graph_Graph022","",100,0,98.9);
   ...
   Graph_Graph022->GetXaxis()->SetRange(2,101);
   ...
   Double_t Graph1_fx23[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph1_fy23[34] = { 20.45958, 15.1478, 13.24202, 13.54486, 13.14658, 13.2636, 12.91702, 13.43259, 19.76311, 25.93033, 31.39673, 36.1623, 45.41312, 49.61804, 55.50492, 64.47542, 64.47542,
   ...
   4.738293 };
   graph = new TGraph(34,Graph1_fx23,Graph1_fy23);
   ...
   TH1F *Graph_Graph123 = new TH1F("Graph_Graph123","Graph",100,0,98.9);
   Graph_Graph123->SetMinimum(1.780749);
   Graph_Graph123->SetMaximum(70.7251);
   ...
   Double_t Graph2_fx24[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph2_fy24[34] = { 14.03206, 9.95691, 8.355768, 8.623442, 8.119161, 8.11935, 7.886832, 8.137666, 11.91361, 15.76729, 19.21467, 21.89417, 28.03077, 30.49613, 34.11431, 39.54322, 39.54322,
   ...
   6.487605 };
   graph = new TGraph(34,Graph2_fx24,Graph2_fy24);
   ...
   TH1F *Graph_Graph224 = new TH1F("Graph_Graph224","Graph",100,0,98.9);
   Graph_Graph224->SetMinimum(2.619598);
   Graph_Graph224->SetMaximum(43.20647);
   ...
   Double_t Graph0_fx25[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy25[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   graph = new TGraph(16,Graph0_fx25,Graph0_fy25);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   TH1F *Graph_Graph025 = new TH1F("Graph_Graph025","",100,0,98.9);
   ...
   Graph_Graph025->GetXaxis()->SetRange(2,101);
   ...
   Double_t Graph_fx26[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy26[16] = { 3.903124, 2.452932, 1.728179, 1.305691, 1.033766, 0.8463378, 0.7105092, 0.608238, 0.08053454, 0.04606619, 0.03096, 0.02273769, 0.01766517, 0.01426827, 0.01185755, 0.01007102 };
   graph = new TGraph(16,Graph_fx26,Graph_fy26);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph26 = new TH1F("Graph_Graph26","",100,0,98.9);
   ...
   Double_t Graph_fx28[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy28[16] = { 4.293437, 2.698225, 1.900997, 1.43626, 1.137143, 0.9309716, 0.7815602, 0.6690618, 0.088588, 0.05067281, 0.034056, 0.02501145, 0.01943169, 0.0156951, 0.0130433, 0.01107812 };
   graph = new TGraph(16,Graph_fx28,Graph_fy28);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   TH1F *Graph_Graph28 = new TH1F("Graph_Graph28","",100,0,98.9);
   ...
   pt->SetTextAlign(12);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("#varepsilon = 7e-09");
