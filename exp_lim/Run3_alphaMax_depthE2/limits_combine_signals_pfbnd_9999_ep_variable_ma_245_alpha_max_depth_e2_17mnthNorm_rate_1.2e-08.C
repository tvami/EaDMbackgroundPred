...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_1.2e-08()
{
...
//=========  (Wed Mar 11 02:50:57 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx57[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy57[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph1_fx58[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph1_fy58[36] = { 22.13127, 17.60809, 16.06013, 10.75758, 9.110659, 8.199594, 8.374799, 8.620086, 11.07296, 16.39919, 22.42624, 27.19182, 31.81723, 39.94674, 42.89018, 50.45904, 54.38363,
   ...
   Graph_Graph158->SetMinimum(0.6920274);
   Graph_Graph158->SetMaximum(59.7451);
   ...
   Double_t Graph2_fx59[36] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180,
   180, 180, 180, 160, 140, 120, 100, 80, 60, 40, 20, 10, 9, 8, 7, 6,
   4, 3, 2 };
   Double_t Graph2_fy59[36] = { 14.74078, 11.29431, 10.59756, 6.386179, 5.910078, 5.415805, 5.56444, 5.727415, 7.357167, 10.89606, 14.90059, 18.06697, 21.14021, 26.54168, 28.49738, 33.52633, 36.13394,
   ...
   Graph_Graph259->SetMinimum(1.234155);
   Graph_Graph259->SetMaximum(39.6102);
   ...
   Double_t Graph0_fx60[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph0_fy60[17] = { 9.633594, 7.121484, 7.063867, 3.537695, 2.996094, 2.696484, 2.754102, 2.834766, 3.641406, 5.392969, 7.375, 8.942188, 10.46328, 13.13672, 14.10469, 16.59375, 17.88438 };
   ...
   Double_t Graph_fx61[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy61[17] = { 18.86174, 14.38498, 11.16452, 7.357, 6.191985, 5.307154, 4.617108, 4.06683, 1.69446, 0.6756268, 0.3902201, 0.2635298, 0.1941046, 0.1510942, 0.1222086, 0.101666, 0.08641805 };
   ...
   Double_t Graph_fx63[17] = { 2, 3, 4, 6, 7, 8, 9, 10, 20, 40, 60, 80, 100, 120, 140, 160, 180 };
   Double_t Graph_fy63[17] = { 20.74791, 15.82348, 12.28097, 8.0927, 6.811183, 5.837869, 5.078819, 4.473513, 1.863906, 0.7431895, 0.4292421, 0.2898828, 0.2135151, 0.1662037, 0.1344295, 0.1118326, 0.09505985 };
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(13.20545,0,13.20545,3.071688);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(13.20045,0,"  13.21 TeV");
