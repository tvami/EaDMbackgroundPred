...
#endif
void limits_combine_signals_pfbnd_9999_ep_variable_ma_245_alpha_max_depth_e2_17mnthNorm_rate_2.94e-07()
{
...
//=========  (Tue Feb  3 11:44:06 2026) by ROOT version 6.30/07
   ...
   Double_t Graph0_fx330[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy330[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   TGraph *graph = new TGraph(16,Graph0_fx330,Graph0_fy330);
   ...
   Double_t Graph1_fx331[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph1_fy331[34] = { 20.45958, 15.1478, 13.24202, 13.54486, 13.14658, 13.2636, 12.91702, 13.43259, 19.76311, 25.93033, 31.39673, 36.1623, 45.41312, 49.61804, 55.50492, 64.47542, 64.47542,
   ...
   4.738293 };
   graph = new TGraph(34,Graph1_fx331,Graph1_fy331);
   ...
   Graph_Graph1331->SetMinimum(1.780749);
   Graph_Graph1331->SetMaximum(70.7251);
   ...
   Double_t Graph2_fx332[34] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90, 90,
   90, 90, 80, 70, 60, 50, 40, 30, 20, 4.5, 4, 3.5, 3, 2.5, 2, 1.5,
   1 };
   Double_t Graph2_fy332[34] = { 14.03206, 9.95691, 8.355768, 8.623442, 8.119161, 8.11935, 7.886832, 8.137666, 11.91361, 15.76729, 19.21467, 21.89417, 28.03077, 30.49613, 34.11431, 39.54322, 39.54322,
   ...
   6.487605 };
   graph = new TGraph(34,Graph2_fx332,Graph2_fy332);
   ...
   Graph_Graph2332->SetMinimum(2.619598);
   Graph_Graph2332->SetMaximum(43.20647);
   ...
   Double_t Graph0_fx333[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph0_fy333[16] = { 9.403125, 6.407031, 5.139453, 5.369922, 4.874414, 4.862891, 4.690039, 4.79375, 6.499219, 8.527344, 10.325, 11.89219, 14.93438, 16.31719, 18.25313, 21.20312 };
   graph = new TGraph(16,Graph0_fx333,Graph0_fy333);
   graph->SetName("Graph0");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineStyle(2);
   ...
   Double_t Graph_fx334[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy334[16] = { 6.067526e-223, 1.035276e-146, 1.201866e-108, 7.731227e-86, 1.184657e-70, 8.05064e-60, 1.045187e-51, 2.094995e-45, 8.588228e-07, 0.003258333, 0.1783447, 1.835325, 8.287489, 23.53058, 50.20223, 88.77198 };
   graph = new TGraph(16,Graph_fx334,Graph_fy334);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   ...
   Double_t Graph_fx336[16] = { 1, 1.5, 2, 2.5, 3, 3.5, 4, 4.5, 20, 30, 40, 50, 60, 70, 80, 90 };
   Double_t Graph_fy336[16] = { 6.674279e-223, 1.138804e-146, 1.322052e-108, 8.50435e-86, 1.303123e-70, 8.855704e-60, 1.149706e-51, 2.304495e-45, 9.447051e-07, 0.003584166, 0.1961792, 2.018858, 9.116238, 25.88363, 55.22245, 97.64918 };
   graph = new TGraph(16,Graph_fx336,Graph_fy336);
   graph->SetName("");
   graph->SetTitle("");
   graph->SetFillStyle(1000);
   graph->SetLineColor(4);
   ...
   line->SetNDC();
   line->Draw();
   line = new TLine(66.16668,0,66.16668,15.77259);

   ci = TColor::GetColor("#666666");
   line->SetLineColor(ci);
   line->SetLineStyle(2);
   line->Draw();
   TLatex *   tex = new TLatex(66.16168,0,"  66.17 TeV");
