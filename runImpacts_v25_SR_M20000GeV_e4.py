...
# Usage: python runImpacts_v25_SR_M20000GeV_e4.py <workingArea> [--regen]
# e.g.   python runImpacts_v25_SR_M20000GeV_e4.py rpfmult_Binningv10_Inputv25_SR_M20000GeV_e4 --regen
...
configJSON = "config_Binningv10_Inputv25_SR_M20000GeV_e4.json"  # same JSON as runWith1DVanilla_v25_SR_M20000GeV_e4.py
...
def regenerate(signal, tf):
    ...
    and datacard. Reuses the v25 workspace builder so the rpf setup stays identical.
    make_workspace() overwrites base.root + the ledger but leaves the existing fit/GoF
    outputs in the *_area directory untouched.'''
    import runWith1DVanilla_v25_SR_M20000GeV_e4 as ref
