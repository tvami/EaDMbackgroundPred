...
configJSON = "config_Binningv13_Inputv30_VR1_M3000GeV_e4.json" # sys.argv[2]
...
def plot_fit(signal, tf):
    ...
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, lumiText=data_title, pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.99999"})
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, True, lumiText=data_title, pf_slice_str={"fail":"RNNScore < 0.45","pass":"0.45 < RNNScore < 0.99999"})
