...
if __name__ == "__main__":
    ...
    for MBH_val in [3000]:
        ...
        rootdir = f'/home/users/smasanam/EarthAsDMProject/CMSSW_14_1_0_pre4/src/rpfmult_Binningv7_Inputv20_VR1_Unblind'
        ...
        f = ROOT.TFile.Open(f"/home/users/smasanam/EarthAsDMProject/CMSSW_14_1_0_pre4/src/rpfmult_Binningv7_Inputv20_VR1_Unblind/Signal_M3000GeV_VR1-2x0_area/plots_fit_b/all_plots.root")
        # get the histogram
        ...
        # ===========================
        f_fit = ROOT.TFile.Open(f"{rootdir}/Signal_M3000GeV_VR1-{tf.lower()}_area/fitDiagnosticsTest.root")
