...
def plot_fit(signal, tf):
    ...
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, lumiText=r'2023Dv1+v2 (13.2M Events)', pf_slice_str={"fail":"RNNScore < 0.35","pass":"0.35 < RNNScore < 0.7"})
    twoD.StdPlots('{}-{}_area'.format(signal, tf), subset, True, lumiText=r'2023Dv1+v2 (13.2M Events)', pf_slice_str={"fail":"RNNScore < 0.35","pass":"0.35 < RNNScore < 0.7"})
