...
# Usage: python runImpacts_v25_SR_M800GeV.py <workingArea> [--regen]
# e.g.   python runImpacts_v25_SR_M800GeV.py rpfmult_Binningv10_Inputv25_SR_M800GeV --regen
...
configJSON = "config_Binningv10_Inputv25_SR_M800GeV.json"  # same JSON as runWith1DVanilla_v25_SR_M800GeV.py
...
def regenerate(signal, tf):
    ...
    import runWith1DVanilla_v25_SR_M800GeV as ref
