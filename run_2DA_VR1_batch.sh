...
mv config_Binningv7_InputTemplate_VR1_Unblind.json $rel/src/
...
ls -lh histograms_for_2DAlphabet_v21/ | grep -E "(${signal}|Data_VR)" || echo "WARNING: Expected files not found"
...
parent_dir="rpf2x0_Binningv7_Inputv21_VR1_Unblind"
